...
export const zhHK: Record<string, string> = {
  ...
  sideChatBlockNoExitCode: "已結束（無結束碼）",
  ...
  tasksViewGraph: '工作流圖',
  tasksViewTree: '樹狀圖',
  tasksViewSwitchToGraph: '切換為工作流圖',
  tasksViewSwitchToTree: '切換為樹狀圖',
  settingsViewModeTitle: '任務管理預設檢視',
  settingsViewModeDesc: '任務管理頁開啟時的預設顯示方式（頁內仍可臨時切換）',
  settingsViewModeGraph: '工作流圖',
  ...
  tasksNodeMode: '模式',
  tasksNodeModel: '模型',
  tasksNodeTeamRole: '團隊角色',
  tasksNodeActivity: '最近活動',
  tasksStateRunning: '執行中',
  tasksStateIdle: '閒置',
  tasksStateDone: '已完成',
  tasksStateError: '出錯',
  teamBoard: '團隊任務板',
  teamChip: '團隊 {members} 成員 · {tasks} 任務',
  teamTasksEmpty: '暫無共用任務',
  teamTaskCreate: '新增任務',
  teamTaskSubject: '標題',
  ...
  teamTaskReopen: '重開',
  teamTaskDelete: '刪除',
  teamTaskDeleteConfirm: '確認刪除',
  teamTaskEdit: '編輯',
  teamTaskSave: '儲存',
  teamTaskCancel: '取消',
  teamTaskConflict: '任務已被他人修改，已重新整理',
  teamTaskError: '操作失敗：{message}',
  teamTaskDeleted: '已刪除',
  teamTaskActions: '任務操作',
  teamTaskDetail: '任務詳情',
  teamTaskNoDescription: '暫無描述，點擊「編輯」補充',
  teamTaskBlockedBy: '受阻於',
  teamTaskSubjectPlaceholder: '一句話說明要做什麼',
  teamTaskDescriptionPlaceholder: '補充說明（可選）',
  teamFilterAll: '全部',
  tasksNodeTasks: '共用任務',
  jobCopyOutput: '複製輸出',
  jobCopied: '已複製',
  ...
  workflowFailed: '失敗',
  workflowPhaseUnnamed: '未命名階段',
  workflowMembers: '{done}/{total} 成員',
  jobsAutoCollapsed: '代理較多，已自動收起',
  catalogLoadFailed: '{count} 個分支載入失敗',
