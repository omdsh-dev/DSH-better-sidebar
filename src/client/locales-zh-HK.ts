...
export const zhHK: Record<string, string> = {
  ...
  pluginIdeGitDesc: 'better-sidebar 嘅 Git 分頁:分支樹(ahead/behind 標記、worktree 佔用標記)、可按文字/分支/作者/日期/路徑篩選嘅提交圖譜、逐個檔案嘅逐行 diff、變更清單同提交框,仲有合併、變基、揀選、重設、貯藏同標籤操作;破壞性操作會先確認,刪除同丟棄都可以撤回。冇裝 better-sidebar 時會註冊到 DSH 原生右側欄,所以可以單獨用',
  ...
  pluginIdeGitName: 'dsh-ide-git Git 工具視窗',
