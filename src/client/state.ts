...
export type SidebarDiffRef =
  ...
  | { kind: 'commit'; hash: string; hashFull: string; subject: string; worktree?: string; repoRoot?: string; /** When present, the commit diff is limited to this file (repoRoot-relative). */ path?: string }
