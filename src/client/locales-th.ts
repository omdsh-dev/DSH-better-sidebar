...
export const th: Record<string, string> = {
  ...
  editorContentMode: 'โหมดมุมมองเนื้อหา',
  ...
  fileCommentsPanel: 'ความคิดเห็นของไฟล์ปัจจุบัน',
  fileCommentsCurrent: 'ปัจจุบัน',
  fileCommentsSend: 'ส่งความคิดเห็นที่เลือกให้ Agent',
  fileCommentsSendShort: 'ส่ง',
  fileCommentsSendFailed: 'ส่งความคิดเห็นไม่สำเร็จ: {error}',
  fileCommentsEmptyCurrent: 'ไม่มีความคิดเห็นที่ยังไม่ได้ส่งสำหรับไฟล์นี้',
  fileCommentsEmptyHistory: 'ไม่มีความคิดเห็นที่ส่งแล้วสำหรับไฟล์นี้',
  fileCommentsSelectionOmitted: 'ส่วนที่เลือกยาวเกินไป จะส่งเฉพาะตำแหน่งไฟล์',
  fileCommentsEdit: 'แก้ไขความคิดเห็น',
  fileCommentsDelete: 'ลบความคิดเห็น',
  fileCommentsSelect: 'เลือกความคิดเห็น',
  fileCommentsSelectAll: 'เลือกทั้งหมด',
  fileCommentsClearSelection: 'ยกเลิก',
  fileCommentsDeleteSelected: 'ลบ',
  fileCommentsPlaceholder: 'เพิ่มความคิดเห็นเกี่ยวกับส่วนที่เลือก…',
