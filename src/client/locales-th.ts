...
export const th: Record<string, string> = {
  ...
  guideDescSubagent: 'กราฟเวิร์กโฟลว์ บอร์ดงานของทีม และงานเบื้องหลัง แบบเรียลไทม์',
  ...
  tasksViewGraph: 'กราฟเวิร์กโฟลว์',
  tasksViewTree: 'มุมมองต้นไม้',
  tasksViewSwitchToGraph: 'สลับเป็นกราฟเวิร์กโฟลว์',
  tasksViewSwitchToTree: 'สลับเป็นมุมมองต้นไม้',
  settingsViewModeTitle: 'มุมมองเริ่มต้นของหน้างาน',
  settingsViewModeDesc: 'รูปแบบการแสดงหน้างานเมื่อเปิด (ปุ่มสลับในหน้ายังใช้สลับชั่วคราวได้)',
  settingsViewModeGraph: 'กราฟเวิร์กโฟลว์',
  ...
  tasksFoldExpand: 'ขยายโหนดที่เสร็จแล้ว',
  tasksFoldCollapse: 'ย่อโหนดที่เสร็จแล้ว',
  tasksZoomIn: 'ซูมเข้า',
  tasksZoomOut: 'ซูมออก',
  ...
  tasksNodeTeamRole: 'บทบาทในทีม',
  tasksNodeActivity: 'กิจกรรมล่าสุด',
  tasksStateRunning: 'กำลังทำงาน',
  tasksStateIdle: 'พร้อม',
  tasksStateDone: 'เสร็จแล้ว',
  tasksStateError: 'ข้อผิดพลาด',
  teamBoard: 'บอร์ดงานของทีม',
  teamChip: 'ทีม {members} สมาชิก · {tasks} งาน',
  teamTasksEmpty: 'ยังไม่มีงานที่แชร์',
  teamTaskCreate: 'งานใหม่',
  teamTaskSubject: 'หัวข้อ',
  teamTaskDescription: 'คำอธิบาย',
  teamTaskOwner: 'ผู้รับผิดชอบ',
  teamTaskUnowned: 'ยังไม่มีผู้รับ',
  teamTaskPending: 'รอดำเนินการ',
  teamTaskInProgress: 'กำลังดำเนินการ',
  teamTaskCompleted: 'เสร็จแล้ว',
  teamTaskBlocked: 'ถูกบล็อก',
  teamTaskComplete: 'ทำให้เสร็จ',
  teamTaskReopen: 'เปิดใหม่',
  teamTaskDelete: 'ลบ',
  teamTaskDeleteConfirm: 'ยืนยันการลบ',
  teamTaskEdit: 'แก้ไข',
  teamTaskSave: 'บันทึก',
  teamTaskCancel: 'ยกเลิก',
  teamTaskConflict: 'งานถูกแก้ไขโดยผู้อื่น รีเฟรชแล้ว',
  teamTaskError: 'ดำเนินการไม่สำเร็จ: {message}',
  teamTaskDeleted: 'ลบแล้ว',
  teamTaskActions: 'การดำเนินการของงาน',
  teamTaskDetail: 'รายละเอียดงาน',
  teamTaskNoDescription: 'ยังไม่มีคำอธิบาย — คลิก “แก้ไข” เพื่อเพิ่ม',
  teamTaskBlockedBy: 'ถูกบล็อกโดย',
  teamTaskSubjectPlaceholder: 'อธิบายงานที่ต้องทำในบรรทัดเดียว',
  teamTaskDescriptionPlaceholder: 'รายละเอียดเพิ่มเติม (ไม่บังคับ)',
  teamFilterAll: 'ทั้งหมด',
  tasksNodeTasks: 'งานที่แชร์',
  jobCopyOutput: 'คัดลอกเอาต์พุต',
  jobCopied: 'คัดลอกแล้ว',
  jobFollowTail: 'ติดตามบรรทัดล่าสุด',
  jobDragHint: 'ลากเพื่อย้าย',
  workflowRunning: 'กำลังทำงาน',
  workflowCompleted: 'เสร็จสิ้น',
  workflowCancelled: 'ยกเลิกแล้ว',
  workflowFailed: 'ล้มเหลว',
  workflowPhaseUnnamed: 'เฟสไม่มีชื่อ',
  workflowMembers: '{done}/{total} สมาชิก',
  jobsAutoCollapsed: 'ย่ออัตโนมัติ (เอเจนต์จำนวนมาก)',
  catalogLoadFailed: 'โหลดสาขาไม่สำเร็จ {count} รายการ',
