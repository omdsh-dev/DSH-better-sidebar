...
export const th: Record<string, string> = {
  ...
  subagentDelete: "ลบถาวร",
  subagentDeleteConfirm: "ลบถาวร",
  subagentDeleteDesc: "ลบเอเจนต์ย่อย \"{name}\" และบันทึกทั้งหมด (รวมถึงเอเจนต์ย่อยลูก) อย่างถาวร ไม่สามารถยกเลิกได้",
  subagentDeleteRunning: "กำลังทำงาน — ลบไม่ได้",
  subagentDeleteUnavailable: "ต้องติดตั้งปลั๊กอิน @michengai/dsh-archive-manager",
