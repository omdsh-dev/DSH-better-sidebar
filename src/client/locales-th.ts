...
export const th: Record<string, string> = {
  enterCodeFocus: 'เต็มหน้าจอ',
  exitCodeFocus: 'ออกจากโหมดเต็มหน้าจอ',
  resizeSidebar: 'ปรับความกว้างแถบด้านข้าง; ลากไปทางขวาสุดเพื่อซ่อน',
  releaseToHideSidebar: 'ปล่อยเพื่อซ่อนแถบด้านข้าง',
  createFile: 'ไฟล์ใหม่',
  createFolder: 'โฟลเดอร์ใหม่',
  newFileName: 'ชื่อไฟล์',
  newFolderName: 'ชื่อโฟลเดอร์',
  createNameRequired: 'กรอกชื่อ',
  createNameInvalid: 'ชื่อต้องไม่เป็น . หรือ .. และต้องไม่มีตัวคั่นพาธ',
  creating: 'กำลังสร้าง…',
  createDone: 'สร้าง {path} แล้ว',
  createFailed: 'สร้างไม่สำเร็จ: {error}',
  operationBusy: 'กำลังดำเนินการกับไฟล์รายการอื่น',
  importFiles: 'นำเข้าไฟล์',
  importFolder: 'นำเข้าโฟลเดอร์',
  deleteFile: 'ลบไฟล์',
  deleteFileTitle: 'ลบไฟล์',
  deleteFileDesc: 'ลบ “{path}” อย่างถาวรหรือไม่ การดำเนินการนี้เลิกทำไม่ได้',
  deleteFolder: 'ลบโฟลเดอร์',
  deleteFolderTitle: 'ลบโฟลเดอร์',
  deleteFolderDesc: 'ลบ “{path}” และเนื้อหาทั้งหมดอย่างถาวรหรือไม่ การดำเนินการนี้เลิกทำไม่ได้',
  deleteSymlink: 'ลบลิงก์สัญลักษณ์',
  deleteSymlinkTitle: 'ลบลิงก์สัญลักษณ์',
  deleteSymlinkDesc: 'ลบลิงก์สัญลักษณ์ “{path}” หรือไม่ เป้าหมายของลิงก์จะไม่ถูกลบ การดำเนินการนี้เลิกทำไม่ได้',
  deleting: 'กำลังลบ…',
  deleteDone: 'ลบ {path} แล้ว',
  deleteFailed: 'ลบไม่สำเร็จ: {error}',
  files: 'ไฟล์',
  explorer: 'ตัวสำรวจ',
  git: 'การควบคุมซอร์ส',
  terminal: 'เทอร์มินัล',
