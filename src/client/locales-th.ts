...
export const th: Record<string, string> = {
  ...
  pasteImageFailed: 'วางรูปภาพล้มเหลว',
  ...
  settingsSearchExcludeTitle: 'ไดเรกทอรีที่ยกเว้นจากการค้นหา',
  settingsSearchExcludeDesc: 'ข้ามไดเรกทอรีเหล่านี้เมื่อค้นหาชื่อไฟล์ (คั่นด้วยจุลภาค; ชื่อเดียวกันทุกระดับความลึกถูกยกเว้น)',
  ...
  settingsImageDirTitle: 'ไดเรกทอรีรูปภาพ Obsidian',
  settingsImageDirDesc: 'ไดเรกทอรีสำหรับ ![[x.png]] และการวางรูป: เทียบกับ cwd ของเซอร์ชัน (ค่าเริ่มต้น images) หรือพาธแบบสมบูรณ์',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'ชุดสีพรีวิว',
  settingsMdPreviewThemeDesc: 'ใช้เฉพาะกับการพรีวิวไฟล์ Markdown — ไม่กระทบ Side Chat หรือโหมดอ่าน Changes',
  settingsMdPreviewThemeVivid: 'สดใส',
  settingsMdPreviewThemeVividDesc: 'เน้นหัวข้อ คำอ้างอิง และหัวตารางด้วยโทเค็นเชิงความหมาย',
  settingsMdPreviewThemeHost: 'โฮสต์',
  settingsMdPreviewThemeHostDesc: 'คงสี MarkdownText ของโฮสต์ตามเดิม',
  viewerCode: 'โค้ด',
