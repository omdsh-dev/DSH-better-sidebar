...
export const th: Record<string, string> = {
  ...
  pluginIdeGitDesc: 'แท็บ Git สำหรับ better-sidebar: ทรีแบรนช์ (ป้าย ahead/behind, ตัวบอก worktree), กราฟคอมมิตพร้อมตัวกรองข้อความ/แบรนช์/ผู้เขียน/วันที่/พาธ, diff รายบรรทัดต่อไฟล์, รายการเปลี่ยนแปลงและช่องคอมมิต พร้อม merge, rebase, cherry-pick, reset, stash และแท็ก; การกระทำที่ทำลายข้อมูลจะถามยืนยัน และการลบหรือทิ้งการเปลี่ยนแปลงสามารถย้อนกลับได้ หากไม่มี better-sidebar จะลงทะเบียนในแถบด้านขวาของ DSH จึงใช้เดี่ยว ๆ ได้',
  ...
  pluginIdeGitName: 'dsh-ide-git หน้าต่าง Git',
