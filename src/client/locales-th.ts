...
export const th: Record<string, string> = {
  ...
  toc: 'สารบัญ',
  review: 'ตรวจทาน',
  reviewPending: 'รอตรวจทาน {count} รายการ',
  reviewNoRepo: 'ไม่ใช่ที่เก็บ Git',
  reviewAccepted: 'ยอมรับแล้ว',
  accept: 'ยอมรับ',
  acceptAll: 'ยอมรับทั้งหมด',
  reject: 'ปฏิเสธ',
  rejectUntracked: 'ไฟล์ใหม่ไม่มีเวอร์ชันที่คอมมิตไว้ให้กู้คืน',
  find: 'ค้นหา',
  findPrev: 'ผลก่อนหน้า',
  findNext: 'ผลถัดไป',
  findClose: 'ปิดการค้นหา',
  findNoResults: 'ไม่พบผลลัพธ์',
  edit: 'แก้ไข',
  ...
  browserLocalBlockedTitle: 'เชื่อถือและเปิด {authority} หรือไม่',
  browserLocalBlockedDesc: 'นี่คือบริการภายในเครื่องคอมพิวเตอร์ของคุณ อนุญาตเฉพาะเมื่อคุณเป็นผู้เริ่มหรือเชื่อถือเว็บแอปนี้ สิทธิ์เข้าถึงใช้กับที่อยู่และพอร์ตนี้เท่านั้น',
  browserTrustAndOpen: 'เชื่อถือและเปิด',
  browserTrusting: 'กำลังบันทึก…',
  browserTrustFailed: 'บันทึกที่อยู่ภายในเครื่องนี้ไม่ได้ โปรดตรวจสอบบริการการตั้งค่าแถบด้านข้างแล้วลองอีกครั้ง',
