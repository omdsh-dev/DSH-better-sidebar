...
export const th: Record<string, string> = {
  ...
  searchFind: 'ค้นหา',
  searchReplace: 'แทนที่',
  searchNext: 'ถัดไป',
  searchPrevious: 'ก่อนหน้า',
  searchAll: 'เลือกทั้งหมด',
  searchMatchCase: 'จับคู่ตัวพิมพ์',
  searchWholeWord: 'ทั้งคำ',
  searchRegexp: 'รีเจกซ์',
  searchReplaceAll: 'แทนที่ทั้งหมด',
  searchCurrentMatch: 'ที่ตรงกันปัจจุบัน',
  searchOnLine: 'ในบรรทัด',
  searchReplacedMatches: 'แทนที่แล้ว $ รายการ',
  searchReplacedMatchOnLine: 'แทนที่รายการในบรรทัด $ แล้ว',
  searchGoToLine: 'ไปยังบรรทัด',
  searchGo: 'ไป',
