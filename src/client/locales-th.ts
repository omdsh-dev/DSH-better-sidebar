...
export const th: Record<string, string> = {
  ...
  replace: 'แทนที่',
  findNext: 'ถัดไป',
  findPrevious: 'ก่อนหน้า',
  findAll: 'เลือกทั้งหมด',
  findMatchCase: 'ตรงตามตัวพิมพ์',
  findRegexp: 'Regex',
  findByWord: 'ทั้งคำ',
  replaceOne: 'แทนที่',
  ...
  closeUnsavedConfirm: 'ไฟล์นี้มีการแก้ไขที่ยังไม่ได้บันทึก การปิดแท็บจะทิ้งการแก้ไขนั้น ดำเนินการต่อหรือไม่',
  save: 'บันทึก',
  saved: 'บันทึกแล้ว',
  unsaved: 'ยังไม่ได้บันทึก',
  saveFailed: 'บันทึกล้มเหลว',
  saveConflict: 'ไฟล์ถูกแก้ไขบนดิสก์จากแหล่งอื่น การบันทึกถูกยกเลิก การแก้ไขของคุณยังอยู่ในเอดิเตอร์',   saveConflictReload: 'โหลดใหม่จากดิสก์',
