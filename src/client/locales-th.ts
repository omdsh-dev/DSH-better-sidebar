...
export const th: Record<string, string> = {
  ...
  guideDescPlan: 'แผนฉบับเต็มที่โมเดลเสนอในโหมดวางแผน เก็บไว้ทุกเวอร์ชัน',
  ...
  plan: 'แผน',
  planEmpty: 'ยังไม่มีแผนในเซสชันนี้',
  planEmptyDesc: 'ให้โมเดลสร้างแผนในโหมดวางแผน เมื่อเสนอแล้วจะปรากฏที่นี่',
  planStatusPending: 'รอการตรวจสอบ',
  planStatusApproved: 'อนุมัติแล้ว',
  planStatusUnadopted: 'ยังไม่นำไปใช้',
  planCopy: 'คัดลอกแผน',
  planLoadError: 'โหลดแผนล้มเหลว กำลังลองใหม่',
  ...
  settingsPlanTitle: 'เลือกหน้าแผนโดยอัตโนมัติเมื่อโมเดลเสนอแผน',
  settingsPlanDesc: 'เมื่อโมเดลเสนอแผนในแชทปัจจุบัน ระบบจะเลือกหน้าแผนโดยอัตโนมัติ; ในมุมมองแบบกว้าง ระบบจะขยายการ์ดด้านข้างด้วย ส่วนในมุมมองแบบแคบ ระบบจะไม่บังคับเปิดลิ้นชักเต็มหน้าจอ; ปิดเพื่อเลือกหน้าด้วยตนเอง',
