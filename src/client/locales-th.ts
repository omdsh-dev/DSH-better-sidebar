...
export const th: Record<string, string> = {
  ...
  allowOutsideFiles: 'อนุญาตให้เปิดไฟล์นอกพื้นที่ทำงาน',
  allowOutsideFilesDesc: 'ตัวเลือกแบบอ่านอย่างเดียว: แถบด้านข้างสามารถดูไฟล์/โฟลเดอร์นอกพื้นที่ทำงานของเซสชันได้ การแก้ไข บันทึก และอัปโหลดยังคงจำกัดเฉพาะในพื้นที่ทำงาน',
  externalReadonly: 'ภายนอก · อ่านอย่างเดียว',
