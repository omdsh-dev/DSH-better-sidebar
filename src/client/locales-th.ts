...
export const th: Record<string, string> = {
  ...
  explorerExclude: 'รูปแบบการยกเว้น',
  explorerExcludeDesc: 'ลบรายการที่ตรงกันออกจากแผนผังไฟล์และการค้นหาทั้งหมด (รองรับ * และ ? ส่วนหัว **/ จับคู่ทุกระดับความลึก) รายการที่ยกเว้นจะไม่ขัดขวางการพับ breadcrumb เลย',
  explorerExcludePlaceholder: 'เพิ่มรูปแบบ เช่น node_modules, *.log, **/.git',
  explorerExcludeAdd: 'เพิ่ม',
  explorerExcludeRemove: 'ลบ',
