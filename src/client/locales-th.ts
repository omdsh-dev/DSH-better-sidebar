...
export const th: Record<string, string> = {
  ...
  generateCommitMessage: 'สร้างข้อความ commit',
  generatingCommitMessage: 'กำลังสร้างข้อความ commit…',
  suggestCommitError: 'สร้างข้อความ commit ไม่สำเร็จ',
  suggestCommitEmpty: 'ไม่มีการเปลี่ยนแปลงที่รอดำเนินการ',
  push: 'ผลัก',
  pull: 'ดึง',
  pushError: 'ผลักไม่สำเร็จ',
  pullError: 'ดึงไม่สำเร็จ',
  branch: 'Branch',
  worktree: 'เวิร์กทรี',
