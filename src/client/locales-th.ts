...
export const th: Record<string, string> = {
  ...
  settingsAutoCollapseTitle: 'พับการ์ดด้านข้างอัตโนมัติเมื่องานเสร็จสิ้น',
  settingsAutoCollapseDesc: 'เมื่อการเปิดใช้งานอัตโนมัติขยายการ์ดด้านข้างที่พับอยู่ ระบบจะพับการ์ดกลับเมื่อซับเอเจนต์และงานเบื้องหลังทั้งหมดของแชทปัจจุบันเสร็จสิ้นและไม่มีการใช้งานต่อสักครู่ (ปิดเฉพาะการ์ด แท็บยังอยู่; การ์ดที่คุณเปิดเองจะไม่ถูกแตะต้อง) ปิดไว้เป็นค่าเริ่มต้น',
