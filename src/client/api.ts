...
export const api = {
  ...
  /** Open the OS file manager at the path (folders open; files reveal selected). */
  reveal: (scope: SessionScope, path: string) =>
    call<{ ok: true }>('reveal', scopePayload(scope, { path })),
