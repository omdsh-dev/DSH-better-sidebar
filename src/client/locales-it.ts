...
export const it: Record<string, string> = {
  ...
  replace: 'Sostituisci',
  findNext: 'Successivo',
  findPrevious: 'Precedente',
  findAll: 'Seleziona tutto',
  findMatchCase: 'Maiuscole/minuscole',
  findRegexp: 'Regex',
  findByWord: 'Parola intera',
  ...
  closeUnsavedConfirm: 'Questo file ha modifiche non salvate. Chiudere la scheda le perderà. Continuare?',
  save: 'Salva',
  saved: 'Salvato',
  unsaved: 'Non salvato',
  saveFailed: 'Salvataggio non riuscito',
  saveConflict: 'Il file è stato modificato su disco da un\'altra origine. Salvataggio annullato; le modifiche restano nell\'editor.',
  saveConflictReload: 'Ricarica dal disco',
