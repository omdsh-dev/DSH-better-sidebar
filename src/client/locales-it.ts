...
export const it: Record<string, string> = {
  ...
  suggestCommitError: 'Generazione del messaggio di commit non riuscita',
  suggestCommitEmpty: 'Nessuna modifica in sospeso',
  push: 'Push',
  pull: 'Pull',
  pushError: 'Push non riuscito',
  pullError: 'Pull non riuscito',
  branch: 'Ramo',
