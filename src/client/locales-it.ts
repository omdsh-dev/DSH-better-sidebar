...
export const it: Record<string, string> = {
  ...
  allowOutsideFiles: 'Consenti l’apertura di file fuori dall’area di lavoro',
  allowOutsideFilesDesc: 'Opzione di sola lettura: la barra laterale può visualizzare file/cartelle fuori dall’area di lavoro della sessione; modifica, salvataggio e upload restano limitati all’area di lavoro.',
  externalReadonly: 'Esterno · sola lettura',
