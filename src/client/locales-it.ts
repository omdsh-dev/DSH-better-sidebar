...
export const it: Record<string, string> = {
  ...
  toc: 'Indice',
  review: 'Revisione',
  reviewPending: '{count} da rivedere',
  reviewNoRepo: 'Non è un repository Git',
  reviewAccepted: 'Accettato',
  accept: 'Accetta',
  acceptAll: 'Accetta tutto',
  reject: 'Rifiuta',
  rejectUntracked: 'Un file nuovo non ha una versione registrata da ripristinare',
  find: 'Trova',
  findPrev: 'Corrispondenza precedente',
  findNext: 'Corrispondenza successiva',
  findClose: 'Chiudi ricerca',
  findNoResults: 'Nessun risultato',
  edit: 'Modifica',
  ...
  browserLocalBlockedTitle: 'Considerare attendibile {authority} e aprirlo?',
  browserLocalBlockedDesc: 'Questo è un servizio locale sul computer. Consentilo solo se hai avviato o ritieni attendibile questa app web. L’accesso vale solo per questo indirizzo e questa porta.',
  browserTrustAndOpen: 'Considera attendibile e apri',
  browserTrusting: 'Salvataggio…',
  browserTrustFailed: 'Impossibile salvare questo indirizzo locale. Controlla il servizio delle impostazioni della barra laterale e riprova.',
