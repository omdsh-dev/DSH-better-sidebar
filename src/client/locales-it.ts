...
export const it: Record<string, string> = {
  ...
  pasteImageFailed: 'Incolla immagine non riuscita',
  ...
  settingsSearchExcludeTitle: 'Directory escluse dalla ricerca',
  settingsSearchExcludeDesc: 'Salta queste directory nella ricerca per nome file (separate da virgole; lo stesso nome a qualsiasi profondità viene escluso)',
  ...
  settingsImageDirTitle: 'Directory immagini Obsidian',
  settingsImageDirDesc: 'Directory per embed ![[x.png]] e immagini incollate: relativa alla cwd della sessione (default images) o percorso assoluto',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'Tema colori anteprima',
  settingsMdPreviewThemeDesc: 'Si applica solo all’anteprima dei file Markdown — non a Side Chat né alla lettura Changes',
  settingsMdPreviewThemeVivid: 'Vivace',
  settingsMdPreviewThemeVividDesc: 'Titoli, citazioni e intestazioni tabella più contrastati tramite token semantici',
  settingsMdPreviewThemeHost: 'Host',
  settingsMdPreviewThemeHostDesc: 'Mantieni i colori MarkdownText dell’host così come sono',
  viewerCode: 'Codice',
