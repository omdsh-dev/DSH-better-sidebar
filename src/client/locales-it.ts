...
export const it: Record<string, string> = {
  ...
  subagentDelete: "Elimina definitivamente",
  subagentDeleteConfirm: "Elimina definitivamente",
  subagentDeleteDesc: "Elimina definitivamente il sotto-agente \"{name}\" e tutti i suoi record (inclusi i sotto-agenti figli). Operazione irreversibile.",
  subagentDeleteRunning: "In esecuzione — impossibile eliminare",
  subagentDeleteUnavailable: "Richiede il plugin @michengai/dsh-archive-manager",
