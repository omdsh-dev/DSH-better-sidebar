...
export const it: Record<string, string> = {
  ...
  editorContentMode: 'Modalità di visualizzazione contenuto',
  ...
  fileCommentsPanel: 'Commenti del file corrente',
  fileCommentsCurrent: 'Correnti',
  fileCommentsSend: 'Invia i commenti selezionati ad Agent',
  fileCommentsSendShort: 'Invia',
  fileCommentsSendFailed: 'Invio dei commenti non riuscito: {error}',
  fileCommentsEmptyCurrent: 'Nessun commento non inviato per questo file',
  fileCommentsEmptyHistory: 'Nessun commento inviato per questo file',
  fileCommentsSelectionOmitted: 'La selezione è troppo lunga; verrà inviata solo la posizione nel file',
  fileCommentsEdit: 'Modifica commento',
  fileCommentsDelete: 'Elimina commento',
  fileCommentsSelect: 'Seleziona commento',
  fileCommentsSelectAll: 'Seleziona tutto',
  fileCommentsClearSelection: 'Annulla',
  fileCommentsDeleteSelected: 'Elimina',
  fileCommentsPlaceholder: 'Aggiungi un commento sulla selezione…',
