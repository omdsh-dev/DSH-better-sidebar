...
export const it: Record<string, string> = {
  enterCodeFocus: 'Schermo intero',
  exitCodeFocus: 'Esci da schermo intero',
  resizeSidebar: 'Ridimensiona la barra laterale; trascinala completamente a destra per nasconderla',
  releaseToHideSidebar: 'Rilascia per nascondere la barra laterale',
  createFile: 'Nuovo file',
  createFolder: 'Nuova cartella',
  newFileName: 'Nome file',
  newFolderName: 'Nome cartella',
  createNameRequired: 'Inserisci un nome',
  createNameInvalid: 'Il nome non può essere . o .. né contenere separatori di percorso',
  creating: 'Creazione…',
  createDone: '{path} è stato creato',
  createFailed: 'Creazione non riuscita: {error}',
  operationBusy: 'È in corso un’altra operazione sui file',
  importFiles: 'Importa file',
  importFolder: 'Importa cartella',
  deleteFile: 'Elimina file',
  deleteFileTitle: 'Elimina file',
  deleteFileDesc: 'Eliminare definitivamente “{path}”? Questa azione non può essere annullata.',
  deleteFolder: 'Elimina cartella',
  deleteFolderTitle: 'Elimina cartella',
  deleteFolderDesc: 'Eliminare definitivamente “{path}” e tutto il suo contenuto? Questa azione non può essere annullata.',
  deleteSymlink: 'Elimina collegamento simbolico',
  deleteSymlinkTitle: 'Elimina collegamento simbolico',
  deleteSymlinkDesc: 'Eliminare il collegamento simbolico “{path}”? La destinazione non verrà eliminata. Questa azione non può essere annullata.',
  deleting: 'Eliminazione…',
  deleteDone: '{path} è stato eliminato',
