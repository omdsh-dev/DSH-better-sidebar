...
export const it: Record<string, string> = {
  ...
  explorerExclude: 'Modelli di esclusione',
  explorerExcludeDesc: 'Rimuove completamente le voci corrispondenti dall’albero dei file e dalla ricerca (supporta * e ?, un prefisso **/ corrisponde a qualsiasi profondità); le voci escluse non bloccano mai la compressione dei breadcrumb',
  explorerExcludePlaceholder: 'Aggiungi un modello, es. node_modules, *.log, **/.git',
  explorerExcludeAdd: 'Aggiungi',
  explorerExcludeRemove: 'Rimuovi',
