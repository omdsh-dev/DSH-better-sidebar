...
export const it: Record<string, string> = {
  ...
  guideDescSubagent: 'Grafo del workflow, bacheca delle attività del team e attività in background, in tempo reale',
  ...
  sideChatBlockNoExitCode: "Terminato senza codice di uscita",
  ...
  codeBlockTitle: 'Blocco di codice',
  codeBlockWrap: 'A capo automatico',
  ...
  tasksViewGraph: 'Grafo del workflow',
  tasksViewTree: 'Albero',
  tasksViewSwitchToGraph: 'Passa al grafo del workflow',
  tasksViewSwitchToTree: 'Passa all’albero',
  settingsViewModeTitle: 'Vista predefinita della pagina Attività',
  settingsViewModeDesc: 'Come si apre la pagina Attività (l’interruttore in pagina permette comunque di cambiare al volo)',
  settingsViewModeGraph: 'Grafo del workflow',
  ...
  tasksFoldCollapse: 'Comprimi i nodi completati',
  tasksZoomIn: 'Ingrandisci',
  tasksZoomOut: 'Riduci',
  ...
  tasksNodeTeamRole: 'Ruolo nel team',
  tasksNodeActivity: 'Ultima attività',
  tasksStateRunning: 'In esecuzione',
  tasksStateIdle: 'In attesa',
  tasksStateDone: 'Completato',
  tasksStateError: 'Errore',
  teamBoard: 'Bacheca delle attività del team',
  teamChip: 'Team {members} membri · {tasks} attività',
  teamTasksEmpty: 'Ancora nessuna attività condivisa',
  teamTaskCreate: 'Nuova attività',
  teamTaskSubject: 'Titolo',
  teamTaskDescription: 'Descrizione',
  teamTaskOwner: 'Responsabile',
  teamTaskUnowned: 'Non assegnata',
  teamTaskPending: 'Da fare',
  teamTaskInProgress: 'In corso',
  teamTaskCompleted: 'Completata',
  teamTaskBlocked: 'Bloccata',
  teamTaskComplete: 'Completa',
  teamTaskReopen: 'Riapri',
  teamTaskDelete: 'Elimina',
  teamTaskDeleteConfirm: 'Conferma eliminazione',
  teamTaskEdit: 'Modifica',
  teamTaskSave: 'Salva',
  teamTaskCancel: 'Annulla',
  teamTaskConflict: 'L’attività è stata modificata da altri; aggiornata',
  teamTaskError: 'Operazione non riuscita: {message}',
  teamTaskDeleted: 'Eliminata',
  teamTaskActions: 'Azioni attività',
  teamTaskDetail: 'Dettagli attività',
  teamTaskNoDescription: 'Nessuna descrizione — fai clic su «Modifica» per aggiungerne una',
  teamTaskBlockedBy: 'Bloccata da',
  teamTaskSubjectPlaceholder: 'Descrivi il lavoro in una riga',
  teamTaskDescriptionPlaceholder: 'Dettagli aggiuntivi (opzionale)',
  teamFilterAll: 'Tutti',
  tasksNodeTasks: 'Attività condivise',
  jobCopyOutput: 'Copia output',
  jobCopied: 'Copiato',
  jobFollowTail: 'Segui le ultime righe',
  jobDragHint: 'Trascina per spostare',
  workflowRunning: 'In corso',
  workflowCompleted: 'Completato',
  workflowCancelled: 'Annullato',
  workflowFailed: 'Non riuscito',
  workflowPhaseUnnamed: 'Fase senza nome',
  workflowMembers: '{done}/{total} membri',
  jobsAutoCollapsed: 'Compresso automaticamente (molti agenti)',
  catalogLoadFailed: 'Impossibile caricare {count} branch',
