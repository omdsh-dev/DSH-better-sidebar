...
export const it: Record<string, string> = {
  ...
  guideDescPlan: 'Ogni piano presentato dal modello in modalità di pianificazione, conservato integralmente a ogni revisione',
  ...
  plan: 'Piano',
  planEmpty: 'Ancora nessun piano in questa sessione',
  planEmptyDesc: 'I piani presentati dal modello in modalità di pianificazione compariranno qui',
  planStatusPending: 'In attesa di revisione',
  planStatusApproved: 'Approvato',
  planStatusUnadopted: 'Non adottato',
  planCopy: 'Copia il piano',
  planLoadError: 'Impossibile caricare il piano; nuovo tentativo in corso',
  ...
  settingsPlanTitle: 'Apri automaticamente la pagina Piano quando il modello presenta un piano',
  settingsPlanDesc: 'Quando il modello presenta un piano nella conversazione attuale, apri la pagina Piano (l’apertura avviene per ogni piano presentato); sugli schermi ampi espande anche la barra laterale, mentre sugli schermi stretti non forza l’apertura del pannello a schermo intero; disattiva per aprirla manualmente',
