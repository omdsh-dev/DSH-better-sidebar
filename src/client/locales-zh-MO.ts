...
export const zhMO: Record<string, string> = {
  ...
  guideDescPlan: '計劃模式下 AI 提交的計劃全文，逐版保留',
  ...
  plan: '計劃',
  planEmpty: '本工作階段還沒有計劃',
  planEmptyDesc: '在計劃模式下讓 AI 產生計劃，提交後會出現在這裡',
  planStatusPending: '待評審',
  planStatusApproved: '已批准',
  planStatusUnadopted: '未採納',
  planCopy: '複製全文',
  planLoadError: '計劃載入失敗，請稍後重試',
  ...
  settingsPlanTitle: 'AI 提交計劃時自動選取計劃頁',
  settingsPlanDesc: '目前工作階段的模型在計劃模式下提交計劃時，自動選取計劃頁查看全文；寬螢幕時亦會展開側邊欄，窄螢幕時不會強制開啟全螢幕抽屜；關閉後需手動選取',
