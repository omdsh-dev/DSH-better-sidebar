...
export const zhMO: Record<string, string> = {
  ...
  settingsSearchExcludeTitle: '搜尋排除目錄',
  settingsSearchExcludeDesc: '檔名搜尋時略過這些目錄（逗號分隔；任意深度同名目錄均排除）',
  ...
  settingsImageDirTitle: 'Obsidian 圖片目錄',
  settingsImageDirDesc: '![[圖.png]] 的解析與貼上儲存目錄：相對會話目錄（預設 images）或絕對路徑',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: '預覽配色主題',
  settingsMdPreviewThemeDesc: '僅套用於 Markdown 檔案預覽，不影響側邊對話與檔案變動閱讀模式',
  settingsMdPreviewThemeVivid: '鮮明',
  settingsMdPreviewThemeVividDesc: '標題、引用、表頭等用語義色拉高對比',
  settingsMdPreviewThemeHost: '宿主',
  settingsMdPreviewThemeHostDesc: '保持宿主 MarkdownText 原樣配色',
  viewerCode: '程式碼',
  viewerBinary: '二進位下載',
  viewerHtml: 'HTML',
  browser: '瀏覽器',
