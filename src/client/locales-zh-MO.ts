...
export const zhMO: Record<string, string> = {
  ...
  stageAll: '全部暫存',
  unstageAll: '全部取消暫存',
  commitPlaceholder: '提交訊息 (Ctrl+G 產生，Ctrl+Enter 提交)',
  commit: '提交',
  commitError: '提交失敗',
  ...
  commitModelDesc: '選擇產生提交訊息時使用的模型；預設跟隨目前對話使用的模型。',
  commitModelFollow: '跟隨目前對話',
  commitModelSearchPlaceholder: '搜尋：輸入 provider/model',
  commitModelCurrent: '目前：{route}',
  commitModelInvalid: '請填寫 provider/model 格式',
  commitModelUnavailable: '目前部署未提供模型服務，只能跟隨目前對話',
  commitModelEmpty: '未發現可用模型（可於上方直接輸入 provider/model）',
  commitModelDefaultNote: '預設',
  commitModelRecentNote: '本對話用過',
  branch: '分支',
  worktree: '工作樹',
