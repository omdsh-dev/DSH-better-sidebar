...
export const zh = {
  ...
  worktreeOpenSession: '在此 Worktree 中新建 DSH 会话',
  worktreeCurrent: '当前',
  worktreeLocked: '已锁定',
  ...
  worktreeMerge: '合并到当前分支',
  worktreeMergeTitle: '合并 Worktree',
  worktreeMergeDesc: '将「{source}」合并到当前分支「{current}」。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  worktreeOpenSession: 'Create a DSH session in this Worktree',
  ...
  worktreeMerge: 'Merge into current branch',
  worktreeMergeTitle: 'Merge Worktree',
  worktreeMergeDesc: 'Merge "{source}" into the current branch "{current}".',
