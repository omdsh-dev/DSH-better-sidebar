...
export const zh = {
  ...
  settingsWidthSuffix: '%',
  settingsOpacityTitle: '面板透明度',
  settingsOpacityDesc: '侧边卡片面板的透明度百分比 (20–100)，数值越小越透明',
  settingsOpacitySuffix: '%',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsWidthSuffix: '%',
  settingsOpacityTitle: 'Panel opacity',
  settingsOpacityDesc: 'The side card panel opacity as a percent (20–100); lower is more transparent',
  settingsOpacitySuffix: '%',
