...
export const zh = {
  ...
  fileCommentsPanel: '当前文件评论',
  fileCommentsCurrent: '当前',
  fileCommentsSend: '发送所选评论给 Agent',
  fileCommentsSendShort: '发送',
  fileCommentsSendFailed: '评论发送失败：{error}',
  fileCommentsEmptyCurrent: '当前文件还没有未发送的评论',
  fileCommentsEmptyHistory: '当前文件还没有已发送的评论',
  fileCommentsSelectionOmitted: '选中内容过长，发送时仅包含文件位置',
  fileCommentsEdit: '编辑评论',
  fileCommentsDelete: '删除评论',
  fileCommentsSelect: '选择评论',
  fileCommentsSelectAll: '全选',
  fileCommentsClearSelection: '取消',
  fileCommentsDeleteSelected: '删除',
  fileCommentsPlaceholder: '添加针对所选内容的评论…',
  ...
  preview: '预览',
  source: '源码',
  editorContentMode: '内容显示模式',
  toc: '目录',
  edit: '编辑',
  editorFileMode: '文件视图模式',
  editorFile: '文件',
  editorDiff: '差异',
  editorDiffToolbar: '差异工具栏',
  editorDiffPrevious: '上一差异',
  editorDiffNext: '下一差异',
  editorDiffLayout: '差异布局',
  editorDiffSplit: '分栏视图',
  editorDiffUnified: '单栏视图',
  editorDiffCollapse: '折叠未更改片段',
  editorDiffCount: '{count} 处差异',
  editorDiffHead: 'HEAD 版本',
  editorDiffCurrent: '当前内容',
  editorDiffUnifiedLabel: 'HEAD 版本与当前内容',
  editorDiffLoadError: '无法加载 Git 版本：{error}',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  fileCommentsPanel: 'Current file comments',
  fileCommentsCurrent: 'Current',
  fileCommentsSend: 'Send selected comments to Agent',
  fileCommentsSendShort: 'Send',
  fileCommentsSendFailed: 'Failed to send comments: {error}',
  fileCommentsEmptyCurrent: 'No unsent comments for this file',
  fileCommentsEmptyHistory: 'No sent comments for this file',
  fileCommentsSelectionOmitted: 'The selection is too long; only its file location will be sent',
  fileCommentsEdit: 'Edit comment',
  fileCommentsDelete: 'Delete comment',
  fileCommentsSelect: 'Select comment',
  fileCommentsSelectAll: 'Select all',
  fileCommentsClearSelection: 'Cancel',
  fileCommentsDeleteSelected: 'Delete',
  fileCommentsPlaceholder: 'Add a comment about the selection…',
  ...
  preview: 'Preview',
  source: 'Source',
  editorContentMode: 'Content view mode',
  toc: 'Table of contents',
  edit: 'Edit',
  editorFileMode: 'File view mode',
  editorFile: 'File',
  editorDiff: 'Diff',
  editorDiffToolbar: 'Diff toolbar',
  editorDiffPrevious: 'Previous change',
  editorDiffNext: 'Next change',
  editorDiffLayout: 'Diff layout',
  editorDiffSplit: 'Split view',
  editorDiffUnified: 'Unified view',
  editorDiffCollapse: 'Collapse unchanged',
  editorDiffCount: '{count} changes',
  editorDiffHead: 'HEAD version',
  editorDiffCurrent: 'Current content',
  editorDiffUnifiedLabel: 'HEAD version and current content',
  editorDiffLoadError: 'Failed to load Git version: {error}',
