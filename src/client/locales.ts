...
export const zh = {
  ...
  subagentRunning: '运行中',
  subagentInactive: '空闲',
  subagentSettledGroup: '已完成的子代理 ({count})',
  subagentSettledExpand: '点击展开',
  subagentSettledCollapse: '点击收起',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  subagentSettledGroup: 'Completed subagents ({count})',
  subagentSettledExpand: 'Show completed',
  subagentSettledCollapse: 'Hide completed',
