...
export const zh = {
  ...
  sideChat: '侧边对话',
  sideChatNew: '新建侧边对话',
  sideChatPlaceholder: '输入首问，Enter 创建线程…',
  sideChatEmpty: '暂无侧边对话',
  sideChatEmptyDesc: '侧边对话继承当前会话的上下文独立运行，不会进入主会话',
  sideChatSave: '保存为新会话',
  ...
  sideChatComposerPlaceholder: '输入追问，Enter 发送…',
  sideChatSend: '发送',
  sideChatCancel: '停止',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  sideChat: 'Side Chat',
  sideChatNew: 'New side conversation',
  sideChatPlaceholder: 'Ask a side question, Enter to create…',
  sideChatEmpty: 'No side conversations',
  sideChatEmptyDesc: 'A side conversation inherits the current session\'s context and runs independently — it never enters the main conversation',
  ...
  sideChatComposerPlaceholder: 'Ask a follow-up, Enter to send…',
  sideChatSend: 'Send',
  sideChatCancel: 'Stop',
