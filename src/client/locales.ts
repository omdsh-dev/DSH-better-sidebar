...
export const zh = {
  ...
  githubUnconfiguredNoGh: "GitHub 未配置：在 cordis.patch.yml 中给 dsh-better-sidebar 配置 githubToken，或设置 GH_TOKEN / GITHUB_TOKEN 环境变量",
  ...
  githubChipReviewRequestedDesc: "显示请你 review 的 PR 通知（review_requested）",
  githubChipPrActivity: "我的 PR 动态",
  githubChipPrActivityDesc: "显示自己 PR 上的 review 结果与新评论（author + PullRequest）",
  githubChipComments: "评论 / 提及",
  githubChipCommentsDesc: "显示评论与 @提及（comment / mention / author + issue）",
  githubChipCi: "CI 状态",
  githubChipCiDesc: "显示工作流完成通知（ci_activity，默认关闭以过滤 CI 失败噪音）",
  githubChipOther: "其他",
  githubChipOtherDesc: "显示指派、订阅、安全告警、状态变更等其余通知",
  githubPollSecondsTitle: "轮询间隔",
  githubPollSecondsDesc: "收件箱快照的拉取间隔（60–300 秒，GitHub 的最低轮询间隔为 60 秒）",
  githubPollSecondsSuffix: "s",
...
export const en: Record<keyof typeof zh, string> = {
  ...
  githubUnconfiguredNoGh: "GitHub is not configured: set githubToken for dsh-better-sidebar in cordis.patch.yml, or set GH_TOKEN / GITHUB_TOKEN",
  ...
  githubChipReviewRequestedDesc: "Show PRs requesting your review (review_requested)",
  githubChipPrActivity: "My PR activity",
  githubChipPrActivityDesc: "Show review verdicts and new comments on your own PRs (author + PullRequest)",
  githubChipComments: "Comments / mentions",
  githubChipCommentsDesc: "Show comments and @mentions (comment / mention / author + issue)",
  githubChipCi: "CI status",
  githubChipCiDesc: "Show workflow-completion notifications (ci_activity; off by default to filter CI-failure noise)",
  githubChipOther: "Other",
  githubChipOtherDesc: "Show assignments, subscriptions, security alerts, state changes and the rest",
  githubPollSecondsTitle: "Poll interval",
  githubPollSecondsDesc: "How often the inbox snapshot is fetched (60–300s; GitHub floors polling at 60s)",
  githubPollSecondsSuffix: "s",
