...
export const zh = {
  ...
  allowOutsideFiles: '允许打开工作区外的文件',
  allowOutsideFilesDesc: '仅放开查看：侧边栏可读取工作区外的文件/目录；编辑、保存与上传仍限制在工作区内',
  externalReadonly: '外部 · 只读',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  allowOutsideFiles: 'Allow opening files outside the workspace',
  allowOutsideFilesDesc: 'Read-only opt-in: the sidebar may view files/directories outside the session workspace; edit, save, and upload stay workspace-only',
