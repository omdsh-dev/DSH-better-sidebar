...
export const zh = {
  ...
  guideDescPlan: '计划模式下 AI 提交的计划全文，逐版留档',
  ...
  plan: '计划',
  planEmpty: '本会话还没有计划',
  planEmptyDesc: '在计划模式下让 AI 出计划，提交后会出现在这里',
  planStatusPending: '待评审',
  planStatusApproved: '已批准',
  planStatusUnadopted: '未采纳',
  planCopy: '复制全文',
  planLoadError: '计划加载失败，稍后重试',
  ...
  settingsPlanTitle: 'AI 提交计划时自动打开计划页',
  settingsPlanDesc: '当前会话的模型在计划模式下提交计划时，自动打开侧边栏「计划」页查看全文；宽屏同时展开侧边栏，窄屏不强制展开全屏抽屉；关闭后需手动打开',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  guideDescPlan: 'Every plan the model presented in plan mode, kept per revision',
  ...
  plan: 'Plan',
  planEmpty: 'No plans in this session yet',
  planEmptyDesc: 'Present a plan from plan mode and it will appear here',
  planStatusPending: 'Pending review',
  planStatusApproved: 'Approved',
  planStatusUnadopted: 'Not adopted',
  planCopy: 'Copy plan',
  planLoadError: 'Could not load the plan; retrying',
  ...
  settingsPlanTitle: 'Open the Plan page when the model presents a plan',
  settingsPlanDesc: 'Open the sidebar Plan page when the model presents a plan in the current conversation; wide viewports also expand the side card, while narrow full-screen drawers are not forced open; turn off to open it manually',
