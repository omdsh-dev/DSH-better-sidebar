...
export const zh = {
  ...
  openWithChoose: '选择应用…',
  openWithTitle: '打开方式',
  openWithDesc: '输入应用名称，用所选应用打开「{path}」',
  openWithPlaceholder: '应用名称，例如 Visual Studio Code',
  openAction: '打开',
  openFailed: '操作失败',
  settingsNav: '侧边卡片',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  saveAs: 'Save As…',
  openWith: 'Open With',
  openWithDefault: 'Default App',
  openWithChoose: 'Choose App…',
  openWithTitle: 'Open With',
  openWithDesc: 'Enter an app name to open "{path}" with it',
  openWithPlaceholder: 'App name, e.g. Visual Studio Code',
  openAction: 'Open',
  openFailed: 'Operation failed',
