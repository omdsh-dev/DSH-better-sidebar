...
export const zh = {
  ...
  pluginTylinaDesc: 'DeepSeek Harness 中的 Typst 文档编辑器：直接编辑排版页面，并导出 PDF、视觉保真或实验性可编辑 PowerPoint；与当前会话工作区和 better-sidebar 的「Tylina」Tab 集成',
  ...
  pluginTylinaName: 'dsh-tylina Typst 文档编辑器',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  pluginTylinaDesc: 'Typst document editor for DeepSeek Harness: edit typeset pages directly, then export PDF, visually faithful PowerPoint, or experimental editable PowerPoint; integrates with the current session workspace and the better-sidebar "Tylina" tab',
  ...
  pluginTylinaName: 'dsh-tylina Typst Document Editor',
