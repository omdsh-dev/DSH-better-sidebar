...
export const zh = {
  ...
  settingsShortcutDesc: '选择右侧按键框后，直接按下新的组合键；需包含 Ctrl、Cmd 或 Alt（Shift 可叠加）；浏览器或系统保留的组合键可能无法录制',
  settingsShortcutRecording: '正在录制：按下组合键；Esc 取消',
  settingsShortcutPressKeys: '请按组合键…',
  settingsShortcutModifierRequired: '请同时按住 Ctrl、Cmd 或 Alt（可再加 Shift），再按另一个键',
  settingsShortcutUnsupported: '不支持这个按键；请使用字母、数字、功能键或导航键',
  settingsShortcutRecordAria: '录制「{shortcut}」快捷键',
  shortcutToggleSidebar: '开/关侧边栏',
  shortcutSaveEditor: '保存编辑',
  shortcutCommitGit: 'Git 提交',
  settingsPopup: '功能设置',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsShortcutDesc: 'Select the key field, then press the new combination; include Ctrl, Cmd, or Alt (Shift may be added); browser- or OS-reserved shortcuts may not be recordable',
  settingsShortcutRecording: 'Recording: press the shortcut now; Esc cancels',
  settingsShortcutPressKeys: 'Press shortcut…',
  settingsShortcutModifierRequired: 'Hold Ctrl, Cmd, or Alt (optionally with Shift) while pressing another key',
  settingsShortcutUnsupported: 'That key is not supported; use a letter, number, function key, or navigation key',
  settingsShortcutRecordAria: 'Record shortcut for {shortcut}',
  shortcutToggleSidebar: 'Toggle sidebar',
  shortcutSaveEditor: 'Save editor',
  shortcutCommitGit: 'Git commit',
