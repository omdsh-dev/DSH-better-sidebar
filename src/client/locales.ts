...
export const zh = {
  ...
  searchInDirectory: '查找功能',
  expandDirectory: '展开目录',
  collapseDirectory: '收起目录',
  createIn: '在 {dir} 中新建',
  searchScoped: '在 {dir} 中查找',
  newDirPlaceholder: '新目录名称',
  newFilePlaceholder: '新文件名称',
  renameDirLabel: '重命名目录',
  renameFileLabel: '重命名文件',
  confirmAction: '确定',
  creatingEntry: '创建中…',
  renamingEntry: '重命名中…',
  deletingEntry: '删除中…',
  nameRequired: '请输入名称',
  invalidEntryName: '名称不能为空，不能包含 / 或 \\，不能为 . 或 ..',
  deleteConfirmTitle: '确定要删除「{name}」吗？',
  deleteConfirmDesc: '将移入系统回收站（Trash），清空回收站前可在回收站中恢复。',
  trashedNotice: '「{name}」已移入回收站',
  permanentDeleteNotice: '「{name}」已永久删除（当前系统不支持回收站）',
  renamedNotice: '已重命名为「{name}」',
  createFailed: '创建失败',
  renameFailed: '重命名失败',
  deleteFailed: '删除失败',
  revealFailed: '无法在 Finder 中查看',
  searchPlaceholder: '按文件名或文件内容查找（遍历所有子目录）…',
  searchNoQuery: '输入关键词进行查找：匹配文件名或文件内容（遍历所有子目录）',
  searchEmpty: '未找到匹配的文件名或内容',
  searching: '查找中…',
  searchFailed: '查找失败',
  searchTruncated: '匹配结果过多，仅显示前 {count} 项（或已扫描 20000 个条目 / 2000 个文件内容）',
  closeSearch: '关闭查找',
  emptyDirectory: '空目录',
  directoryEmptyHint: '目录为空（右键空白处可新建或查找）',
  settingsNav: '侧边卡片',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  expandDirectory: 'Expand folder',
  collapseDirectory: 'Collapse folder',
  createIn: 'New in {dir}',
  searchScoped: 'Search in {dir}',
  newDirPlaceholder: 'New folder name',
  newFilePlaceholder: 'New file name',
  renameDirLabel: 'Rename folder',
  renameFileLabel: 'Rename file',
  confirmAction: 'OK',
  creatingEntry: 'Creating…',
  renamingEntry: 'Renaming…',
  deletingEntry: 'Deleting…',
  nameRequired: 'Enter a name',
  invalidEntryName: 'The name cannot be empty, contain / or \\, or be . or ..',
  deleteConfirmTitle: 'Delete "{name}"?',
  deleteConfirmDesc: 'The item will be moved to the system Trash and can be restored until the Trash is emptied.',
  trashedNotice: '"{name}" moved to the Trash',
  permanentDeleteNotice: '"{name}" was permanently deleted (no Trash on this system)',
  renamedNotice: 'Renamed to "{name}"',
  createFailed: 'Create failed',
  renameFailed: 'Rename failed',
  deleteFailed: 'Delete failed',
  revealFailed: 'Cannot reveal in Finder',
  searchPlaceholder: 'Search by file name or content (recurses into all subfolders)…',
  searchNoQuery: 'Type a keyword to search: matches file names and file contents (recurses into all subfolders)',
  searchEmpty: 'No matching file names or contents',
  searching: 'Searching…',
  searchFailed: 'Search failed',
  searchTruncated: 'Too many matches — showing the first {count} (or 20000 entries visited / 2000 contents scanned)',
  closeSearch: 'Close search',
  emptyDirectory: 'Empty folder',
  directoryEmptyHint: 'Folder is empty (right-click the empty area to create or search)',
