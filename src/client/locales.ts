...
export const zh = {
  ...
  synced: '已同步',
  pushTitle: '推送当前分支',
  pushDetail: '将「{branch}」推送到 {remote}/{branch}。',
  pushForceTitle: '强制推送当前分支',
  pushForceDetail: '将使用 --force-with-lease 强制推送「{branch}」（不会覆盖他人提交）。',
  timeJustNow: '刚刚',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  push: 'Push',
  synced: 'Synced',
  pushTitle: 'Push current branch',
  pushDetail: 'Push "{branch}" to {remote}/{branch}.',
  pushForceTitle: 'Force-push current branch',
  pushForceDetail: 'Force-push "{branch}" with --force-with-lease (cannot clobber others\' commits).',
