...
export const zh = {
  ...
  viewerVideo: '视频',
  videoUnsupported: '当前浏览器无法播放该视频，可下载后用本地播放器打开。',
  mediaLoadFailed: '无法加载该文件',
  viewerCode: '代码',
  viewerHtml: 'HTML',
  browser: '浏览器',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  viewerMarkdown: 'Markdown',
  viewerVideo: 'Video',
  videoUnsupported: 'This browser cannot play the video — download it and open it in a local player.',
  mediaLoadFailed: 'Could not load this file',
  viewerCode: 'Code',
  viewerHtml: 'HTML',
  browser: 'Browser',
