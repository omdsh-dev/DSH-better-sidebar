...
export const zh = {
  ...
  autoRefreshFiles: '自动刷新文件树',
  autoRefreshFilesDesc: '工作区文件变动时自动刷新文件管理器，无需手动点击刷新',
  ...
  settingsWidthSuffix: '%',
  settingsWidthPersistentTitle: '跨会话宽度一致',
  settingsWidthPersistentDesc: '所有会话共用同一个侧边栏宽度；拖动侧边栏宽度会同步更新默认宽度占比（同样限制在 20–60%）',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  autoRefreshFiles: 'Auto-refresh file tree',
  autoRefreshFilesDesc: 'Automatically refresh the file manager when workspace files change, without pressing refresh manually',
  ...
  settingsWidthSuffix: '%',
  settingsWidthPersistentTitle: 'Consistent width across conversations',
  settingsWidthPersistentDesc: 'All conversations share the same sidebar width; dragging the sidebar updates the default width share (also clamped to 20–60%)',
