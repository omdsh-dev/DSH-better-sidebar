...
export const zh = {
  ...
  settingsFileIconsTitle: '文件图标',
  settingsFileIconsDesc: '选择文件树的图标主题（品牌彩色图标 / 第三方图标库）',
  settingsPopup: '功能设置',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsFileIconsTitle: 'File icons',
  settingsFileIconsDesc: 'Choose the file tree icon theme (brand-colored / third-party icon packs)',
