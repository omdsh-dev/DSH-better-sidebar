...
export const zh = {
  ...
  enterCodeFocus: '全屏',
  exitCodeFocus: '退出全屏',
  resizeSidebar: '调整侧边栏宽度；拖到最右侧可隐藏',
  releaseToHideSidebar: '松手隐藏侧边栏',
  ...
  createFolder: '新建文件夹',
  newFileName: '输入文件名',
  newFolderName: '输入文件夹名',
  createNameRequired: '请输入名称',
  createNameInvalid: '名称不能是 .、.. 或包含路径分隔符',
  creating: '正在创建…',
  createDone: '已创建 {path}',
  createFailed: '创建失败：{error}',
  operationBusy: '另一项文件操作正在进行',
  importFiles: '导入文件',
  importFolder: '导入文件夹',
  deleteFile: '删除文件',
  deleteFileTitle: '删除文件',
  deleteFileDesc: '将永久删除「{path}」。此操作无法撤销。',
  deleteFolder: '删除文件夹',
  deleteFolderTitle: '删除文件夹',
  deleteFolderDesc: '将永久删除文件夹「{path}」及其中的全部内容。此操作无法撤销。',
  deleteSymlink: '删除符号链接',
  deleteSymlinkTitle: '删除符号链接',
  deleteSymlinkDesc: '将删除符号链接「{path}」，不会删除它指向的内容。此操作无法撤销。',
  deleting: '正在删除…',
  deleteDone: '已删除 {path}',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  enterCodeFocus: 'Fullscreen',
  exitCodeFocus: 'Exit fullscreen',
  resizeSidebar: 'Resize sidebar; drag to the far right to hide',
  releaseToHideSidebar: 'Release to hide sidebar',
  ...
  createNameInvalid: 'Names cannot be . or .. or contain path separators',
  creating: 'Creating…',
  createDone: 'Created {path}',
  createFailed: 'Create failed: {error}',
  operationBusy: 'Another file operation is in progress',
  importFiles: 'Import Files',
  importFolder: 'Import Folder',
  deleteFile: 'Delete File',
  deleteFileTitle: 'Delete File',
  deleteFileDesc: 'Permanently delete “{path}”? This action cannot be undone.',
  deleteFolder: 'Delete Folder',
  deleteFolderTitle: 'Delete Folder',
  deleteFolderDesc: 'Permanently delete “{path}” and everything inside it? This action cannot be undone.',
  deleteSymlink: 'Delete Symbolic Link',
  deleteSymlinkTitle: 'Delete Symbolic Link',
  deleteSymlinkDesc: 'Delete the symbolic link “{path}”? Its target will not be deleted. This action cannot be undone.',
  deleting: 'Deleting…',
  deleteDone: 'Deleted {path}',
