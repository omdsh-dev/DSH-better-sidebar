...
export const zh = {
  ...
  settingsWhiteOpacityDesc: '调整侧边卡片白色背景的不透明程度，0% 完全透明，100% 完全不透明',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsWidthSuffix: '%',
  settingsWhiteOpacityTitle: 'White background opacity',
  settingsWhiteOpacityDesc: 'Adjust the white sidebar surface: 0% is fully transparent and 100% is fully opaque',
