...
export const zh = {
  ...
  mcp: 'MCP',
  mcpEmpty: '未连接任何 MCP 服务器',
  mcpEmptyDesc: '通过 dsh-mcp-client 挂载的 MCP 服务器及其工具将显示在这里',
  subagent: '任务管理',
  openSubagent: '任务管理',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  mcpEmptyDesc: 'MCP servers mounted through dsh-mcp-client and their tools will appear here',
  subagent: 'Tasks',
  openSubagent: 'Tasks',
