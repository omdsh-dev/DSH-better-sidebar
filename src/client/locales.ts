...
export const zh = {
  ...
  toc: '目录',
  review: '审查',
  reviewPending: '{count} 项待审查',
  reviewNoRepo: '当前目录不是 Git 仓库',
  reviewAccepted: '已接受',
  accept: '接受',
  acceptAll: '全部接受',
  reject: '拒绝',
  rejectUntracked: '新文件没有可回退的提交版本',
  find: '查找',
  findPrev: '上一个匹配',
  findNext: '下一个匹配',
  findClose: '关闭查找',
  ...
  browserLocalBlockedTitle: '信任并打开 {authority}？',
  browserLocalBlockedDesc: '这是你电脑上的本地服务。仅在你启动或信任此 Web 应用时允许访问。此权限只授予这个地址和端口',
  browserTrustAndOpen: '信任并打开',
  browserTrusting: '正在保存…',
  browserTrustFailed: '无法保存此本机地址。请检查侧栏设置服务后重试',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  review: 'Review',
  reviewPending: '{count} to review',
  reviewNoRepo: 'Not a Git repository',
  reviewAccepted: 'Accepted',
  accept: 'Accept',
  acceptAll: 'Accept all',
  reject: 'Reject',
  rejectUntracked: 'A new file has no committed version to restore',
  find: 'Find',
  ...
  browserLocalBlockedTitle: 'Trust and open {authority}?',
  browserLocalBlockedDesc: 'This is a service on your computer. Allow it only when you started or trust the web app. Access applies only to this address and port.',
  browserTrustAndOpen: 'Trust and open',
  browserTrusting: 'Saving…',
  browserTrustFailed: 'Could not save this local address. Check the sidebar settings service and try again.',
