...
export const zh = {
  ...
  settingsSearchExcludeTitle: '搜索排除目录',
  settingsSearchExcludeDesc: '文件名搜索时跳过这些目录（逗号分隔；任意深度同名目录均排除）',
  settingsSearchExcludePlaceholder: '.smart-env, .obsidian',
  ...
  settingsImageDirTitle: 'Obsidian 图片目录',
  settingsImageDirDesc: '![[图.png]] 的解析与粘贴保存目录：相对会话目录（默认 images）或绝对路径',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: '预览配色主题',
  settingsMdPreviewThemeDesc: '仅作用于 Markdown 文件预览，不影响侧边对话与文件变动阅读模式',
  settingsMdPreviewThemeVivid: '鲜明',
  settingsMdPreviewThemeVividDesc: '标题、引用、表头等用语义色拉高对比',
  settingsMdPreviewThemeHost: '宿主',
  settingsMdPreviewThemeHostDesc: '保持宿主 MarkdownText 原样配色',
  viewerCode: '代码',
  viewerBinary: '二进制下载',
  viewerHtml: 'HTML',
  browser: '浏览器',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsSearchExcludeTitle: 'Directories excluded from search',
  settingsSearchExcludeDesc: 'Skip these directories during filename search (comma-separated; same name at any depth is excluded)',
  settingsSearchExcludePlaceholder: '.smart-env, .obsidian',
  ...
  viewerPdf: 'PDF',
  viewerMarkdown: 'Markdown',
  settingsImageDirTitle: 'Obsidian image directory',
  settingsImageDirDesc: 'Directory for ![[x.png]] embeds and pasted images: relative to the session cwd (default images), or an absolute path',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'Preview color theme',
  settingsMdPreviewThemeDesc: 'Applies only to Markdown file preview — not Side Chat or Changes reading mode',
  settingsMdPreviewThemeVivid: 'Vivid',
  settingsMdPreviewThemeVividDesc: 'Richer heading, quote, and table accents via semantic skin tokens',
  settingsMdPreviewThemeHost: 'Host',
  settingsMdPreviewThemeHostDesc: 'Keep the host MarkdownText colors as-is',
  viewerCode: 'Code',
