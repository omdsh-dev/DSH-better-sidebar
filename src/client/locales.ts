...
export const zh = {
  ...
  git: '源代码管理',
  terminal: '终端',
  restartHost: '重启 DSH Web',
  restartHostStarting: '正在重启 DSH Web…',
  restartHostFailed: '重启失败，点击重试',
  editor: '编辑器',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  git: 'Source Control',
  terminal: 'Terminal',
  restartHost: 'Restart DSH Web',
  restartHostStarting: 'Restarting DSH Web…',
  restartHostFailed: 'Restart failed — click to retry',
  editor: 'Editor',
