...
export const zh = {
  ...
  settingsAutoCollapseTitle: '任务结束后自动收起侧边栏',
  settingsAutoCollapseDesc: '自动激活把原本折叠的侧边栏展开时，等当前会话的子代理与后台任务全部结束、并保持空闲片刻后，自动把这侧边栏收回（只收面板，标签页保留）；你原本就展开的面板不动。默认关闭',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsAutoCollapseTitle: 'Auto-collapse the side card once the activity settles',
  settingsAutoCollapseDesc: 'When the auto-activation expands a collapsed side card, collapse it again once this conversation\'s subagents and background jobs have all settled and stayed idle for a moment (the tab stays open; a card you had already expanded is never touched). Off by default',
