...
export const zh = {
  ...
  sandboxRestore: '恢复沙箱',
  settingsEditorVimTitle: '编辑器 vim 键位',
  settingsEditorVimDesc: '开启后，代码 / Markdown 编辑器启用 vim 键位（普通 / 插入 / 可视模式，hjkl、dd、yy、p 等）；保存仍为 Ctrl/Cmd+S，开关对已打开的编辑器即时生效',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsEditorVimTitle: 'Vim keybindings in the editor',
  settingsEditorVimDesc: 'When on, the code/markdown editor enables vim keybindings (normal/insert/visual modes — hjkl, dd, yy, p, ...); saving stays Ctrl/Cmd+S, and the toggle applies to already-open editors immediately',
