...
export const zh = {
  ...
  subagentDelete: '永久删除',
  subagentDeleteConfirm: '永久删除',
  subagentDeleteDesc: '将永久删除子代理「{name}」及其全部记录（含其子代理），此操作不可恢复。',
  subagentDeleteRunning: '运行中，无法删除',
  subagentDeleteUnavailable: '需要安装 @michengai/dsh-archive-manager 插件才能删除',
  sideChat: '侧边对话(beta)',
  sideChatNew: '新建对话',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  subagentDelete: 'Delete permanently',
  subagentDeleteConfirm: 'Delete permanently',
  subagentDeleteDesc: 'This permanently deletes the subagent "{name}" and all of its records (including its child agents). This cannot be undone.',
  subagentDeleteRunning: 'Running — cannot delete',
  subagentDeleteUnavailable: 'Requires the @michengai/dsh-archive-manager plugin',
