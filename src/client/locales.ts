...
export const zh = {
  ...
  settingsShellTitle: '终端',
  settingsShellSelectTitle: '默认终端',
  settingsShellSelectDesc: '选择新终端使用的 Shell',
  settingsShellDefault: '系统默认',
  settingsShellDefaultDesc: '使用平台默认 Shell',
  settingsShellDetectTitle: '重新检测系统终端',
  settingsPopup: '功能设置',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsShellTitle: 'Terminal',
  settingsShellSelectTitle: 'Default shell',
  settingsShellSelectDesc: 'Choose which shell new terminals use',
  settingsShellDefault: 'System default',
  settingsShellDefaultDesc: 'Use the platform default shell',
  settingsShellDetectTitle: 'Re-detect system shells',
