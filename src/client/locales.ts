...
export const zh = {
  ...
  editorExplorerMergedDesc: '首个文件在文件窗口内打开；后续文件在顶部新标签页中打开',
  ...
  visualEdit: '可视化',
  sourceEdit: '源码',
  visualEditorFailed: '可视化 Markdown 编辑器加载失败',
  draftConflictRestored: '已恢复未保存草稿，但磁盘文件已发生变化。请选择重新加载或覆盖。',
  saveConflict: '文件已被代理或其他程序修改。未覆盖磁盘内容。',
  reloadDisk: '重新加载磁盘版本',
  overwriteDisk: '用当前草稿覆盖',
  ...
  moveDestinationPlaceholder: '目标路径（相对工作区或绝对路径）',
  deleteEntryTitle: '永久删除',
  deleteEntryDesc: '将永久删除「{path}」。此操作不可撤销。',
  deleteEntryDirtyDesc: '其中有 {count} 个未保存草稿；删除后这些恢复副本也会清除。',
  fileOperationFailed: '文件操作失败',
  uploadingFiles: '正在上传 {count} 个文件…',
  dropFilesHere: '拖放文件或文件夹以上传',
  openEditor: '打开编辑器',
  gitDetail: '查看变更详情',
  referenceFile: '@文件',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  editorExplorerMergedDesc: 'The first file uses the Files window; later files open in top tabs',
  ...
  visualEdit: 'Visual',
  sourceEdit: 'Source',
  visualEditorFailed: 'The visual Markdown editor failed to load',
  draftConflictRestored: 'An unsaved draft was restored, but the disk file has changed. Reload it or overwrite it with the draft.',
  saveConflict: 'An agent or another program changed this file. The disk copy was not overwritten.',
  reloadDisk: 'Reload disk version',
  overwriteDisk: 'Overwrite with this draft',
  ...
  create: 'Create',
  entryNamePlaceholder: 'Enter a name',
  moveDestinationPlaceholder: 'Destination path (workspace-relative or absolute)',
  deleteEntryTitle: 'Permanently delete',
  deleteEntryDesc: '“{path}” will be permanently deleted. This cannot be undone.',
  deleteEntryDirtyDesc: '{count} unsaved draft(s) are inside it; their recovery copies will also be removed.',
  fileOperationFailed: 'File operation failed',
  uploadingFiles: 'Uploading {count} file(s)…',
  dropFilesHere: 'Drop files or folders to upload',
