...
export const zh = {
  ...
  settingsExplorerExcludeTitle: '排除模式',
  settingsExplorerExcludeDesc: '条目名称匹配任一模式（单个 * 通配，大小写不敏感）时在树中隐藏，每行一个',
  settingsExplorerExcludePlaceholder: '例如：*.meta、.DS_Store、node_modules、build*',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsExplorerExcludeTitle: 'Exclude patterns',
  settingsExplorerExcludeDesc: 'Entries whose name matches any pattern (single * wildcard, case-insensitive) are hidden from the tree; one per line',
  settingsExplorerExcludePlaceholder: 'e.g. *.meta, .DS_Store, node_modules, build*',
