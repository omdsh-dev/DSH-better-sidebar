...
export const zh = {
  ...
  settingsWidthSuffix: '%',
  settingsShortcutPanelTitle: '侧边栏开关快捷键',
  settingsShortcutPanelDesc: '唤起或收起侧边卡片（点击后按下新组合键；Backspace/Delete 禁用）',
  settingsShortcutTerminalTitle: '底部面板开关快捷键',
  settingsShortcutTerminalDesc: '唤起或收起底部面板（终端）；窄窗口下改为切换合并侧边栏（点击后按下新组合键；Backspace/Delete 禁用）',
  shortcutCaptureHint: '按下组合键…',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsWidthSuffix: '%',
  settingsShortcutPanelTitle: 'Sidebar toggle shortcut',
  settingsShortcutPanelDesc: 'Show or hide the side card (click, then press the new combo; Backspace/Delete disables)',
  settingsShortcutTerminalTitle: 'Bottom panel toggle shortcut',
  settingsShortcutTerminalDesc: 'Show or hide the bottom panel (the terminal); on narrow windows it toggles the merged sidebar instead (click, then press the new combo; Backspace/Delete disables)',
  shortcutCaptureHint: 'Press a combo…',
