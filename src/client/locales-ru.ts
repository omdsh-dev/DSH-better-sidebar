...
export const ru: Record<string, string> = {
  ...
  explorerExclude: 'Шаблоны исключения',
  explorerExcludeDesc: 'Полностью убирает совпадающие записи из дерева файлов и поиска (поддерживаются * и ?, префикс **/ совпадает на любой глубине); исключённые записи никогда не блокируют свёртывание хлебных крошек',
  explorerExcludePlaceholder: 'Добавьте шаблон, напр. node_modules, *.log, **/.git',
  explorerExcludeAdd: 'Добавить',
  explorerExcludeRemove: 'Убрать',
