...
export const ru: Record<string, string> = {
  ...
  viewerVideo: 'Видео',
  videoUnsupported: 'Этот браузер не может воспроизвести видео — скачайте файл и откройте его в локальном плеере.',
  mediaLoadFailed: 'Не удалось загрузить этот файл',
  viewerCode: 'Код',
  viewerHtml: 'HTML',
  browser: 'Браузер',
