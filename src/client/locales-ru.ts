...
export const ru: Record<string, string> = {
  enterCodeFocus: 'Полноэкранный режим',
  exitCodeFocus: 'Выйти из полноэкранного режима',
  resizeSidebar: 'Измените ширину боковой панели; перетащите до правого края, чтобы скрыть',
  releaseToHideSidebar: 'Отпустите, чтобы скрыть боковую панель',
  createFile: 'Новый файл',
  createFolder: 'Новая папка',
  newFileName: 'Имя файла',
  newFolderName: 'Имя папки',
  createNameRequired: 'Введите имя',
  createNameInvalid: 'Имя не может быть . или .. и не должно содержать разделители пути',
  creating: 'Создание…',
  createDone: '{path} создан',
  createFailed: 'Не удалось создать: {error}',
  operationBusy: 'Выполняется другая файловая операция',
  importFiles: 'Импортировать файлы',
  importFolder: 'Импортировать папку',
  deleteFile: 'Удалить файл',
  deleteFileTitle: 'Удалить файл',
  deleteFileDesc: 'Навсегда удалить «{path}»? Это действие нельзя отменить.',
  deleteFolder: 'Удалить папку',
  deleteFolderTitle: 'Удалить папку',
  deleteFolderDesc: 'Навсегда удалить «{path}» и всё её содержимое? Это действие нельзя отменить.',
  deleteSymlink: 'Удалить символическую ссылку',
  deleteSymlinkTitle: 'Удалить символическую ссылку',
  deleteSymlinkDesc: 'Удалить символическую ссылку «{path}»? Её цель не будет удалена. Это действие нельзя отменить.',
  deleting: 'Удаление…',
  deleteDone: '{path} удалён',
