...
export const ru: Record<string, string> = {
  ...
  guideDescSubagent: 'Граф рабочего процесса, доска задач команды и фоновые задания в реальном времени',
  ...
  tasksViewGraph: 'Граф рабочего процесса',
  tasksViewTree: 'Дерево',
  tasksViewSwitchToGraph: 'Переключить на граф рабочего процесса',
  tasksViewSwitchToTree: 'Переключить на дерево',
  settingsViewModeTitle: 'Вид страницы задач по умолчанию',
  settingsViewModeDesc: 'Как отображается страница задач при открытии (переключатель на странице всё ещё меняет её на лету)',
  settingsViewModeGraph: 'Граф рабочего процесса',
  ...
  tasksFoldExpand: 'Развернуть завершённые узлы',
  tasksFoldCollapse: 'Свернуть завершённые узлы',
  tasksZoomIn: 'Увеличить',
  ...
  tasksNodeTeamRole: 'Роль в команде',
  tasksNodeActivity: 'Последняя активность',
  tasksStateRunning: 'Выполняется',
  tasksStateIdle: 'Ожидает',
  tasksStateDone: 'Завершено',
  tasksStateError: 'Ошибка',
  teamBoard: 'Доска задач команды',
  teamChip: 'Команда: {members} участников · {tasks} задач',
  teamTasksEmpty: 'Общих задач пока нет',
  teamTaskCreate: 'Новая задача',
  teamTaskSubject: 'Тема',
  teamTaskDescription: 'Описание',
  teamTaskOwner: 'Ответственный',
  teamTaskUnowned: 'Не занята',
  teamTaskPending: 'Ожидает',
  teamTaskInProgress: 'В работе',
  teamTaskCompleted: 'Завершена',
  teamTaskBlocked: 'Заблокирована',
  teamTaskComplete: 'Завершить',
  teamTaskReopen: 'Открыть снова',
  teamTaskDelete: 'Удалить',
  teamTaskDeleteConfirm: 'Подтвердите удаление',
  teamTaskEdit: 'Изменить',
  teamTaskSave: 'Сохранить',
  teamTaskCancel: 'Отмена',
  teamTaskConflict: 'Задача изменена другим участником, обновлено',
  teamTaskError: 'Не удалось выполнить: {message}',
  teamTaskDeleted: 'Удалена',
  teamTaskActions: 'Действия с задачей',
  teamTaskDetail: 'Детали задачи',
  teamTaskNoDescription: 'Описание пока отсутствует — нажмите «Изменить», чтобы добавить',
  teamTaskBlockedBy: 'Заблокирована задачей',
  teamTaskSubjectPlaceholder: 'Опишите работу одной строкой',
  teamTaskDescriptionPlaceholder: 'Дополнительные сведения (необязательно)',
  teamFilterAll: 'Все',
  tasksNodeTasks: 'Общие задачи',
  jobCopyOutput: 'Копировать вывод',
  jobCopied: 'Скопировано',
  jobFollowTail: 'Следить за новыми строками',
  jobDragHint: 'Перетащите, чтобы переместить',
  workflowRunning: 'Выполняется',
  workflowCompleted: 'Завершён',
  workflowCancelled: 'Отменён',
  workflowFailed: 'Сбой',
  workflowPhaseUnnamed: 'Безымянная фаза',
  workflowMembers: '{done}/{total} участников',
  jobsAutoCollapsed: 'Свернуто автоматически (много агентов)',
  catalogLoadFailed: 'Не удалось загрузить ветки: {count}',
