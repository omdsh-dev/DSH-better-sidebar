...
export const ru: Record<string, string> = {
  ...
  findNext: 'Далее',
  findPrevious: 'Назад',
  findAll: 'Выделить всё',
  findMatchCase: 'Учитывать регистр',
  findRegexp: 'Регулярное выражение',
  findByWord: 'Слово целиком',
  replaceOne: 'Заменить',
  ...
  closeUnsavedConfirm: 'В файле есть несохранённые изменения. Закрытие вкладки их отменит. Продолжить?',
  save: 'Сохранить',
  saved: 'Сохранено',
  unsaved: 'Не сохранено',
  saveFailed: 'Не удалось сохранить',
  saveConflict: 'Файл был изменён на диске другим источником. Сохранение прервано; ваши правки остались в редакторе.',   saveConflictReload: 'Перезагрузить с диска',
