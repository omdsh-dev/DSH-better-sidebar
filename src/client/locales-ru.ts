...
export const ru: Record<string, string> = {
  ...
  toc: 'Оглавление',
  review: 'Проверка',
  reviewPending: 'На проверку: {count}',
  reviewNoRepo: 'Это не репозиторий Git',
  reviewAccepted: 'Принято',
  accept: 'Принять',
  acceptAll: 'Принять все',
  reject: 'Отклонить',
  rejectUntracked: 'У нового файла нет зафиксированной версии для восстановления',
  find: 'Поиск',
  ...
  browserLocalBlockedTitle: 'Доверять {authority} и открыть?',
  browserLocalBlockedDesc: 'Это локальная служба на вашем компьютере. Разрешайте доступ, только если вы запустили это веб-приложение или доверяете ему. Доступ действует только для этого адреса и порта.',
  browserTrustAndOpen: 'Доверять и открыть',
  browserTrusting: 'Сохранение…',
  browserTrustFailed: 'Не удалось сохранить локальный адрес. Проверьте службу настроек боковой панели и повторите попытку.',
