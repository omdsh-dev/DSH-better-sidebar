...
export const ru: Record<string, string> = {
  ...
  searchFind: 'Найти',
  searchReplace: 'Заменить',
  searchNext: 'Далее',
  searchPrevious: 'Назад',
  searchAll: 'Выделить все',
  searchMatchCase: 'Учитывать регистр',
  searchWholeWord: 'Слово целиком',
  searchRegexp: 'Регулярное выражение',
  searchReplaceAll: 'Заменить все',
  searchCurrentMatch: 'Текущее совпадение',
  searchOnLine: 'в строке',
  searchReplacedMatches: 'заменено совпадений: $',
  searchReplacedMatchOnLine: 'совпадение в строке $ заменено',
  searchGoToLine: 'Перейти к строке',
  searchGo: 'Перейти',
