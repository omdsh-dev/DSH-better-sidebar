...
export const ru: Record<string, string> = {
  ...
  subagentDelete: "Удалить навсегда",
  subagentDeleteConfirm: "Удалить навсегда",
  subagentDeleteDesc: "Навсегда удаляет субагента «{name}» и все его записи (включая дочерних субагентов). Это действие необратимо.",
  subagentDeleteRunning: "Работает — удаление невозможно",
  subagentDeleteUnavailable: "Требуется плагин @michengai/dsh-archive-manager",
