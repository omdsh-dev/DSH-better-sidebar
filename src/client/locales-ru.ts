...
export const ru: Record<string, string> = {
  ...
  settingsEditorVimTitle: 'vim-привязки в редакторе',
  settingsEditorVimDesc: 'При включении редактор кода/Markdown использует vim-привязки клавиш (режимы normal/insert/visual — hjkl, dd, yy, p и т.д.); сохранение остаётся на Ctrl/Cmd+S, переключатель сразу применяется к открытым редакторам',
