...
export const ru: Record<string, string> = {
  ...
  settingsAutoCollapseTitle: 'Автоматически сворачивать боковую панель после завершения задач',
  settingsAutoCollapseDesc: 'Когда автоактивация разворачивает свёрнутую боковую панель, она сворачивается обратно, как только все субагенты и фоновые задачи текущей сессии завершатся и останутся неактивными на мгновение (закрывается только панель, вкладка остаётся; панель, развёрнутая вами вручную, не затрагивается). По умолчанию выключено',
