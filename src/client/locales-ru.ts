...
export const ru: Record<string, string> = {
  ...
  guideDescPlan: 'Планы, представленные моделью в режиме планирования, хранятся по версиям',
  ...
  plan: 'План',
  planEmpty: 'В этой сессии пока нет планов',
  planEmptyDesc: 'Попросите модель составить план в режиме планирования — он появится здесь',
  planStatusPending: 'Ожидает рассмотрения',
  planStatusApproved: 'Одобрен',
  planStatusUnadopted: 'Не принят',
  planCopy: 'Копировать план',
  planLoadError: 'Не удалось загрузить план; повторная попытка',
  ...
  settingsPlanTitle: 'Автоматически активировать страницу «План», когда модель представляет план',
  settingsPlanDesc: 'Когда модель представляет план в текущей сессии, автоматически активируется страница «План»; на широких экранах также разворачивается боковая панель, а на узких экранах полноэкранная выдвижная панель не открывается принудительно; отключите, чтобы выбирать страницу вручную',
