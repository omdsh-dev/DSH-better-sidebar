...
export const ru: Record<string, string> = {
  ...
  settingsSearchExcludeTitle: 'Каталоги, исключённые из поиска',
  settingsSearchExcludeDesc: 'Пропускать эти каталоги при поиске по имени файла (через запятую; одноимённые каталоги на любой глубине исключаются)',
  ...
  settingsImageDirTitle: 'Каталог изображений Obsidian',
  settingsImageDirDesc: 'Каталог для встраиваний ![[x.png]] и вставленных изображений: относительно cwd сессии (по умолчанию images) или абсолютный путь',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'Цветовая тема предпросмотра',
  settingsMdPreviewThemeDesc: 'Только для предпросмотра Markdown-файлов — не для Side Chat и режима чтения Changes',
  settingsMdPreviewThemeVivid: 'Яркая',
  settingsMdPreviewThemeVividDesc: 'Более контрастные заголовки, цитаты и таблицы через семантические токены',
  settingsMdPreviewThemeHost: 'Хост',
  settingsMdPreviewThemeHostDesc: 'Оставить цвета MarkdownText хоста без изменений',
  viewerCode: 'Код',
