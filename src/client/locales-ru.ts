...
export const ru: Record<string, string> = {
  ...
  editorContentMode: 'Режим просмотра содержимого',
  ...
  fileCommentsPanel: 'Комментарии к текущему файлу',
  fileCommentsCurrent: 'Текущие',
  fileCommentsSend: 'Отправить выбранные комментарии Agent',
  fileCommentsSendShort: 'Отправить',
  fileCommentsSendFailed: 'Не удалось отправить комментарии: {error}',
  fileCommentsEmptyCurrent: 'Для этого файла нет неотправленных комментариев',
  fileCommentsEmptyHistory: 'Для этого файла нет отправленных комментариев',
  fileCommentsSelectionOmitted: 'Выделение слишком длинное; будет отправлена только позиция в файле',
  fileCommentsEdit: 'Изменить комментарий',
  fileCommentsDelete: 'Удалить комментарий',
  fileCommentsSelect: 'Выбрать комментарий',
  fileCommentsSelectAll: 'Выбрать все',
  fileCommentsClearSelection: 'Отменить',
  fileCommentsDeleteSelected: 'Удалить',
  fileCommentsPlaceholder: 'Добавить комментарий к выделению…',
