...
export const ru: Record<string, string> = {
  ...
  generatingCommitMessage: 'Создание сообщения коммита…',
  suggestCommitError: 'Не удалось создать сообщение коммита',
  suggestCommitEmpty: 'Нет ожидающих изменений',
  push: 'Отправить',
  pull: 'Получить',
  pushError: 'Не удалось отправить',
  pullError: 'Не удалось получить',
  branch: 'Ветка',
