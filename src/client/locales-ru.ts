...
export const ru: Record<string, string> = {
  ...
  allowOutsideFiles: 'Разрешить открывать файлы вне рабочей области',
  allowOutsideFilesDesc: 'Режим только для чтения: боковая панель может просматривать файлы/папки вне рабочей области сеанса; редактирование, сохранение и загрузка остаются только внутри рабочей области.',
  externalReadonly: 'Внешний · только чтение',
