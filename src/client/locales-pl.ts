...
export const pl: Record<string, string> = {
  ...
  pasteImageFailed: 'Wklejenie obrazu nie powiodło się',
  ...
  settingsSearchExcludeTitle: 'Katalogi wykluczone z wyszukiwania',
  settingsSearchExcludeDesc: 'Pomijaj te katalogi podczas wyszukiwania po nazwie pliku (oddzielone przecinkami; ta sama nazwa na dowolnej głębokości jest wykluczana)',
  ...
  settingsImageDirTitle: 'Katalog obrazów Obsidian',
  settingsImageDirDesc: 'Katalog osadzeń ![[x.png]] i wklejonych obrazów: względem cwd sesji (domyślnie images) lub ścieżka bezwzględna',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'Motyw kolorów podglądu',
  settingsMdPreviewThemeDesc: 'Dotyczy tylko podglądu plików Markdown — nie Side Chat ani trybu czytania Changes',
  settingsMdPreviewThemeVivid: 'Wyrazisty',
  settingsMdPreviewThemeVividDesc: 'Bogatsze akcenty nagłówków, cytatów i tabel przez tokeny semantyczne',
  settingsMdPreviewThemeHost: 'Host',
  settingsMdPreviewThemeHostDesc: 'Zachowaj kolory MarkdownText hosta bez zmian',
  viewerCode: 'Kod',
