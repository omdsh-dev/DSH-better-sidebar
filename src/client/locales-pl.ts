...
export const pl: Record<string, string> = {
  ...
  toc: 'Spis treści',
  review: 'Przegląd',
  reviewPending: '{count} do przeglądu',
  reviewNoRepo: 'To nie jest repozytorium Git',
  reviewAccepted: 'Zaakceptowano',
  accept: 'Akceptuj',
  acceptAll: 'Akceptuj wszystko',
  reject: 'Odrzuć',
  rejectUntracked: 'Nowy plik nie ma zatwierdzonej wersji do przywrócenia',
  find: 'Znajdź',
  ...
  browserLocalBlockedTitle: 'Zaufać {authority} i otworzyć?',
  browserLocalBlockedDesc: 'To jest usługa lokalna na tym komputerze. Zezwól tylko wtedy, gdy uruchomiono tę aplikację internetową lub jest ona zaufana. Dostęp dotyczy wyłącznie tego adresu i portu.',
  browserTrustAndOpen: 'Zaufaj i otwórz',
  browserTrusting: 'Zapisywanie…',
  browserTrustFailed: 'Nie udało się zapisać tego adresu lokalnego. Sprawdź usługę ustawień paska bocznego i spróbuj ponownie.',
