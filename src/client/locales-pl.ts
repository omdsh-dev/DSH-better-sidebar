...
export const pl: Record<string, string> = {
  enterCodeFocus: 'Pełny ekran',
  exitCodeFocus: 'Wyjdź z pełnego ekranu',
  resizeSidebar: 'Zmień szerokość panelu bocznego; przeciągnij do prawej krawędzi, aby go ukryć',
  releaseToHideSidebar: 'Puść, aby ukryć panel boczny',
  createFile: 'Nowy plik',
  createFolder: 'Nowy folder',
  newFileName: 'Nazwa pliku',
  newFolderName: 'Nazwa folderu',
  createNameRequired: 'Wprowadź nazwę',
  createNameInvalid: 'Nazwa nie może być . ani .. i nie może zawierać separatorów ścieżki',
  creating: 'Tworzenie…',
  createDone: 'Utworzono {path}',
  createFailed: 'Nie udało się utworzyć: {error}',
  operationBusy: 'Trwa inna operacja na plikach',
  importFiles: 'Importuj pliki',
  importFolder: 'Importuj folder',
  deleteFile: 'Usuń plik',
  deleteFileTitle: 'Usuń plik',
  deleteFileDesc: 'Trwale usunąć „{path}”? Tej operacji nie można cofnąć.',
  deleteFolder: 'Usuń folder',
  deleteFolderTitle: 'Usuń folder',
  deleteFolderDesc: 'Trwale usunąć „{path}” i całą jego zawartość? Tej operacji nie można cofnąć.',
  deleteSymlink: 'Usuń dowiązanie symboliczne',
  deleteSymlinkTitle: 'Usuń dowiązanie symboliczne',
  deleteSymlinkDesc: 'Usunąć dowiązanie symboliczne „{path}”? Jego cel nie zostanie usunięty. Tej operacji nie można cofnąć.',
  deleting: 'Usuwanie…',
  deleteDone: 'Usunięto {path}',
