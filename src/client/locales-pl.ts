...
export const pl: Record<string, string> = {
  ...
  searchFind: 'Szukaj',
  searchReplace: 'Zamień',
  searchNext: 'Następny',
  searchPrevious: 'Poprzedni',
  searchAll: 'Zaznacz wszystko',
  searchMatchCase: 'Uwzględnij wielkość liter',
  searchWholeWord: 'Całe słowo',
  searchRegexp: 'Regexp',
  searchReplaceAll: 'Zamień wszystko',
  searchCurrentMatch: 'Bieżące dopasowanie',
  searchOnLine: 'w wierszu',
  searchReplacedMatches: 'zamieniono $ dopasowań',
  searchReplacedMatchOnLine: 'zamieniono dopasowanie w wierszu $',
  searchGoToLine: 'Przejdź do wiersza',
  searchGo: 'Przejdź',
