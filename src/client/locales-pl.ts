...
export const pl: Record<string, string> = {
  ...
  replace: 'Zamień',
  findNext: 'Następne',
  findPrevious: 'Poprzednie',
  findAll: 'Zaznacz wszystko',
  findMatchCase: 'Uwzględnij wielkość liter',
  findRegexp: 'Regex',
  findByWord: 'Całe słowo',
  replaceOne: 'Zamień',
  ...
  closeUnsavedConfirm: 'Ten plik ma niezapisane zmiany. Zamknięcie karty je odrzuci. Kontynuować?',
  save: 'Zapisz',
  saved: 'Zapisano',
  unsaved: 'Niezapisane',
  saveFailed: 'Zapis nie powiódł się',
  saveConflict: 'Plik został zmieniony na dysku przez inne źródło. Zapis przerwany; zmiany pozostają w edytorze.',   saveConflictReload: 'Wczytaj ponownie z dysku',
