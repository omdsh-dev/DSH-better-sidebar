...
export const pl: Record<string, string> = {
  ...
  sideChatBlockNoExitCode: "Zakończono bez kodu wyjścia",
  ...
  codeBlockWrap: 'Zawijanie wierszy',
  ...
  tasksViewGraph: 'Graf przepływu pracy',
  tasksViewTree: 'Drzewo',
  tasksViewSwitchToGraph: 'Przełącz na graf przepływu pracy',
  tasksViewSwitchToTree: 'Przełącz na drzewo',
  settingsViewModeTitle: 'Domyślny widok strony zadań',
  settingsViewModeDesc: 'Jak strona zadań renderuje się po otwarciu (przełącznik na stronie nadal działa doraźnie)',
  settingsViewModeGraph: 'Graf przepływu pracy',
  ...
  tasksFoldCollapse: 'Zwiń ukończone węzły',
  tasksZoomIn: 'Przybliż',
  tasksZoomOut: 'Oddal',
  ...
  tasksNodeTeamRole: 'Rola w zespole',
  tasksNodeActivity: 'Ostatnia aktywność',
  tasksStateRunning: 'Działa',
  tasksStateIdle: 'Gotowe',
  tasksStateDone: 'Ukończone',
  tasksStateError: 'Błąd',
  teamBoard: 'Tablica zadań zespołu',
  teamChip: 'Zespół {members} członków · {tasks} zadań',
  teamTasksEmpty: 'Brak wspólnych zadań',
  teamTaskCreate: 'Nowe zadanie',
  teamTaskSubject: 'Temat',
  teamTaskDescription: 'Opis',
  teamTaskOwner: 'Odpowiedzialny',
  teamTaskUnowned: 'Nieprzypisane',
  teamTaskPending: 'Do zrobienia',
  teamTaskInProgress: 'W toku',
  teamTaskCompleted: 'Ukończone',
  teamTaskBlocked: 'Zablokowane',
  teamTaskComplete: 'Ukończ',
  teamTaskReopen: 'Otwórz ponownie',
  teamTaskDelete: 'Usuń',
  teamTaskDeleteConfirm: 'Potwierdź usunięcie',
  teamTaskEdit: 'Edytuj',
  teamTaskSave: 'Zapisz',
  teamTaskCancel: 'Anuluj',
  teamTaskConflict: 'Zadanie zostało zmienione przez kogoś innego; odświeżono',
  teamTaskError: 'Operacja nie powiodła się: {message}',
  teamTaskDeleted: 'Usunięte',
  teamTaskActions: 'Akcje zadania',
  teamTaskDetail: 'Szczegóły zadania',
  teamTaskNoDescription: 'Brak opisu — kliknij „Edytuj”, aby dodać',
  teamTaskBlockedBy: 'Zablokowane przez',
  teamTaskSubjectPlaceholder: 'Opisz pracę w jednym zdaniu',
  teamTaskDescriptionPlaceholder: 'Dodatkowe informacje (opcjonalnie)',
  teamFilterAll: 'Wszystko',
  tasksNodeTasks: 'Wspólne zadania',
  jobCopyOutput: 'Kopiuj wyjście',
  jobCopied: 'Skopiowano',
  jobFollowTail: 'Śledź najnowsze',
  jobDragHint: 'Przeciągnij, aby przenieść',
  workflowRunning: 'W toku',
  workflowCompleted: 'Ukończony',
  workflowCancelled: 'Anulowany',
  workflowFailed: 'Niepowodzenie',
  workflowPhaseUnnamed: 'Faza bez nazwy',
  workflowMembers: '{done}/{total} członków',
  jobsAutoCollapsed: 'Automatycznie zwinięto (wiele agentów)',
  catalogLoadFailed: 'Nie udało się załadować {count} gałęzi',
