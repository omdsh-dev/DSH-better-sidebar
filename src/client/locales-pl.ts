...
export const pl: Record<string, string> = {
  ...
  generatingCommitMessage: 'Generowanie wiadomości commita…',
  suggestCommitError: 'Nie udało się wygenerować wiadomości commita',
  suggestCommitEmpty: 'Brak oczekujących zmian',
  push: 'Wypchnij',
  pull: 'Pociągnij',
  pushError: 'Nie udało się wypchnąć',
  pullError: 'Nie udało się pociągnąć',
  branch: 'Gałąź',
