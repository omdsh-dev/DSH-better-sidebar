...
export const pl: Record<string, string> = {
  ...
  subagentDelete: "Usuń trwale",
  subagentDeleteConfirm: "Usuń trwale",
  subagentDeleteDesc: "Trwale usuwa podagenta „{name}“ i wszystkie jego zapisy (w tym podagentów potomnych). Tej operacji nie można cofnąć.",
  subagentDeleteRunning: "Działa — nie można usunąć",
  subagentDeleteUnavailable: "Wymaga wtyczki @michengai/dsh-archive-manager",
