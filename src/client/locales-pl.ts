...
export const pl: Record<string, string> = {
  ...
  viewerVideo: 'Wideo',
  videoUnsupported: 'Ta przeglądarka nie odtworzy tego wideo — pobierz plik i otwórz go w lokalnym odtwarzaczu.',
  mediaLoadFailed: 'Nie udało się wczytać tego pliku',
  viewerCode: 'Kod',
  viewerHtml: 'HTML',
