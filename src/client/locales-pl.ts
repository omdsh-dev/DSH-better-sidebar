...
export const pl: Record<string, string> = {
  ...
  editorContentMode: 'Tryb widoku zawartości',
  ...
  fileCommentsPanel: 'Komentarze do bieżącego pliku',
  fileCommentsCurrent: 'Bieżące',
  fileCommentsSend: 'Wyślij zaznaczone komentarze do Agent',
  fileCommentsSendShort: 'Wyślij',
  fileCommentsSendFailed: 'Nie udało się wysłać komentarzy: {error}',
  fileCommentsEmptyCurrent: 'Brak niewysłanych komentarzy do tego pliku',
  fileCommentsEmptyHistory: 'Brak wysłanych komentarzy do tego pliku',
  fileCommentsSelectionOmitted: 'Zaznaczenie jest zbyt długie; zostanie wysłana tylko pozycja w pliku',
  fileCommentsEdit: 'Edytuj komentarz',
  fileCommentsDelete: 'Usuń komentarz',
  fileCommentsSelect: 'Wybierz komentarz',
  fileCommentsSelectAll: 'Zaznacz wszystko',
  fileCommentsClearSelection: 'Anuluj',
  fileCommentsDeleteSelected: 'Usuń',
  fileCommentsPlaceholder: 'Dodaj komentarz do zaznaczenia…',
