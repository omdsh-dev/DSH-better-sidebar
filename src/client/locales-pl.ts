...
export const pl: Record<string, string> = {
  ...
  explorerExclude: 'Wzorce wykluczania',
  explorerExcludeDesc: 'Całkowicie usuwa pasujące wpisy z drzewa plików i wyszukiwania (obsługuje * i ?, prefiks **/ pasuje na każdej głębokości); wykluczone wpisy nigdy nie blokują zwijania nawigacji',
  explorerExcludePlaceholder: 'Dodaj wzorzec, np. node_modules, *.log, **/.git',
  explorerExcludeAdd: 'Dodaj',
  explorerExcludeRemove: 'Usuń',
