...
export const pl: Record<string, string> = {
  ...
  guideDescPlan: 'Pełna treść każdego planu przedstawionego przez model w trybie planowania, zachowywana wersja po wersji',
  ...
  plan: 'Plan',
  planEmpty: 'Brak planów w tej sesji',
  planEmptyDesc: 'Plany przedstawione przez model w trybie planowania pojawią się tutaj',
  planStatusPending: 'Oczekuje na przegląd',
  planStatusApproved: 'Zatwierdzony',
  planStatusUnadopted: 'Nieprzyjęty',
  planCopy: 'Kopiuj plan',
  planLoadError: 'Nie udało się wczytać planu; ponowna próba nastąpi',
  ...
  settingsPlanTitle: 'Automatycznie otwieraj stronę „Plan”, gdy model przedstawi plan',
  settingsPlanDesc: 'Gdy model przedstawi plan w bieżącej rozmowie, automatycznie otwórz stronę „Plan” (akcja jest wyzwalana przez każdy przedstawiony plan); na szerokich ekranach rozwiń także panel boczny, a na wąskich nie wymuszaj otwarcia pełnoekranowego panelu; wyłącz, aby otwierać ją ręcznie',
