...
export const pl: Record<string, string> = {
  ...
  terminal: 'Terminal',
  restartHost: 'Uruchom ponownie DSH Web',
  restartHostStarting: 'Ponowne uruchamianie DSH Web…',
  restartHostFailed: 'Ponowne uruchomienie nie powiodło się — kliknij, aby spróbować ponownie',
  editor: 'Edytor',
