...
export const pl: Record<string, string> = {
  ...
  allowOutsideFiles: 'Zezwalaj na otwieranie plików poza obszarem roboczym',
  allowOutsideFilesDesc: 'Opcja tylko do odczytu: panel boczny może wyświetlać pliki/katalogi poza obszarem roboczym sesji; edycja, zapisywanie i przesyłanie pozostają ograniczone do obszaru roboczego.',
  externalReadonly: 'Zewnętrzny · tylko do odczytu',
