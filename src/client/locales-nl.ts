...
export const nl: Record<string, string> = {
  ...
  guideDescPlan: 'Elk plan dat het model in de planmodus presenteert, volledig bewaard per revisie',
  ...
  plan: 'Plan',
  planEmpty: 'Nog geen plannen in deze sessie',
  planEmptyDesc: 'Plannen die het model in de planmodus presenteert, verschijnen hier',
  planStatusPending: 'Wacht op beoordeling',
  planStatusApproved: 'Goedgekeurd',
  planStatusUnadopted: 'Niet overgenomen',
  planCopy: 'Plan kopiëren',
  planLoadError: 'Kan het plan niet laden; nieuwe poging volgt',
  ...
  settingsPlanTitle: 'Open de Plan-pagina automatisch wanneer het model een plan presenteert',
  settingsPlanDesc: 'Wanneer het model in de huidige conversatie een plan presenteert, wordt de Plan-pagina automatisch geopend (dit gebeurt bij elk gepresenteerd plan); op brede schermen wordt ook de zijkaart uitgeklapt, terwijl op smalle schermen het schuifpaneel op volledig scherm niet geforceerd wordt geopend; schakel uit om de pagina handmatig te openen',
