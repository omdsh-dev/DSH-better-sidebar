...
export const nl: Record<string, string> = {
  ...
  searchNext: 'Volgende',
  searchPrevious: 'Vorige',
  searchAll: 'Alles selecteren',
  searchMatchCase: 'Hoofdlettergevoelig',
  searchWholeWord: 'Heel woord',
  searchRegexp: 'Regexp',
  searchReplaceAll: 'Alles vervangen',
  searchCurrentMatch: 'Huidige overeenkomst',
  searchOnLine: 'op regel',
  searchReplacedMatches: '$ overeenkomsten vervangen',
  searchReplacedMatchOnLine: 'overeenkomst op regel $ vervangen',
  searchGoToLine: 'Naar regel',
  searchGo: 'Ga',
