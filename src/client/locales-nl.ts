...
export const nl: Record<string, string> = {
  ...
  toc: 'Inhoudsopgave',
  review: 'Beoordelen',
  reviewPending: '{count} te beoordelen',
  reviewNoRepo: 'Geen Git-repository',
  reviewAccepted: 'Geaccepteerd',
  accept: 'Accepteren',
  acceptAll: 'Alles accepteren',
  reject: 'Afwijzen',
  rejectUntracked: 'Een nieuw bestand heeft geen vastgelegde versie om te herstellen',
  find: 'Zoeken',
  findPrev: 'Vorige overeenkomst',
  findNext: 'Volgende overeenkomst',
  findClose: 'Zoeken sluiten',
  findNoResults: 'Geen resultaten',
  edit: 'Bewerken',
  ...
  browserLocalBlockedTitle: '{authority} vertrouwen en openen?',
  browserLocalBlockedDesc: 'Dit is een lokale service op je computer. Sta deze alleen toe als je de web-app hebt gestart of vertrouwt. De toegang geldt alleen voor dit adres en deze poort.',
  browserTrustAndOpen: 'Vertrouwen en openen',
  browserTrusting: 'Opslaan…',
  browserTrustFailed: 'Dit lokale adres kon niet worden opgeslagen. Controleer de instellingenservice van de zijbalk en probeer het opnieuw.',
