...
export const nl: Record<string, string> = {
  ...
  pluginVideoPreviewDesc: 'Inline videovoorbeeld (.mp4/.webm/.mov/.mkv/.avi enz.) voor de better-sidebar-editor, ondersteund door een toegewijde /video-host-route met HTTP Range (206)-ondersteuning — scrubben werkt en bestanden worden niet beperkt door de 64MB mediaLimit',
