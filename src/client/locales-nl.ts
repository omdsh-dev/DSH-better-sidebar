...
export const nl: Record<string, string> = {
  ...
  guideDescSubagent: 'Workflowgrafiek, teamtakenbord en achtergrondtaken, live',
  ...
  sideChatBlockNoExitCode: "Beëindigd zonder exitcode",
  ...
  codeBlockTitle: 'Codeblok',
  codeBlockWrap: 'Regels afbreken',
  ...
  tasksViewGraph: 'Workflowgrafiek',
  tasksViewTree: 'Boom',
  tasksViewSwitchToGraph: 'Omschakelen naar de workflowgrafiek',
  tasksViewSwitchToTree: 'Omschakelen naar de boom',
  settingsViewModeTitle: 'Standaardweergave van de takenpagina',
  settingsViewModeDesc: 'Hoe de takenpagina bij het openen wordt weergegeven (de schakelaar op de pagina wisselt nog steeds ad hoc)',
  settingsViewModeGraph: 'Workflowgrafiek',
  ...
  tasksFoldExpand: 'Voltooide knopen uitklappen',
  tasksFoldCollapse: 'Voltooide knopen inklappen',
  tasksZoomIn: 'Inzoomen',
  ...
  tasksNodeTeamRole: 'Teamrol',
  tasksNodeActivity: 'Laatste activiteit',
  tasksStateRunning: 'Bezig',
  tasksStateIdle: 'Inactief',
  tasksStateDone: 'Voltooid',
  tasksStateError: 'Fout',
  teamBoard: 'Teamtakenbord',
  teamChip: 'Team {members} leden · {tasks} taken',
  teamTasksEmpty: 'Nog geen gedeelde taken',
  teamTaskCreate: 'Nieuwe taak',
  teamTaskSubject: 'Onderwerp',
  teamTaskDescription: 'Beschrijving',
  teamTaskOwner: 'Verantwoordelijke',
  teamTaskUnowned: 'Niet opgeëist',
  teamTaskPending: 'Te doen',
  teamTaskInProgress: 'Bezig',
  teamTaskCompleted: 'Voltooid',
  teamTaskBlocked: 'Geblokkeerd',
  teamTaskComplete: 'Voltooien',
  teamTaskReopen: 'Heropenen',
  teamTaskDelete: 'Verwijderen',
  teamTaskDeleteConfirm: 'Verwijderen bevestigen',
  teamTaskEdit: 'Bewerken',
  teamTaskSave: 'Opslaan',
  teamTaskCancel: 'Annuleren',
  teamTaskConflict: 'De taak is elders gewijzigd; vernieuwd',
  teamTaskError: 'Bewerking mislukt: {message}',
  teamTaskDeleted: 'Verwijderd',
  teamTaskActions: 'Taakacties',
  teamTaskDetail: 'Taakdetails',
  teamTaskNoDescription: 'Nog geen beschrijving — klik op “Bewerken” om er een toe te voegen',
  teamTaskBlockedBy: 'Geblokkeerd door',
  teamTaskSubjectPlaceholder: 'Beschrijf het werk in één regel',
  teamTaskDescriptionPlaceholder: 'Aanvullende details (optioneel)',
  teamFilterAll: 'Alles',
  tasksNodeTasks: 'Gedeelde taken',
  jobCopyOutput: 'Uitvoer kopiëren',
  jobCopied: 'Gekopieerd',
  jobFollowTail: 'Nieuwste volgen',
  jobDragHint: 'Slepen om te verplaatsen',
  workflowRunning: 'Bezig',
  workflowCompleted: 'Voltooid',
  workflowCancelled: 'Geannuleerd',
  workflowFailed: 'Mislukt',
  workflowPhaseUnnamed: 'Naamloze fase',
  workflowMembers: '{done}/{total} leden',
  jobsAutoCollapsed: 'Automatisch ingeklapt (veel agents)',
  catalogLoadFailed: '{count} branches konden niet worden geladen',
