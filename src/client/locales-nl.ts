...
export const nl: Record<string, string> = {
  ...
  explorerExclude: 'Uitsluitingspatronen',
  explorerExcludeDesc: 'Verwijdert overeenkomende items volledig uit de bestandsboom en het zoeken (ondersteunt * en ?, een **/-voorvoegsel matcht elke diepte); uitgesloten items blokkeren het broodkruimelsamenvouwen nooit',
  explorerExcludePlaceholder: 'Patroon toevoegen, bijv. node_modules, *.log, **/.git',
  explorerExcludeAdd: 'Toevoegen',
  explorerExcludeRemove: 'Verwijderen',
