...
export const nl: Record<string, string> = {
  ...
  editorContentMode: 'Inhoudsweergave',
  ...
  fileCommentsPanel: 'Opmerkingen bij huidig bestand',
  fileCommentsCurrent: 'Huidig',
  fileCommentsSend: 'Geselecteerde opmerkingen naar Agent sturen',
  fileCommentsSendShort: 'Versturen',
  fileCommentsSendFailed: 'Opmerkingen verzenden mislukt: {error}',
  fileCommentsEmptyCurrent: 'Geen niet-verzonden opmerkingen voor dit bestand',
  fileCommentsEmptyHistory: 'Geen verzonden opmerkingen voor dit bestand',
  fileCommentsSelectionOmitted: 'De selectie is te lang; alleen de bestandslocatie wordt verzonden',
  fileCommentsEdit: 'Opmerking bewerken',
  fileCommentsDelete: 'Opmerking verwijderen',
  fileCommentsSelect: 'Opmerking selecteren',
  fileCommentsSelectAll: 'Alles selecteren',
  fileCommentsClearSelection: 'Annuleren',
  fileCommentsDeleteSelected: 'Verwijderen',
  fileCommentsPlaceholder: 'Voeg een opmerking over de selectie toe…',
