...
export const nl: Record<string, string> = {
  ...
  viewerVideo: 'Video',
  videoUnsupported: 'Deze browser kan de video niet afspelen — download het bestand en open het in een lokale speler.',
  mediaLoadFailed: 'Dit bestand kon niet worden geladen',
  viewerCode: 'Code',
  viewerHtml: 'HTML',
  browser: 'Browser',
