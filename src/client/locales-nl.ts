...
export const nl: Record<string, string> = {
  ...
  subagentDelete: "Definitief verwijderen",
  subagentDeleteConfirm: "Definitief verwijderen",
  subagentDeleteDesc: "Verwijdert subagent \"{name}\" en al zijn gegevens (inclusief subagents) definitief. Dit kan niet ongedaan worden gemaakt.",
  subagentDeleteRunning: "Actief — kan niet worden verwijderd",
  subagentDeleteUnavailable: "Vereist de @michengai/dsh-archive-manager plugin",
