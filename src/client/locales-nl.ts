...
export const nl: Record<string, string> = {
  enterCodeFocus: 'Volledig scherm',
  exitCodeFocus: 'Volledig scherm afsluiten',
  resizeSidebar: 'Pas de breedte van de zijbalk aan; sleep helemaal naar rechts om te verbergen',
  releaseToHideSidebar: 'Laat los om de zijbalk te verbergen',
  createFile: 'Nieuw bestand',
  createFolder: 'Nieuwe map',
  newFileName: 'Bestandsnaam',
  newFolderName: 'Mapnaam',
  createNameRequired: 'Voer een naam in',
  createNameInvalid: 'De naam mag niet . of .. zijn en geen padscheidingstekens bevatten',
  creating: 'Bezig met maken…',
  createDone: '{path} is gemaakt',
  createFailed: 'Maken mislukt: {error}',
  operationBusy: 'Er wordt een andere bestandsbewerking uitgevoerd',
  ...
  deleteFileDesc: '“{path}” permanent verwijderen? Deze actie kan niet ongedaan worden gemaakt.',
  deleteFolder: 'Map verwijderen',
  deleteFolderTitle: 'Map verwijderen',
  deleteFolderDesc: '“{path}” en alle inhoud permanent verwijderen? Deze actie kan niet ongedaan worden gemaakt.',
  deleteSymlink: 'Symbolische koppeling verwijderen',
  deleteSymlinkTitle: 'Symbolische koppeling verwijderen',
  deleteSymlinkDesc: 'De symbolische koppeling “{path}” verwijderen? Het doel wordt niet verwijderd. Deze actie kan niet ongedaan worden gemaakt.',
  deleting: 'Bezig met verwijderen…',
  deleteDone: '{path} is verwijderd',
