...
export const nl: Record<string, string> = {
  ...
  explorer: 'Verkenner',
  terminal: 'Terminal',
  restartHost: 'DSH Web opnieuw starten',
  restartHostStarting: 'DSH Web wordt opnieuw gestart…',
  restartHostFailed: 'Opnieuw starten mislukt — klik om opnieuw te proberen',
  editor: 'Editor',
