...
export const nl: Record<string, string> = {
  ...
  pasteImageFailed: 'Afbeelding plakken mislukt',
  ...
  settingsSearchExcludeTitle: 'Mappen uitgesloten van zoeken',
  settingsSearchExcludeDesc: 'Sla deze mappen over bij bestandsnaamzoeken (kommagescheiden; dezelfde naam op elke diepte wordt uitgesloten)',
  ...
  settingsImageDirTitle: 'Obsidian-afbeeldingsmap',
  settingsImageDirDesc: 'Map voor ![[x.png]]-insluitingen en geplakte afbeeldingen: relatief aan de sessie-cwd (standaard images) of een absoluut pad',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'Voorbeeld-kleurthema',
  settingsMdPreviewThemeDesc: 'Geldt alleen voor Markdown-bestandsvoorbeeld — niet voor Side Chat of Changes-leesmodus',
  settingsMdPreviewThemeVivid: 'Levendig',
  settingsMdPreviewThemeVividDesc: 'Rijkere kop-, citaat- en tabelaccenten via semantische skin-tokens',
  settingsMdPreviewThemeHost: 'Host',
  settingsMdPreviewThemeHostDesc: 'Host-MarkdownText-kleuren ongewijzigd houden',
  viewerCode: 'Code',
