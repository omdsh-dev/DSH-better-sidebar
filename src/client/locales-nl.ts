...
export const nl: Record<string, string> = {
  ...
  allowOutsideFiles: 'Openen van bestanden buiten de werkruimte toestaan',
  allowOutsideFilesDesc: 'Alleen-lezen optie: de zijbalk kan bestanden/mappen buiten de sessiewerkruimte bekijken; bewerken, opslaan en uploaden blijven beperkt tot de werkruimte.',
  externalReadonly: 'Extern · alleen-lezen',
