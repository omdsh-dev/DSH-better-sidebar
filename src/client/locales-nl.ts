...
export const nl: Record<string, string> = {
  ...
  generateCommitMessage: 'Commitbericht genereren',
  generatingCommitMessage: 'Commitbericht wordt gegenereerd…',
  suggestCommitError: 'Genereren van commitbericht mislukt',
  suggestCommitEmpty: 'Geen openstaande wijzigingen',
  push: 'Pushen',
  pull: 'Pullen',
  pushError: 'Pushen mislukt',
  pullError: 'Pullen mislukt',
  branch: 'Branch',
  worktree: 'Worktree',
