...
export const nl: Record<string, string> = {
  ...
  findNext: 'Volgende',
  findPrevious: 'Vorige',
  findAll: 'Alles selecteren',
  findMatchCase: 'Hoofdlettergevoelig',
  findRegexp: 'Regex',
  findByWord: 'Heel woord',
  ...
  closeUnsavedConfirm: 'Dit bestand heeft niet-opgeslagen wijzigingen. Het sluiten van het tabblad gooit ze weg. Doorgaan?',
  save: 'Opslaan',
  saved: 'Opgeslagen',
  unsaved: 'Niet opgeslagen',
  saveFailed: 'Opslaan mislukt',
  saveConflict: 'Het bestand is op schijf door iets anders gewijzigd. Opslaan afgebroken; je wijzigingen blijven in de editor.',   saveConflictReload: 'Opnieuw laden vanaf schijf',
