...
export const vi: Record<string, string> = {
  ...
  editorContentMode: 'Chế độ xem nội dung',
  ...
  fileCommentsPanel: 'Nhận xét tệp hiện tại',
  fileCommentsCurrent: 'Hiện tại',
  fileCommentsSend: 'Gửi nhận xét đã chọn cho Agent',
  fileCommentsSendShort: 'Gửi',
  fileCommentsSendFailed: 'Không thể gửi nhận xét: {error}',
  fileCommentsEmptyCurrent: 'Không có nhận xét chưa gửi cho tệp này',
  fileCommentsEmptyHistory: 'Không có nhận xét đã gửi cho tệp này',
  fileCommentsSelectionOmitted: 'Vùng chọn quá dài; chỉ vị trí tệp sẽ được gửi',
  fileCommentsEdit: 'Sửa nhận xét',
  fileCommentsDelete: 'Xóa nhận xét',
  fileCommentsSelect: 'Chọn nhận xét',
  fileCommentsSelectAll: 'Chọn tất cả',
  fileCommentsClearSelection: 'Hủy',
  fileCommentsDeleteSelected: 'Xóa',
  fileCommentsPlaceholder: 'Thêm nhận xét về vùng chọn…',
