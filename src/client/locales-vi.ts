...
export const vi: Record<string, string> = {
  ...
  sideChatBlockNoExitCode: "Kết thúc không có mã thoát",
  ...
  tasksViewGraph: 'Đồ thị quy trình',
  tasksViewTree: 'Cây',
  tasksViewSwitchToGraph: 'Chuyển sang đồ thị quy trình',
  tasksViewSwitchToTree: 'Chuyển sang chế độ cây',
  settingsViewModeTitle: 'Chế độ xem mặc định của trang tác vụ',
  settingsViewModeDesc: 'Cách trang tác vụ hiển thị khi mở (nút chuyển trên trang vẫn đổi tùy lúc)',
  settingsViewModeGraph: 'Đồ thị quy trình',
  ...
  tasksFoldCollapse: 'Thu gọn các nút đã hoàn thành',
  tasksZoomIn: 'Phóng to',
  ...
  tasksNodeTeamRole: 'Vai trò trong nhóm',
  tasksNodeActivity: 'Hoạt động gần đây',
  tasksStateRunning: 'Đang chạy',
  tasksStateIdle: 'Nhàn rỗi',
  tasksStateDone: 'Hoàn thành',
  tasksStateError: 'Lỗi',
  teamBoard: 'Bảng tác vụ nhóm',
  teamChip: 'Nhóm {members} thành viên · {tasks} tác vụ',
  teamTasksEmpty: 'Chưa có tác vụ dùng chung',
  teamTaskCreate: 'Tác vụ mới',
  teamTaskSubject: 'Chủ đề',
  teamTaskDescription: 'Mô tả',
  teamTaskOwner: 'Người phụ trách',
  teamTaskUnowned: 'Chưa nhận',
  teamTaskPending: 'Chờ xử lý',
  teamTaskInProgress: 'Đang tiến hành',
  teamTaskCompleted: 'Hoàn thành',
  teamTaskBlocked: 'Bị chặn',
  teamTaskComplete: 'Hoàn tất',
  teamTaskReopen: 'Mở lại',
  teamTaskDelete: 'Xóa',
  teamTaskDeleteConfirm: 'Xác nhận xóa',
  teamTaskEdit: 'Sửa',
  teamTaskSave: 'Lưu',
  teamTaskCancel: 'Hủy',
  teamTaskConflict: 'Tác vụ đã bị người khác thay đổi, đã làm mới',
  teamTaskError: 'Thao tác thất bại: {message}',
  teamTaskDeleted: 'Đã xóa',
  teamTaskActions: 'Thao tác với tác vụ',
  teamTaskDetail: 'Chi tiết tác vụ',
  teamTaskNoDescription: 'Chưa có mô tả — bấm “Sửa” để thêm',
  teamTaskBlockedBy: 'Bị chặn bởi',
  teamTaskSubjectPlaceholder: 'Mô tả việc cần làm trong một dòng',
  teamTaskDescriptionPlaceholder: 'Thông tin bổ sung (không bắt buộc)',
  teamFilterAll: 'Tất cả',
  tasksNodeTasks: 'Tác vụ dùng chung',
  jobCopyOutput: 'Sao chép đầu ra',
  jobCopied: 'Đã sao chép',
  jobFollowTail: 'Theo dòng mới nhất',
  jobDragHint: 'Kéo để di chuyển',
  workflowRunning: 'Đang chạy',
  workflowCompleted: 'Hoàn thành',
  workflowCancelled: 'Đã hủy',
  workflowFailed: 'Thất bại',
  workflowPhaseUnnamed: 'Giai đoạn chưa đặt tên',
  workflowMembers: '{done}/{total} thành viên',
  jobsAutoCollapsed: 'Tự động thu gọn (nhiều agent)',
  catalogLoadFailed: '{count} nhánh không tải được',
