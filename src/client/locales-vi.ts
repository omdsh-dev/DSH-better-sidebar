...
export const vi: Record<string, string> = {
  ...
  findPrevious: 'Trước',
  findAll: 'Chọn tất cả',
  findMatchCase: 'Phân biệt chữ hoa thường',
  findRegexp: 'Regex',
  findByWord: 'Toàn bộ từ',
  replaceOne: 'Thay thế',
  ...
  closeUnsavedConfirm: 'Tệp này có chỉnh sửa chưa lưu. Đóng tab sẽ loại bỏ chúng. Tiếp tục?',
  save: 'Lưu',
  saved: 'Đã lưu',
  unsaved: 'Chưa lưu',
  saveFailed: 'Lưu thất bại',
  saveConflict: 'Tệp đã bị nguồn khác sửa trên đĩa. Đã hủy lưu; chỉnh sửa của bạn vẫn còn trong trình soạn thảo.',   saveConflictReload: 'Tải lại từ đĩa',
