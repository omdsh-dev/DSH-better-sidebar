...
export const vi: Record<string, string> = {
  ...
  generatingCommitMessage: 'Đang tạo thông điệp commit…',
  suggestCommitError: 'Không thể tạo thông điệp commit',
  suggestCommitEmpty: 'Không có thay đổi đang chờ',
  push: 'Đẩy',
  pull: 'Kéo',
  pushError: 'Đẩy thất bại',
  pullError: 'Kéo thất bại',
  branch: 'Branch',
  worktree: 'Worktree',
