...
export const vi: Record<string, string> = {
  ...
  subagentDelete: "Xóa vĩnh viễn",
  subagentDeleteConfirm: "Xóa vĩnh viễn",
  subagentDeleteDesc: "Xóa vĩnh viễn tác tử con \"{name}\" và toàn bộ bản ghi (bao gồm tác tử con của nó). Không thể hoàn tác.",
  subagentDeleteRunning: "Đang chạy — không thể xóa",
  subagentDeleteUnavailable: "Yêu cầu plugin @michengai/dsh-archive-manager",
