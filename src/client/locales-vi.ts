...
export const vi: Record<string, string> = {
  ...
  settingsSearchExcludeTitle: 'Thư mục loại trừ khỏi tìm kiếm',
  settingsSearchExcludeDesc: 'Bỏ qua các thư mục này khi tìm theo tên tệp (cách nhau bằng dấu phẩy; cùng tên ở mọi độ sâu đều bị loại)',
  ...
  settingsImageDirTitle: 'Thư mục ảnh Obsidian',
  settingsImageDirDesc: 'Thư mục embed ![[x.png]] và ảnh dán: tương đối với cwd phiên (mặc định images) hoặc đường dẫn tuyệt đối',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'Chủ đề màu xem trước',
  settingsMdPreviewThemeDesc: 'Chỉ áp dụng cho xem trước tệp Markdown — không ảnh hưởng Side Chat hay chế độ đọc Changes',
  settingsMdPreviewThemeVivid: 'Rõ nét',
  settingsMdPreviewThemeVividDesc: 'Tăng tương phản tiêu đề, trích dẫn và đầu bảng qua token ngữ nghĩa',
  settingsMdPreviewThemeHost: 'Máy chủ',
  settingsMdPreviewThemeHostDesc: 'Giữ nguyên màu MarkdownText của máy chủ',
  viewerCode: 'Mã',
