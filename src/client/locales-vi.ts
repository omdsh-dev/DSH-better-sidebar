...
export const vi: Record<string, string> = {
  ...
  allowOutsideFiles: 'Cho phép mở tệp ngoài không gian làm việc',
  allowOutsideFilesDesc: 'Tùy chọn chỉ đọc: thanh bên có thể xem tệp/thư mục ngoài không gian làm việc của phiên; chỉnh sửa, lưu và tải lên vẫn giới hạn trong không gian làm việc.',
  externalReadonly: 'Bên ngoài · chỉ đọc',
