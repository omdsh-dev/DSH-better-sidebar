...
export const vi: Record<string, string> = {
  ...
  explorerExclude: 'Mẫu loại trừ',
  explorerExcludeDesc: 'Loại bỏ hoàn toàn các mục khớp khỏi cây tệp và tìm kiếm (hỗ trợ * và ?, tiền tố **/ khớp mọi độ sâu); mục bị loại trừ không bao giờ chặn việc gập breadcrumb',
  explorerExcludePlaceholder: 'Thêm mẫu, vd. node_modules, *.log, **/.git',
  explorerExcludeAdd: 'Thêm',
  explorerExcludeRemove: 'Xóa',
