...
export const vi: Record<string, string> = {
  enterCodeFocus: 'Toàn màn hình',
  exitCodeFocus: 'Thoát toàn màn hình',
  resizeSidebar: 'Thay đổi độ rộng thanh bên; kéo hết sang phải để ẩn',
  releaseToHideSidebar: 'Thả để ẩn thanh bên',
  createFile: 'Tệp mới',
  createFolder: 'Thư mục mới',
  newFileName: 'Tên tệp',
  newFolderName: 'Tên thư mục',
  createNameRequired: 'Nhập tên',
  createNameInvalid: 'Tên không được là . hoặc .. và không được chứa dấu phân cách đường dẫn',
  creating: 'Đang tạo…',
  createDone: 'Đã tạo {path}',
  createFailed: 'Tạo thất bại: {error}',
  operationBusy: 'Một thao tác tệp khác đang diễn ra',
  importFiles: 'Nhập tệp',
  importFolder: 'Nhập thư mục',
  deleteFile: 'Xóa tệp',
  deleteFileTitle: 'Xóa tệp',
  deleteFileDesc: 'Xóa vĩnh viễn “{path}”? Không thể hoàn tác thao tác này.',
  deleteFolder: 'Xóa thư mục',
  deleteFolderTitle: 'Xóa thư mục',
  deleteFolderDesc: 'Xóa vĩnh viễn “{path}” và toàn bộ nội dung bên trong? Không thể hoàn tác thao tác này.',
  deleteSymlink: 'Xóa liên kết tượng trưng',
  deleteSymlinkTitle: 'Xóa liên kết tượng trưng',
  deleteSymlinkDesc: 'Xóa liên kết tượng trưng “{path}”? Đích của liên kết sẽ không bị xóa. Không thể hoàn tác thao tác này.',
  deleting: 'Đang xóa…',
  deleteDone: 'Đã xóa {path}',
