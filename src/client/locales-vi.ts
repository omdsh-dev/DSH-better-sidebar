...
export const vi: Record<string, string> = {
  ...
  toc: 'Mục lục',
  review: 'Xem xét',
  reviewPending: '{count} cần xem xét',
  reviewNoRepo: 'Không phải kho Git',
  reviewAccepted: 'Đã chấp nhận',
  accept: 'Chấp nhận',
  acceptAll: 'Chấp nhận tất cả',
  reject: 'Từ chối',
  rejectUntracked: 'Tệp mới không có bản commit để khôi phục',
  find: 'Tìm',
  findPrev: 'Kết quả trước',
  findNext: 'Kết quả tiếp theo',
  ...
  browserLocalBlockedTitle: 'Tin cậy và mở {authority}?',
  browserLocalBlockedDesc: 'Đây là dịch vụ cục bộ trên máy tính của bạn. Chỉ cho phép nếu bạn đã khởi động hoặc tin cậy ứng dụng web này. Quyền truy cập chỉ áp dụng cho địa chỉ và cổng này.',
  browserTrustAndOpen: 'Tin cậy và mở',
  browserTrusting: 'Đang lưu…',
  browserTrustFailed: 'Không thể lưu địa chỉ cục bộ này. Hãy kiểm tra dịch vụ cài đặt thanh bên rồi thử lại.',
