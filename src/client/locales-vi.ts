...
export const vi: Record<string, string> = {
  ...
  guideDescPlan: 'Toàn văn kế hoạch mô hình trình bày trong chế độ lập kế hoạch, lưu theo từng phiên bản',
  ...
  plan: 'Kế hoạch',
  planEmpty: 'Chưa có kế hoạch nào trong phiên này',
  planEmptyDesc: 'Hãy để mô hình tạo kế hoạch trong chế độ lập kế hoạch; kế hoạch sẽ xuất hiện ở đây sau khi trình bày',
  planStatusPending: 'Chờ duyệt',
  planStatusApproved: 'Đã duyệt',
  planStatusUnadopted: 'Chưa áp dụng',
  planCopy: 'Sao chép kế hoạch',
  planLoadError: 'Tải kế hoạch thất bại, đang thử lại',
  ...
  settingsPlanTitle: 'Tự động kích hoạt trang Kế hoạch khi mô hình trình bày kế hoạch',
  settingsPlanDesc: 'Khi mô hình trình bày kế hoạch trong phiên hiện tại, kích hoạt trang Kế hoạch; trên màn hình rộng, thẻ bên cũng được mở rộng; trên màn hình hẹp, ngăn kéo toàn màn hình không bị ép mở; tắt để mở thủ công',
