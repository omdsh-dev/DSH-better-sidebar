...
export const vi: Record<string, string> = {
  ...
  searchFind: 'Tìm',
  searchReplace: 'Thay thế',
  searchNext: 'Tiếp theo',
  searchPrevious: 'Trước đó',
  searchAll: 'Chọn tất cả',
  searchMatchCase: 'Phân biệt chữ hoa chữ thường',
  searchWholeWord: 'Toàn bộ từ',
  searchRegexp: 'Regexp',
  searchReplaceAll: 'Thay thế tất cả',
  searchCurrentMatch: 'Kết quả khớp hiện tại',
  searchOnLine: 'tại dòng',
  searchReplacedMatches: 'đã thay thế $ kết quả khớp',
  searchReplacedMatchOnLine: 'đã thay thế kết quả khớp tại dòng $',
  searchGoToLine: 'Đi tới dòng',
  searchGo: 'Đi',
