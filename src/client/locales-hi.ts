...
export const hi: Record<string, string> = {
  ...
  explorerExclude: 'बहिष्करण पैटर्न',
  explorerExcludeDesc: 'मेल खाती प्रविष्टियों को फ़ाइल ट्री और खोज से पूरी तरह हटाता है (* और ? समर्थित, **/ उपसर्ग किसी भी गहराई से मेल खाता है); बहिष्कृत प्रविष्टियाँ ब्रेडक्रंब फ़ोल्डिंग में कभी बाधा नहीं डालतीं',
  explorerExcludePlaceholder: 'पैटर्न जोड़ें, जैसे node_modules, *.log, **/.git',
  explorerExcludeAdd: 'जोड़ें',
  explorerExcludeRemove: 'हटाएँ',
