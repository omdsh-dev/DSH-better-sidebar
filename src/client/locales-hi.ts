...
export const hi: Record<string, string> = {
  ...
  toc: 'विषय-सूची',
  review: 'समीक्षा',
  reviewPending: '{count} समीक्षा हेतु',
  reviewNoRepo: 'यह Git रिपॉज़िटरी नहीं है',
  reviewAccepted: 'स्वीकृत',
  accept: 'स्वीकारें',
  acceptAll: 'सभी स्वीकारें',
  reject: 'अस्वीकारें',
  rejectUntracked: 'नई फ़ाइल की कोई कमिट प्रति नहीं है',
  find: 'खोजें',
  findPrev: 'पिछला मिलान',
  findNext: 'अगला मिलान',
  findClose: 'खोज बंद करें',
  findNoResults: 'कोई परिणाम नहीं',
  edit: 'संपादित करें',
  ...
  browserLocalBlockedTitle: '{authority} पर भरोसा करके खोलें?',
  browserLocalBlockedDesc: 'यह आपके कंप्यूटर पर चल रही स्थानीय सेवा है। इसे तभी अनुमति दें जब आपने वेब ऐप शुरू किया हो या आप उस पर भरोसा करते हों। पहुँच केवल इस पते और पोर्ट पर लागू होती है।',
  browserTrustAndOpen: 'भरोसा करके खोलें',
  browserTrusting: 'सहेजा जा रहा है…',
  browserTrustFailed: 'यह स्थानीय पता सहेजा नहीं जा सका। साइडबार सेटिंग सेवा जाँचें और फिर कोशिश करें।',
