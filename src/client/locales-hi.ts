...
export const hi: Record<string, string> = {
  enterCodeFocus: 'पूर्ण स्क्रीन',
  exitCodeFocus: 'पूर्ण स्क्रीन से बाहर निकलें',
  resizeSidebar: 'साइडबार की चौड़ाई बदलें; छिपाने के लिए सबसे दाईं ओर खींचें',
  releaseToHideSidebar: 'साइडबार छिपाने के लिए छोड़ें',
  createFile: 'नई फ़ाइल',
  createFolder: 'नया फ़ोल्डर',
  newFileName: 'फ़ाइल का नाम',
  newFolderName: 'फ़ोल्डर का नाम',
  createNameRequired: 'नाम दर्ज करें',
  createNameInvalid: 'नाम . या .. नहीं हो सकता और उसमें पथ विभाजक नहीं हो सकते',
  creating: 'बनाया जा रहा है…',
  createDone: '{path} बनाया गया',
  createFailed: 'बनाना विफल: {error}',
  operationBusy: 'एक अन्य फ़ाइल कार्रवाई जारी है',
  importFiles: 'फ़ाइलें आयात करें',
  importFolder: 'फ़ोल्डर आयात करें',
  deleteFile: 'फ़ाइल हटाएँ',
  deleteFileTitle: 'फ़ाइल हटाएँ',
  deleteFileDesc: '“{path}” को स्थायी रूप से हटाएँ? यह कार्रवाई वापस नहीं की जा सकती।',
  deleteFolder: 'फ़ोल्डर हटाएँ',
  deleteFolderTitle: 'फ़ोल्डर हटाएँ',
  deleteFolderDesc: '“{path}” और उसके अंदर की सभी सामग्री को स्थायी रूप से हटाएँ? यह कार्रवाई वापस नहीं की जा सकती।',
  deleteSymlink: 'प्रतीकात्मक लिंक हटाएँ',
  deleteSymlinkTitle: 'प्रतीकात्मक लिंक हटाएँ',
  deleteSymlinkDesc: 'प्रतीकात्मक लिंक “{path}” हटाएँ? उसका लक्ष्य नहीं हटाया जाएगा। यह कार्रवाई वापस नहीं की जा सकती।',
  deleting: 'हटाया जा रहा है…',
  deleteDone: '{path} हटाया गया',
