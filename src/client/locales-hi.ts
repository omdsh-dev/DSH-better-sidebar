...
export const hi: Record<string, string> = {
  ...
  editorContentMode: 'सामग्री दृश्य मोड',
  ...
  fileCommentsPanel: 'वर्तमान फ़ाइल टिप्पणियाँ',
  fileCommentsCurrent: 'वर्तमान',
  fileCommentsSend: 'चुनी हुई टिप्पणियाँ Agent को भेजें',
  fileCommentsSendShort: 'भेजें',
  fileCommentsSendFailed: 'टिप्पणियाँ भेजने में विफल: {error}',
  fileCommentsEmptyCurrent: 'इस फ़ाइल के लिए कोई न भेजी गई टिप्पणी नहीं है',
  fileCommentsEmptyHistory: 'इस फ़ाइल के लिए कोई भेजी गई टिप्पणी नहीं है',
  fileCommentsSelectionOmitted: 'चयन बहुत लंबा है; केवल फ़ाइल स्थान भेजा जाएगा',
  fileCommentsEdit: 'टिप्पणी संपादित करें',
  fileCommentsDelete: 'टिप्पणी हटाएँ',
  fileCommentsSelect: 'टिप्पणी चुनें',
  fileCommentsSelectAll: 'सभी चुनें',
  fileCommentsClearSelection: 'रद्द करें',
  fileCommentsDeleteSelected: 'हटाएँ',
  fileCommentsPlaceholder: 'चयन पर टिप्पणी जोड़ें…',
