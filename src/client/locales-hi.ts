...
export const hi: Record<string, string> = {
  ...
  pasteImageFailed: 'छवि चिपकाना विफल',
  ...
  settingsSearchExcludeTitle: 'खोज से बाहर रखी गई निर्देशिकाएँ',
  settingsSearchExcludeDesc: 'फ़ाइलनाम खोज में इन निर्देशिकाओं को छोड़ें (अल्पविराम से अलग; किसी भी गहराई पर समान नाम भी बाहर)',
  ...
  settingsImageDirTitle: 'Obsidian इमेज निर्देशिका',
  settingsImageDirDesc: '![[x.png]] एम्बेड और चिपकाई गई छवियों की निर्देशिका: सत्र cwd के सापेक्ष (डिफ़ॉल्ट images) या निरपेक्ष पथ',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'पूर्वावलोकन रंग थीम',
  settingsMdPreviewThemeDesc: 'केवल Markdown फ़ाइल पूर्वावलोकन पर लागू — Side Chat या Changes पठन मोड पर नहीं',
  settingsMdPreviewThemeVivid: 'जीवंत',
  settingsMdPreviewThemeVividDesc: 'सिमेंटिक स्किन टोकन से शीर्षक, उद्धरण और तालिका में अधिक कंट्रास्ट',
  settingsMdPreviewThemeHost: 'होस्ट',
  settingsMdPreviewThemeHostDesc: 'होस्ट MarkdownText रंग यथावत रखें',
  viewerCode: 'कोड',
