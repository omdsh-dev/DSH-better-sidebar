...
export const hi: Record<string, string> = {
  ...
  findPrevious: 'पिछला',
  findAll: 'सभी चुनें',
  findMatchCase: 'केस मिलाएँ',
  findRegexp: 'रेगुलर एक्सप्रेशन',
  findByWord: 'पूरा शब्द',
  replaceOne: 'बदलें',
  ...
  closeUnsavedConfirm: 'इस फ़ाइल में सहेजे नहीं गए संपादन हैं। टैब बंद करने पर वे हट जाएँगे। जारी रखें?',
  save: 'सहेजें',
  saved: 'सहेजा गया',
  unsaved: 'असहेजित',
  saveFailed: 'सहेजना विफल',
  saveConflict: 'फ़ाइल डिस्क पर किसी अन्य स्रोत से बदल दी गई है। सहेजना रोक दिया गया; आपके संपादन एडिटर में बने हुए हैं।',   saveConflictReload: 'डिस्क से फिर लोड करें',
