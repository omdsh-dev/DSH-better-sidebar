...
export const hi: Record<string, string> = {
  ...
  allowOutsideFiles: 'कार्यक्षेत्र के बाहर फ़ाइलें खोलने की अनुमति दें',
  allowOutsideFilesDesc: 'केवल-पढ़ने की सुविधा: साइडबार सत्र कार्यक्षेत्र के बाहर की फ़ाइलें/फ़ोल्डर देख सकता है; संपादन, सहेजना और अपलोड केवल कार्यक्षेत्र तक सीमित रहते हैं।',
  externalReadonly: 'बाहरी · केवल पढ़ने योग्य',
