...
export const hi: Record<string, string> = {
  ...
  tasksViewGraph: 'वर्कफ़्लो ग्राफ़',
  tasksViewTree: 'ट्री',
  tasksViewSwitchToGraph: 'वर्कफ़्लो ग्राफ़ पर स्विच करें',
  tasksViewSwitchToTree: 'ट्री पर स्विच करें',
  settingsViewModeTitle: 'कार्य पृष्ठ का डिफ़ॉल्ट दृश्य',
  settingsViewModeDesc: 'कार्य पृष्ठ खुलने पर डिफ़ॉल्ट रूप से कैसे दिखता है (पृष्ठ के अंदर अभी भी अस्थायी रूप से बदला जा सकता है)',
  settingsViewModeGraph: 'वर्कफ़्लो ग्राफ़',
  ...
  tasksFoldCollapse: 'पूर्ण नोड्स संकुचित करें',
  tasksZoomIn: 'ज़ूम इन',
  ...
  tasksNodeMode: 'मोड',
  tasksNodeModel: 'मॉडल',
  tasksNodeTeamRole: 'टीम भूमिका',
  tasksNodeActivity: 'नवीनतम गतिविधि',
  tasksStateRunning: 'चल रहा है',
  tasksStateIdle: 'निष्क्रिय',
  tasksStateDone: 'पूर्ण',
  tasksStateError: 'त्रुटि',
  teamBoard: 'टीम कार्य बोर्ड',
  teamChip: 'टीम {members} सदस्य · {tasks} कार्य',
  teamTasksEmpty: 'अभी कोई साझा कार्य नहीं',
  teamTaskCreate: 'नया कार्य',
  teamTaskSubject: 'विषय',
  teamTaskDescription: 'विवरण',
  teamTaskOwner: 'स्वामी',
  teamTaskUnowned: 'बिना स्वामी',
  teamTaskPending: 'लंबित',
  teamTaskInProgress: 'प्रगति पर',
  teamTaskCompleted: 'पूर्ण',
  teamTaskBlocked: 'अवरुद्ध',
  teamTaskComplete: 'पूर्ण करें',
  teamTaskReopen: 'पुनः खोलें',
  teamTaskDelete: 'हटाएँ',
  teamTaskDeleteConfirm: 'हटाने की पुष्टि करें',
  teamTaskEdit: 'संपादित करें',
  teamTaskSave: 'सहेजें',
  teamTaskCancel: 'रद्द करें',
  teamTaskConflict: 'कार्य दूसरी जगह बदल गया; ताज़ा कर दिया गया',
  teamTaskError: 'ऑपरेशन विफल: {message}',
  teamTaskDeleted: 'हटाया गया',
  teamTaskActions: 'कार्य क्रियाएँ',
  teamTaskDetail: 'कार्य विवरण',
  teamTaskNoDescription: 'अभी कोई विवरण नहीं — जोड़ने के लिए “संपादित करें” पर क्लिक करें',
  teamTaskBlockedBy: 'इनसे अवरुद्ध',
  teamTaskSubjectPlaceholder: 'काम को एक पंक्ति में बताएँ',
  teamTaskDescriptionPlaceholder: 'अतिरिक्त जानकारी (वैकल्पिक)',
  teamFilterAll: 'सभी',
  tasksNodeTasks: 'साझा कार्य',
  jobCopyOutput: 'आउटपुट कॉपी',
  jobCopied: 'कॉपी हो गया',
  jobFollowTail: 'नवीनतम पर बने रहें',
  jobDragHint: 'ड्रैग करके खिसकाएँ',
  workflowRunning: 'चल रहा है',
  workflowCompleted: 'पूर्ण',
  workflowCancelled: 'रद्द किया गया',
  workflowFailed: 'विफल',
  workflowPhaseUnnamed: 'अनामित चरण',
  workflowMembers: '{done}/{total} सदस्य',
  jobsAutoCollapsed: 'एजेंट बहुत सारे, स्वतः संकुचित किया गया',
  catalogLoadFailed: '{count} ब्रांच लोड होने में विफल',
