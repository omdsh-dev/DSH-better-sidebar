...
export const hi: Record<string, string> = {
  ...
  subagentDelete: "स्थायी रूप से हटाएँ",
  subagentDeleteConfirm: "स्थायी रूप से हटाएँ",
  subagentDeleteDesc: "उप-एजेंट \"{name}\" और उसके सभी रिकॉर्ड (उसके उप-एजेंट सहित) स्थायी रूप से हटा दिए जाएँगे। इसे पूर्ववत नहीं किया जा सकता।",
  subagentDeleteRunning: "चल रहा है — हटा नहीं सकते",
  subagentDeleteUnavailable: "@michengai/dsh-archive-manager प्लगइन आवश्यक है",
