...
export const ko: Record<string, string> = {
  ...
  fileCommentsPanel: '현재 파일 댓글',
  fileCommentsCurrent: '현재',
  fileCommentsSend: '선택한 댓글을 Agent에게 보내기',
  fileCommentsSendShort: '보내기',
  fileCommentsSendFailed: '댓글 전송 실패: {error}',
  fileCommentsEmptyCurrent: '이 파일에 보내지 않은 댓글이 없습니다',
  fileCommentsEmptyHistory: '이 파일에 보낸 댓글이 없습니다',
  fileCommentsSelectionOmitted: '선택 영역이 너무 길어 파일 위치만 전송됩니다',
  fileCommentsEdit: '댓글 편집',
  fileCommentsDelete: '댓글 삭제',
  fileCommentsSelect: '댓글 선택',
  fileCommentsSelectAll: '전체 선택',
  fileCommentsClearSelection: '취소',
  fileCommentsDeleteSelected: '삭제',
  fileCommentsPlaceholder: '선택 영역에 대한 댓글 추가…',
