...
export const ko: Record<string, string> = {
  ...
  explorerExclude: '제외 패턴',
  explorerExcludeDesc: '일치하는 항목을 파일 트리와 검색에서 완전히 제거합니다(* 및 ? 지원, **/ 접두사는 모든 깊이에 일칩니다). 제외된 항목은 탐색경로 접기에 영향을 주지 않습니다',
  explorerExcludePlaceholder: '패턴 추가, 예: node_modules, *.log, **/.git',
  explorerExcludeAdd: '추가',
  explorerExcludeRemove: '제거',
