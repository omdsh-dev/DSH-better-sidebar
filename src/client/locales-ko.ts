...
export const ko: Record<string, string> = {
  ...
  searchPrevious: '이전',
  searchAll: '모두 선택',
  searchMatchCase: '대소문자 구분',
  searchWholeWord: '단어 단위',
  searchRegexp: '정규식',
  searchReplaceAll: '모두 바꾸기',
  searchCurrentMatch: '현재 일치',
  searchOnLine: '행',
  searchReplacedMatches: '$개 일치 항목을 바꿨습니다',
  searchReplacedMatchOnLine: '$행의 일치 항목을 바꿨습니다',
  searchGoToLine: '줄로 이동',
  searchGo: '이동',
