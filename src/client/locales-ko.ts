...
export const ko: Record<string, string> = {
  ...
  subagentDelete: "영구 삭제",
  subagentDeleteConfirm: "영구 삭제",
  subagentDeleteDesc: "하위 에이전트 \"{name}\" 및 모든 기록(하위 에이전트 포함)을 영구적으로 삭제합니다. 되돌릴 수 없습니다.",
  subagentDeleteRunning: "실행 중 — 삭제할 수 없음",
  subagentDeleteUnavailable: "@michengai/dsh-archive-manager 플러그인이 필요합니다",
