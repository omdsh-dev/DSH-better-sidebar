...
export const ko: Record<string, string> = {
  ...
  allowOutsideFiles: '작업 영역 밖의 파일 열기 허용',
  allowOutsideFilesDesc: '읽기 전용 옵션: 사이드바에서 세션 작업 영역 밖의 파일/폴더를 볼 수 있습니다. 편집, 저장, 업로드는 작업 영역 안으로만 제한됩니다.',
  externalReadonly: '외부 · 읽기 전용',
