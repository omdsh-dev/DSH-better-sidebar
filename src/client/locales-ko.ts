...
export const ko: Record<string, string> = {
  enterCodeFocus: '전체 화면',
  exitCodeFocus: '전체 화면 종료',
  resizeSidebar: '사이드바 너비 조절; 맨 오른쪽으로 끌면 숨겨집니다',
  releaseToHideSidebar: '놓아서 사이드바 숨기기',
  createFile: '새 파일',
  createFolder: '새 폴더',
  newFileName: '파일 이름',
  newFolderName: '폴더 이름',
  createNameRequired: '이름을 입력하세요',
  createNameInvalid: '이름은 . 또는 ..일 수 없으며 경로 구분자를 포함할 수 없습니다',
  creating: '만드는 중…',
  createDone: '{path}을(를) 만들었습니다',
  createFailed: '만들기 실패: {error}',
  operationBusy: '다른 파일 작업이 진행 중입니다',
  importFiles: '파일 가져오기',
  importFolder: '폴더 가져오기',
  deleteFile: '파일 삭제',
  deleteFileTitle: '파일 삭제',
  deleteFileDesc: '“{path}”을(를) 영구 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
  deleteFolder: '폴더 삭제',
  deleteFolderTitle: '폴더 삭제',
  deleteFolderDesc: '“{path}”과(와) 그 안의 모든 내용을 영구 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
  deleteSymlink: '심볼릭 링크 삭제',
  deleteSymlinkTitle: '심볼릭 링크 삭제',
  deleteSymlinkDesc: '심볼릭 링크 “{path}”을(를) 삭제하시겠습니까? 링크 대상은 삭제되지 않습니다. 이 작업은 되돌릴 수 없습니다.',
  deleting: '삭제 중…',
  deleteDone: '{path}을(를) 삭제했습니다',
