...
export const ko: Record<string, string> = {
  ...
  toc: '목차',
  review: '검토',
  reviewPending: '검토 대기 {count}건',
  reviewNoRepo: 'Git 저장소가 아닙니다',
  reviewAccepted: '수락됨',
  accept: '수락',
  acceptAll: '모두 수락',
  reject: '거부',
  rejectUntracked: '새 파일은 복원할 커밋 버전이 없습니다',
  find: '찾기',
  findPrev: '이전 일치',
  findNext: '다음 일치',
  findClose: '찾기 닫기',
  ...
  browserLocalBlockedTitle: '{authority}을(를) 신뢰하고 여시겠습니까?',
  browserLocalBlockedDesc: '컴퓨터에서 실행 중인 로컬 서비스입니다. 직접 시작했거나 신뢰하는 웹 앱인 경우에만 허용하세요. 권한은 이 주소와 포트에만 적용됩니다.',
  browserTrustAndOpen: '신뢰하고 열기',
  browserTrusting: '저장 중…',
  browserTrustFailed: '이 로컬 주소를 저장하지 못했습니다. 사이드바 설정 서비스를 확인한 후 다시 시도하세요.',
