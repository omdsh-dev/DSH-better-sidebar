...
export const ko: Record<string, string> = {
  ...
  guideDescPlan: '플랜 모드에서 모델이 제출한 플랜 전문을 버전별로 보관',
  ...
  plan: '플랜',
  planEmpty: '이 세션에 아직 플랜이 없습니다',
  planEmptyDesc: '플랜 모드에서 모델이 플랜을 제출하면 여기에 표시됩니다',
  planStatusPending: '검토 대기',
  planStatusApproved: '승인됨',
  planStatusUnadopted: '미채택',
  planCopy: '전문 복사',
  planLoadError: '플랜을 불러오지 못했습니다. 잠시 후 다시 시도합니다',
  ...
  settingsPlanTitle: '모델이 플랜을 제출하면 플랜 페이지 자동 열기',
  settingsPlanDesc: '현재 대화에서 모델이 플랜을 제출할 때마다 플랜 페이지를 엽니다(제출마다 트리거됨). 넓은 화면에서는 사이드 카드도 펼치지만, 좁은 화면에서는 전체 화면 드로어를 강제로 열지 않습니다. 끄면 수동으로 열어야 합니다',
