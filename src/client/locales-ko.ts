...
export const ko: Record<string, string> = {
  ...
  settingsSearchExcludeTitle: '검색에서 제외할 디렉터리',
  settingsSearchExcludeDesc: '파일명 검색 시 이 디렉터리를 건너뜁니다(쉼표로 구분; 임의 깊이의 같은 이름 디렉터리도 제외)',
  ...
  settingsImageDirTitle: 'Obsidian 이미지 디렉터리',
  settingsImageDirDesc: '![[x.png]] 임베드 해석·붙여넣기 저장 디렉터리: 세션 cwd 기준(기본 images) 또는 절대 경로',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: '미리보기 배색 테마',
  settingsMdPreviewThemeDesc: 'Markdown 파일 미리보기에만 적용되며 사이드 채팅·변경 읽기 모드에는 영향 없음',
  settingsMdPreviewThemeVivid: '선명',
  settingsMdPreviewThemeVividDesc: '제목·인용·표 머리글 등에 시맨틱 색으로 대비를 높임',
  settingsMdPreviewThemeHost: '호스트',
  settingsMdPreviewThemeHostDesc: '호스트 MarkdownText 배색을 그대로 유지',
  viewerCode: '코드',
