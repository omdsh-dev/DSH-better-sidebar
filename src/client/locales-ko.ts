...
export const ko: Record<string, string> = {
  ...
  closeUnsavedConfirm: '이 파일에 저장되지 않은 편집이 있습니다. 탭을 닫으면 삭제됩니다. 계속하시겠습니까?',
  save: '저장',
  saved: '저장됨',
  unsaved: '저장 안 됨',
  saveFailed: '저장 실패',
  saveConflict: '파일이 디스크에서 다른 곳에 의해 변경되었습니다. 저장이 중단되었고 편집 내용은 그대로 남아 있습니다.',   saveConflictReload: '디스크에서 다시 불러오기',
