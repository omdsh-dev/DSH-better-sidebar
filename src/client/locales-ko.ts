...
export const ko: Record<string, string> = {
  ...
  pluginIdeGitDesc: 'better-sidebar용 Git 탭: 브랜치 트리(ahead/behind 배지, worktree 표시), 텍스트/브랜치/작성자/날짜/경로 필터가 있는 커밋 그래프, 파일별 줄 diff, 변경 목록과 커밋 상자, 그리고 merge, rebase, cherry-pick, reset, stash, tag 작업. 파괴적인 작업은 확인을 거치고 삭제와 버리기는 되돌릴 수 있습니다. better-sidebar가 없으면 DSH 기본 오른쪽 사이드바에 등록되어 단독으로도 동작합니다',
  ...
  pluginIdeGitName: 'dsh-ide-git Git 창',
