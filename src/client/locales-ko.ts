...
export const ko: Record<string, string> = {
  ...
  jobKillError: '종료 실패',
  tasksViewGraph: '워크플로 그래프',
  tasksViewTree: '트리',
  tasksViewSwitchToGraph: '워크플로 그래프로 전환',
  tasksViewSwitchToTree: '트리로 전환',
  settingsViewModeTitle: '작업 관리 기본 보기',
  settingsViewModeDesc: '작업 관리 페이지를 열 때의 기본 표시 방식(페이지 안에서 언제든 임시 전환 가능)',
  settingsViewModeGraph: '워크플로 그래프',
  ...
  tasksFoldExpand: '완료된 노드 펼치기',
  tasksFoldCollapse: '완료된 노드 접기',
  tasksZoomIn: '확대',
  tasksZoomOut: '축소',
  ...
  tasksNodeMode: '모드',
  tasksNodeModel: '모델',
  tasksNodeTeamRole: '팀 역할',
  tasksNodeActivity: '최근 활동',
  tasksStateRunning: '실행 중',
  tasksStateIdle: '대기 중',
  tasksStateDone: '완료됨',
  tasksStateError: '오류',
  teamBoard: '팀 작업 보드',
  teamChip: '팀 멤버 {members}명 · 작업 {tasks}개',
  teamTasksEmpty: '공유 작업이 없습니다',
  teamTaskCreate: '새 작업',
  teamTaskSubject: '제목',
  teamTaskDescription: '설명',
  teamTaskOwner: '담당자',
  teamTaskUnowned: '미배정',
  teamTaskPending: '할 일',
  teamTaskInProgress: '진행 중',
  teamTaskCompleted: '완료됨',
  teamTaskBlocked: '차단됨',
  teamTaskComplete: '완료',
  teamTaskReopen: '다시 열기',
  teamTaskDelete: '삭제',
  teamTaskDeleteConfirm: '삭제 확인',
  teamTaskEdit: '편집',
  teamTaskSave: '저장',
  teamTaskCancel: '취소',
  teamTaskConflict: '다른 사람이 작업을 수정해 새로고침했습니다',
  teamTaskError: '작업 실패: {message}',
  teamTaskDeleted: '삭제됨',
  teamTaskActions: '작업 동작',
  teamTaskDetail: '작업 상세',
  teamTaskNoDescription: '설명이 아직 없음 — “편집”을 클릭해 추가',
  teamTaskBlockedBy: '차단 원인',
  teamTaskSubjectPlaceholder: '할 일을 한 줄로 설명',
  teamTaskDescriptionPlaceholder: '추가 설명 (선택)',
  teamFilterAll: '모두',
  tasksNodeTasks: '공유 작업',
  jobCopyOutput: '출력 복사',
  jobCopied: '복사됨',
  jobFollowTail: '최신 따라가기',
  jobDragHint: '드래그하여 이동',
  workflowRunning: '진행 중',
  workflowCompleted: '완료됨',
  workflowCancelled: '취소됨',
  workflowFailed: '실패',
  workflowPhaseUnnamed: '이름 없는 단계',
  workflowMembers: '{done}/{total} 멤버',
  jobsAutoCollapsed: '에이전트가 많아 자동으로 접었습니다',
  catalogLoadFailed: '{count}개 브랜치 로드 실패',
