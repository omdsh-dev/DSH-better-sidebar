...
export const id: Record<string, string> = {
  ...
  allowOutsideFiles: 'Izinkan membuka file di luar ruang kerja',
  allowOutsideFilesDesc: 'Opsi baca-saja: sidebar dapat melihat file/folder di luar ruang kerja sesi; edit, simpan, dan unggah tetap terbatas pada ruang kerja.',
  externalReadonly: 'Eksternal · baca-saja',
