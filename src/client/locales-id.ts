...
export const id: Record<string, string> = {
  enterCodeFocus: 'Layar penuh',
  exitCodeFocus: 'Keluar dari layar penuh',
  resizeSidebar: 'Ubah lebar bilah sisi; seret sepenuhnya ke kanan untuk menyembunyikan',
  releaseToHideSidebar: 'Lepaskan untuk menyembunyikan bilah sisi',
  createFile: 'Berkas baru',
  createFolder: 'Folder baru',
  newFileName: 'Nama berkas',
  newFolderName: 'Nama folder',
  createNameRequired: 'Masukkan nama',
  createNameInvalid: 'Nama tidak boleh . atau .. dan tidak boleh mengandung pemisah jalur',
  creating: 'Membuat…',
  createDone: '{path} telah dibuat',
  createFailed: 'Gagal membuat: {error}',
  operationBusy: 'Operasi berkas lain sedang berlangsung',
  importFiles: 'Impor berkas',
  importFolder: 'Impor folder',
  deleteFile: 'Hapus berkas',
  deleteFileTitle: 'Hapus berkas',
  deleteFileDesc: 'Hapus “{path}” secara permanen? Tindakan ini tidak dapat dibatalkan.',
  deleteFolder: 'Hapus folder',
  deleteFolderTitle: 'Hapus folder',
  deleteFolderDesc: 'Hapus “{path}” dan seluruh isinya secara permanen? Tindakan ini tidak dapat dibatalkan.',
  deleteSymlink: 'Hapus tautan simbolis',
  deleteSymlinkTitle: 'Hapus tautan simbolis',
  deleteSymlinkDesc: 'Hapus tautan simbolis “{path}”? Targetnya tidak akan dihapus. Tindakan ini tidak dapat dibatalkan.',
  deleting: 'Menghapus…',
  deleteDone: '{path} telah dihapus',
