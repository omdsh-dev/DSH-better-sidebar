...
export const id: Record<string, string> = {
  ...
  subagentDelete: "Hapus permanen",
  subagentDeleteConfirm: "Hapus permanen",
  subagentDeleteDesc: "Menghapus subagen \"{name}\" dan semua catatannya (termasuk subagen anak) secara permanen. Tindakan ini tidak dapat dibatalkan.",
  subagentDeleteRunning: "Sedang berjalan — tidak dapat dihapus",
  subagentDeleteUnavailable: "Memerlukan plugin @michengai/dsh-archive-manager",
