...
export const id: Record<string, string> = {
  ...
  pluginIdeGitDesc: 'Tab Git untuk better-sidebar: pohon branch (lencana ahead/behind, penanda worktree), grafik commit dengan filter teks/branch/penulis/tanggal/jalur, diff baris per berkas, daftar perubahan dan kotak commit, plus merge, rebase, cherry-pick, reset, stash, dan tag; tindakan merusak meminta konfirmasi dan penghapusan atau pembuangan dapat dibatalkan. Tanpa better-sidebar ia mendaftar ke sidebar kanan asli DSH sehingga tetap bisa dipakai sendiri',
  ...
  pluginIdeGitName: 'dsh-ide-git Jendela Git',
