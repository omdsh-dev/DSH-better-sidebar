...
export const id: Record<string, string> = {
  ...
  editorContentMode: 'Mode tampilan konten',
  ...
  fileCommentsPanel: 'Komentar berkas saat ini',
  fileCommentsCurrent: 'Saat ini',
  fileCommentsSend: 'Kirim komentar terpilih ke Agent',
  fileCommentsSendShort: 'Kirim',
  fileCommentsSendFailed: 'Gagal mengirim komentar: {error}',
  fileCommentsEmptyCurrent: 'Tidak ada komentar yang belum dikirim untuk berkas ini',
  fileCommentsEmptyHistory: 'Tidak ada komentar terkirim untuk berkas ini',
  fileCommentsSelectionOmitted: 'Pilihan terlalu panjang; hanya lokasi berkas yang akan dikirim',
  fileCommentsEdit: 'Edit komentar',
  fileCommentsDelete: 'Hapus komentar',
  fileCommentsSelect: 'Pilih komentar',
  fileCommentsSelectAll: 'Pilih semua',
  fileCommentsClearSelection: 'Batal',
  fileCommentsDeleteSelected: 'Hapus',
  fileCommentsPlaceholder: 'Tambahkan komentar tentang pilihan…',
