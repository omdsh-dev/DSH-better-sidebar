...
export const id: Record<string, string> = {
  ...
  guideDescPlan: 'Setiap rencana yang diajukan model dalam mode perencanaan, disimpan utuh per revisi',
  ...
  plan: 'Rencana',
  planEmpty: 'Belum ada rencana di sesi ini',
  planEmptyDesc: 'Rencana yang diajukan model dalam mode perencanaan akan muncul di sini',
  planStatusPending: 'Menunggu tinjauan',
  planStatusApproved: 'Disetujui',
  planStatusUnadopted: 'Tidak diadopsi',
  planCopy: 'Salin rencana',
  planLoadError: 'Gagal memuat rencana, akan dicoba lagi',
  ...
  settingsPlanTitle: 'Buka otomatis halaman Rencana saat model mengajukan rencana',
  settingsPlanDesc: 'Saat model mengajukan rencana di obrolan saat ini, buka halaman Rencana (setiap rencana yang diajukan memicu pembukaan); pada layar lebar, kartu samping juga dibentangkan; pada layar sempit, laci layar penuh tidak dipaksa terbuka; matikan untuk membukanya secara manual',
