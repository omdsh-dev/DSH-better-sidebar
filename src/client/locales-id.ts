...
export const id: Record<string, string> = {
  ...
  generatingCommitMessage: 'Membuat pesan commit…',
  suggestCommitError: 'Gagal membuat pesan commit',
  suggestCommitEmpty: 'Tidak ada perubahan yang tertunda',
  push: 'Dorong',
  pull: 'Tarik',
  pushError: 'Dorong gagal',
  pullError: 'Tarik gagal',
  branch: 'Branch',
  worktree: 'Worktree',
