...
export const id: Record<string, string> = {
  ...
  pasteImageFailed: 'Gagal menempel gambar',
  ...
  settingsSearchExcludeTitle: 'Direktori yang dikecualikan dari pencarian',
  settingsSearchExcludeDesc: 'Lewati direktori ini saat pencarian nama berkas (dipisah koma; nama yang sama di kedalaman mana pun dikecualikan)',
  ...
  settingsImageDirTitle: 'Direktori gambar Obsidian',
  settingsImageDirDesc: 'Direktori embed ![[x.png]] dan gambar yang ditempel: relatif ke cwd sesi (default images) atau jalur absolut',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'Tema warna pratinjau',
  settingsMdPreviewThemeDesc: 'Hanya berlaku untuk pratinjau berkas Markdown — bukan Side Chat atau mode baca Changes',
  settingsMdPreviewThemeVivid: 'Cerah',
  settingsMdPreviewThemeVividDesc: 'Aksen judul, kutipan, dan tabel lebih kaya lewat token semantik',
  settingsMdPreviewThemeHost: 'Host',
  settingsMdPreviewThemeHostDesc: 'Pertahankan warna MarkdownText host apa adanya',
  viewerCode: 'Kode',
