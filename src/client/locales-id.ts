...
export const id: Record<string, string> = {
  ...
  sideChatBlockNoExitCode: "Berakhir tanpa kode keluar",
  ...
  tasksViewGraph: 'Graf alur kerja',
  tasksViewTree: 'Pohon',
  tasksViewSwitchToGraph: 'Beralih ke graf alur kerja',
  tasksViewSwitchToTree: 'Beralih ke pohon',
  settingsViewModeTitle: 'Tampilan default halaman Tasks',
  settingsViewModeDesc: 'Bagaimana halaman Tasks dirender saat dibuka (tombol di halaman tetap bisa mengalihkannya sementara)',
  settingsViewModeGraph: 'Graf alur kerja',
  ...
  tasksFoldCollapse: 'Lipat node yang selesai',
  tasksZoomIn: 'Perbesar',
  ...
  tasksNodeTeamRole: 'Peran tim',
  tasksNodeActivity: 'Aktivitas terbaru',
  tasksStateRunning: 'Berjalan',
  tasksStateIdle: 'Siaga',
  tasksStateDone: 'Selesai',
  tasksStateError: 'Error',
  teamBoard: 'Papan tugas tim',
  teamChip: 'Tim {members} anggota · {tasks} tugas',
  teamTasksEmpty: 'Belum ada tugas bersama',
  teamTaskCreate: 'Tugas baru',
  teamTaskSubject: 'Judul',
  teamTaskDescription: 'Deskripsi',
  teamTaskOwner: 'Penanggung jawab',
  teamTaskUnowned: 'Belum diklaim',
  teamTaskPending: 'Tertunda',
  teamTaskInProgress: 'Sedang berjalan',
  teamTaskCompleted: 'Selesai',
  teamTaskBlocked: 'Terblokir',
  teamTaskComplete: 'Selesaikan',
  teamTaskReopen: 'Buka kembali',
  teamTaskDelete: 'Hapus',
  teamTaskDeleteConfirm: 'Konfirmasi hapus',
  teamTaskEdit: 'Edit',
  teamTaskSave: 'Simpan',
  teamTaskCancel: 'Batal',
  teamTaskConflict: 'Tugas berubah di tempat lain; sudah disegarkan',
  teamTaskError: 'Operasi gagal: {message}',
  teamTaskDeleted: 'Terhapus',
  teamTaskActions: 'Aksi tugas',
  teamTaskDetail: 'Detail tugas',
  teamTaskNoDescription: 'Belum ada deskripsi — klik “Edit” untuk menambahkan',
  teamTaskBlockedBy: 'Diblokir oleh',
  teamTaskSubjectPlaceholder: 'Jelaskan pekerjaan dalam satu baris',
  teamTaskDescriptionPlaceholder: 'Keterangan tambahan (opsional)',
  teamFilterAll: 'Semua',
  tasksNodeTasks: 'Tugas bersama',
  jobCopyOutput: 'Salin keluaran',
  jobCopied: 'Tersalin',
  jobFollowTail: 'Ikuti baris terbaru',
  jobDragHint: 'Seret untuk memindahkan',
  workflowRunning: 'Berjalan',
  workflowCompleted: 'Selesai',
  workflowCancelled: 'Dibatalkan',
  workflowFailed: 'Gagal',
  workflowPhaseUnnamed: 'Fase tanpa nama',
  workflowMembers: '{done}/{total} anggota',
  jobsAutoCollapsed: 'Dilipat otomatis (agen banyak)',
  catalogLoadFailed: '{count} cabang gagal dimuat',
