...
export const id: Record<string, string> = {
  ...
  toc: 'Daftar Isi',
  review: 'Tinjau',
  reviewPending: '{count} perlu ditinjau',
  reviewNoRepo: 'Bukan repositori Git',
  reviewAccepted: 'Diterima',
  accept: 'Terima',
  acceptAll: 'Terima semua',
  reject: 'Tolak',
  rejectUntracked: 'Berkas baru tidak punya versi commit untuk dipulihkan',
  find: 'Cari',
  findPrev: 'Kecocokan sebelumnya',
  findNext: 'Kecocokan berikutnya',
  findClose: 'Tutup pencarian',
  findNoResults: 'Tidak ada hasil',
  edit: 'Edit',
  ...
  browserLocalBlockedTitle: 'Percayai dan buka {authority}?',
  browserLocalBlockedDesc: 'Ini adalah layanan lokal di komputer Anda. Izinkan hanya jika Anda menjalankan atau memercayai aplikasi web ini. Akses hanya berlaku untuk alamat dan port ini.',
  browserTrustAndOpen: 'Percayai dan buka',
  browserTrusting: 'Menyimpan…',
  browserTrustFailed: 'Alamat lokal ini tidak dapat disimpan. Periksa layanan pengaturan bilah sisi lalu coba lagi.',
