...
export const id: Record<string, string> = {
  ...
  replace: 'Ganti',
  findNext: 'Berikutnya',
  findPrevious: 'Sebelumnya',
  findAll: 'Pilih semua',
  findMatchCase: 'Cocokkan huruf besar/kecil',
  findRegexp: 'Regex',
  findByWord: 'Kata utuh',
  replaceOne: 'Ganti',
  ...
  closeUnsavedConfirm: 'File ini memiliki edit yang belum disimpan. Menutup tab akan membuangnya. Lanjutkan?',
  save: 'Simpan',
  saved: 'Tersimpan',
  unsaved: 'Belum disimpan',
  saveFailed: 'Gagal menyimpan',
  saveConflict: 'File diubah di disk oleh sumber lain. Penyimpanan dihentikan; edit Anda tetap ada di editor.',   saveConflictReload: 'Muat ulang dari disk',
