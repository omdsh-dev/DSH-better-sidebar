...
export const id: Record<string, string> = {
  ...
  explorerExclude: 'Pola pengecualian',
  explorerExcludeDesc: 'Menghapus entri yang cocok sepenuhnya dari pohon berkas dan pencarian (mendukung * dan ?, awalan **/ cocok di kedalaman apa pun); entri yang dikecualikan tidak pernah menghambat pelipatan breadcrumb',
  explorerExcludePlaceholder: 'Tambahkan pola, mis. node_modules, *.log, **/.git',
  explorerExcludeAdd: 'Tambah',
  explorerExcludeRemove: 'Hapus',
