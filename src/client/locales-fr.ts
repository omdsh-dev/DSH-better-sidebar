...
export const fr: Record<string, string> = {
  ...
  guideDescSubagent: 'Diagramme de workflow, tableau de tâches d\'équipe et travaux d\'arrière-plan, en direct',
  ...
  tasksViewGraph: 'Diagramme de workflow',
  tasksViewTree: 'Arbre',
  tasksViewSwitchToGraph: 'Passer au diagramme de workflow',
  tasksViewSwitchToTree: 'Passer à l’arbre',
  settingsViewModeTitle: 'Vue par défaut de la page Tâches',
  settingsViewModeDesc: 'Comment la page Tâches s’affiche à l’ouverture (le bouton dans la page permet toujours de basculer à la volée)',
  settingsViewModeGraph: 'Diagramme de workflow',
  ...
  tasksFoldExpand: 'Déplier les nœuds terminés',
  tasksFoldCollapse: 'Replier les nœuds terminés',
  tasksZoomIn: 'Zoom avant',
  ...
  tasksNodeTeamRole: 'Rôle dans l’équipe',
  tasksNodeActivity: 'Dernière activité',
  tasksStateRunning: 'En cours',
  tasksStateIdle: 'Inactif',
  tasksStateDone: 'Terminé',
  tasksStateError: 'Erreur',
  teamBoard: 'Tableau des tâches d’équipe',
  teamChip: 'Équipe {members} membres · {tasks} tâches',
  teamTasksEmpty: 'Aucune tâche partagée pour l’instant',
  teamTaskCreate: 'Nouvelle tâche',
  teamTaskSubject: 'Sujet',
  teamTaskDescription: 'Description',
  teamTaskOwner: 'Responsable',
  teamTaskUnowned: 'Non réclamée',
  teamTaskPending: 'À faire',
  teamTaskInProgress: 'En cours',
  teamTaskCompleted: 'Terminée',
  teamTaskBlocked: 'Bloquée',
  teamTaskComplete: 'Terminer',
  teamTaskReopen: 'Rouvrir',
  teamTaskDelete: 'Supprimer',
  teamTaskDeleteConfirm: 'Confirmer la suppression',
  teamTaskEdit: 'Modifier',
  teamTaskSave: 'Enregistrer',
  teamTaskCancel: 'Annuler',
  teamTaskConflict: 'La tâche a été modifiée ailleurs ; actualisée',
  teamTaskError: 'Échec de l’opération : {message}',
  teamTaskDeleted: 'Supprimée',
  teamTaskActions: 'Actions sur la tâche',
  teamTaskDetail: 'Détails de la tâche',
  teamTaskNoDescription: 'Aucune description pour le moment — cliquez sur « Modifier » pour en ajouter une',
  teamTaskBlockedBy: 'Bloquée par',
  teamTaskSubjectPlaceholder: 'Décrire le travail en une ligne',
  teamTaskDescriptionPlaceholder: 'Précisions (facultatif)',
  teamFilterAll: 'Tout',
  tasksNodeTasks: 'Tâches partagées',
  jobCopyOutput: 'Copier la sortie',
  jobCopied: 'Copié',
  jobFollowTail: 'Suivre la fin',
  jobDragHint: 'Glisser pour déplacer',
  workflowRunning: 'En cours',
  workflowCompleted: 'Terminé',
  workflowCancelled: 'Annulé',
  workflowFailed: 'Échoué',
  workflowPhaseUnnamed: 'Phase sans nom',
  workflowMembers: '{done}/{total} membres',
  jobsAutoCollapsed: 'Replié automatiquement (nombreux agents)',
  catalogLoadFailed: '{count} branches n’ont pas pu être chargées',
