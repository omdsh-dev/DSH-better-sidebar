...
export const fr: Record<string, string> = {
  ...
  explorerExclude: 'Motifs d’exclusion',
  explorerExcludeDesc: 'Supprime entièrement les entrées correspondantes de l’arborescence et de la recherche (wildcards * et ?, un préfixe **/ correspond à toute profondeur) ; les entrées exclues ne bloquent jamais le repli en fil d’Ariane',
  explorerExcludePlaceholder: 'Ajouter un motif, ex. node_modules, *.log, **/.git',
  explorerExcludeAdd: 'Ajouter',
  explorerExcludeRemove: 'Supprimer',
