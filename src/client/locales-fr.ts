...
export const fr: Record<string, string> = {
  ...
  pasteImageFailed: 'Échec du collage de l’image',
  ...
  settingsSearchExcludeTitle: 'Répertoires exclus de la recherche',
  settingsSearchExcludeDesc: 'Ignorer ces répertoires lors de la recherche par nom de fichier (séparés par des virgules ; même nom à toute profondeur exclu)',
  ...
  settingsImageDirTitle: 'Dossier images Obsidian',
  settingsImageDirDesc: 'Dossier des intégrations ![[x.png]] et images collées : relatif au répertoire de session (défaut images) ou chemin absolu',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'Thème de couleurs de l’aperçu',
  settingsMdPreviewThemeDesc: 'S’applique uniquement à l’aperçu des fichiers Markdown — pas au Side Chat ni au mode lecture Changes',
  settingsMdPreviewThemeVivid: 'Vif',
  settingsMdPreviewThemeVividDesc: 'Titres, citations et en-têtes de tableau plus contrastés via les jetons sémantiques',
  settingsMdPreviewThemeHost: 'Hôte',
  settingsMdPreviewThemeHostDesc: 'Conserver les couleurs MarkdownText de l’hôte telles quelles',
  viewerCode: 'Code',
