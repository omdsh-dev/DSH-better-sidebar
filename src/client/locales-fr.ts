...
export const fr: Record<string, string> = {
  ...
  generatingCommitMessage: 'Génération du message de commit…',
  suggestCommitError: 'Échec de la génération du message de commit',
  suggestCommitEmpty: 'Aucune modification en attente',
  push: 'Pousser',
  pull: 'Tirer',
  pushError: 'Échec du push',
  pullError: 'Échec du pull',
  branch: 'Branche',
