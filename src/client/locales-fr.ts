...
export const fr: Record<string, string> = {
  ...
  subagentDelete: "Supprimer définitivement",
  subagentDeleteConfirm: "Supprimer définitivement",
  subagentDeleteDesc: "Supprime définitivement le sous-agent « {name} » et tous ses enregistrements (y compris ses sous-agents). Action irréversible.",
  subagentDeleteRunning: "En cours — suppression impossible",
  subagentDeleteUnavailable: "Nécessite le plugin @michengai/dsh-archive-manager",
