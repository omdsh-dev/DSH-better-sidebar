...
export const fr: Record<string, string> = {
  ...
  guideDescPlan: 'Chaque plan présenté par le modèle en mode plan, conservé intégralement à chaque révision',
  ...
  plan: 'Plan',
  planEmpty: 'Aucun plan dans cette session pour l’instant',
  planEmptyDesc: 'Les plans présentés par le modèle en mode plan apparaîtront ici',
  planStatusPending: 'En attente de revue',
  planStatusApproved: 'Approuvé',
  planStatusUnadopted: 'Non adopté',
  planCopy: 'Copier le plan',
  planLoadError: 'Impossible de charger le plan ; nouvelle tentative en cours',
  ...
  settingsPlanTitle: 'Ouvrir automatiquement la page Plan lorsque le modèle présente un plan',
  settingsPlanDesc: 'À chaque plan présenté par le modèle dans la session actuelle, ouvrir la page Plan (chaque plan présenté déclenche l’ouverture) ; sur les écrans larges, déployer également la carte latérale ; sur les écrans étroits, ne pas forcer l’ouverture du tiroir plein écran ; une fois l’option désactivée, l’ouverture est manuelle',
