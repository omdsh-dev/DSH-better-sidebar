...
export const fr: Record<string, string> = {
  ...
  allowOutsideFiles: 'Autoriser l’ouverture de fichiers hors de l’espace de travail',
  allowOutsideFilesDesc: 'Option en lecture seule : la barre latérale peut afficher des fichiers/dossiers hors de l’espace de travail de la session ; la modification, l’enregistrement et l’envoi restent limités à l’espace de travail.',
  externalReadonly: 'Externe · lecture seule',
