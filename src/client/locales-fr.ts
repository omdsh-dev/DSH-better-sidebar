...
export const fr: Record<string, string> = {
  enterCodeFocus: 'Plein écran',
  exitCodeFocus: 'Quitter le plein écran',
  resizeSidebar: 'Redimensionner la barre latérale ; faites-la glisser tout à droite pour la masquer',
  releaseToHideSidebar: 'Relâchez pour masquer la barre latérale',
  ...
  createNameInvalid: 'Le nom ne peut pas être . ou .. ni contenir de séparateur de chemin',
  creating: 'Création…',
  createDone: '{path} a été créé',
  createFailed: 'Échec de la création : {error}',
  operationBusy: 'Une autre opération sur les fichiers est en cours',
  importFiles: 'Importer des fichiers',
  importFolder: 'Importer un dossier',
  deleteFile: 'Supprimer le fichier',
  deleteFileTitle: 'Supprimer le fichier',
  deleteFileDesc: 'Supprimer définitivement « {path} » ? Cette action est irréversible.',
  deleteFolder: 'Supprimer le dossier',
  deleteFolderTitle: 'Supprimer le dossier',
  deleteFolderDesc: 'Supprimer définitivement « {path} » et tout son contenu ? Cette action est irréversible.',
  deleteSymlink: 'Supprimer le lien symbolique',
  deleteSymlinkTitle: 'Supprimer le lien symbolique',
  deleteSymlinkDesc: 'Supprimer le lien symbolique « {path} » ? Sa cible ne sera pas supprimée. Cette action est irréversible.',
  deleting: 'Suppression…',
  deleteDone: '{path} a été supprimé',
