...
export const fr: Record<string, string> = {
  ...
  toc: 'Sommaire',
  review: 'Révision',
  reviewPending: '{count} à réviser',
  reviewNoRepo: 'Pas un dépôt Git',
  reviewAccepted: 'Acceptée',
  accept: 'Accepter',
  acceptAll: 'Tout accepter',
  reject: 'Rejeter',
  rejectUntracked: "Un nouveau fichier n'a aucune version validée à restaurer",
  find: 'Rechercher',
  ...
  browserLocalBlockedTitle: 'Faire confiance à {authority} et ouvrir ?',
  browserLocalBlockedDesc: 'Ce service est exécuté sur votre ordinateur. Autorisez-le uniquement si vous avez lancé cette application web ou si vous lui faites confiance. Cet accès se limite à cette adresse et à ce port.',
  browserTrustAndOpen: 'Faire confiance et ouvrir',
  browserTrusting: 'Enregistrement…',
  browserTrustFailed: 'Impossible d’enregistrer cette adresse locale. Vérifiez le service de réglages de la barre latérale et réessayez.',
