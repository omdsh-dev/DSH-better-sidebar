...
export const fr: Record<string, string> = {
  ...
  findAll: 'Tout sélectionner',
  findMatchCase: 'Respecter la casse',
  findRegexp: 'Regex',
  findByWord: 'Mot entier',
  ...
  closeUnsavedConfirm: 'Ce fichier contient des modifications non enregistrées. Fermer l\'onglet les perdra. Continuer ?',
  save: 'Enregistrer',
  saved: 'Enregistré',
  unsaved: 'Non enregistré',
  saveFailed: 'Échec de l’enregistrement',
  saveConflict: 'Le fichier a été modifié sur le disque par une autre source. Enregistrement interrompu ; vos modifications restent dans l\'éditeur.',
  saveConflictReload: 'Recharger depuis le disque',
