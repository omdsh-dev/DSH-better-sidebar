...
export const fr: Record<string, string> = {
  ...
  editorContentMode: 'Mode d’affichage du contenu',
  ...
  fileCommentsPanel: 'Commentaires du fichier actuel',
  fileCommentsCurrent: 'Actuels',
  fileCommentsSend: 'Envoyer les commentaires sélectionnés à Agent',
  fileCommentsSendShort: 'Envoyer',
  fileCommentsSendFailed: 'Échec de l’envoi des commentaires : {error}',
  fileCommentsEmptyCurrent: 'Aucun commentaire non envoyé pour ce fichier',
  fileCommentsEmptyHistory: 'Aucun commentaire envoyé pour ce fichier',
  fileCommentsSelectionOmitted: 'La sélection est trop longue ; seule sa position sera envoyée',
  fileCommentsEdit: 'Modifier le commentaire',
  fileCommentsDelete: 'Supprimer le commentaire',
  fileCommentsSelect: 'Sélectionner le commentaire',
  fileCommentsSelectAll: 'Tout sélectionner',
  fileCommentsClearSelection: 'Annuler',
  fileCommentsDeleteSelected: 'Supprimer',
  fileCommentsPlaceholder: 'Ajouter un commentaire sur la sélection…',
