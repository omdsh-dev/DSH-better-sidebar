export const pt: Record<string, string> = {
  ...
  searchReplace: 'Substituir',
  searchNext: 'Seguinte',
  searchPrevious: 'Anterior',
  searchAll: 'Selecionar tudo',
  searchMatchCase: 'Diferenciar maiúsculas',
  searchWholeWord: 'Palavra inteira',
  searchRegexp: 'Regexp',
  searchReplaceAll: 'Substituir tudo',
  searchCurrentMatch: 'Correspondência atual',
  searchOnLine: 'na linha',
  searchReplacedMatches: '$ correspondências substituídas',
  searchReplacedMatchOnLine: 'correspondência substituída na linha $',
  searchGoToLine: 'Ir para a linha',
  searchGo: 'Ir',
