export const pt: Record<string, string> = {
  ...
  guideDescPlan: 'Todo plano apresentado pelo modelo no modo de plano, arquivado por versão',
  ...
  plan: 'Plano',
  planEmpty: 'Ainda sem planos nesta sessão',
  planEmptyDesc: 'Apresente um plano no modo de plano e ele aparecerá aqui',
  planStatusPending: 'Aguardando revisão',
  planStatusApproved: 'Aprovado',
  planStatusUnadopted: 'Não adotado',
  planCopy: 'Copiar plano',
  planLoadError: 'Falha ao carregar o plano; tentando novamente',
  ...
  settingsPlanTitle: 'Ativar automaticamente a página de Plano quando o modelo apresentar um plano',
  settingsPlanDesc: 'Ativar a página de Plano quando o modelo apresentar um plano na conversa atual; em telas largas, expandir também o cartão lateral; em telas estreitas, não forçar a abertura da gaveta em tela cheia; desative para abri-la manualmente',
