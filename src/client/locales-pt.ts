export const pt: Record<string, string> = {
  ...
  guideDescSubagent: 'Grafo do workflow, quadro de tarefas da equipe e tarefas em segundo plano, ao vivo',
  ...
  sideChatBlockNoExitCode: "Terminou sem código de saída",
  ...
  tasksViewGraph: 'Grafo do workflow',
  tasksViewTree: 'Árvore',
  tasksViewSwitchToGraph: 'Mudar para o grafo do workflow',
  tasksViewSwitchToTree: 'Mudar para a árvore',
  settingsViewModeTitle: 'Visualização padrão da página de tarefas',
  settingsViewModeDesc: 'Como a página de tarefas é exibida ao abrir (o seletor na própria página ainda permite alternar pontualmente)',
  settingsViewModeGraph: 'Grafo do workflow',
  ...
  tasksFoldCollapse: 'Recolher os nós concluídos',
  tasksZoomIn: 'Aproximar',
  ...
  tasksNodeTeamRole: 'Função na equipe',
  tasksNodeActivity: 'Atividade recente',
  tasksStateRunning: 'Em execução',
  tasksStateIdle: 'Em espera',
  tasksStateDone: 'Concluído',
  tasksStateError: 'Erro',
  teamBoard: 'Quadro de tarefas da equipe',
  teamChip: 'Equipe {members} membros · {tasks} tarefas',
  teamTasksEmpty: 'Ainda não há tarefas compartilhadas',
  teamTaskCreate: 'Nova tarefa',
  teamTaskSubject: 'Assunto',
  teamTaskDescription: 'Descrição',
  teamTaskOwner: 'Responsável',
  teamTaskUnowned: 'Não reivindicada',
  teamTaskPending: 'Pendente',
  teamTaskInProgress: 'Em andamento',
  teamTaskCompleted: 'Concluída',
  teamTaskBlocked: 'Bloqueada',
  teamTaskComplete: 'Concluir',
  teamTaskReopen: 'Reabrir',
  teamTaskDelete: 'Excluir',
  teamTaskDeleteConfirm: 'Confirmar exclusão',
  teamTaskEdit: 'Editar',
  teamTaskSave: 'Salvar',
  teamTaskCancel: 'Cancelar',
  teamTaskConflict: 'A tarefa foi alterada por outra pessoa; atualizada',
  teamTaskError: 'Operação falhou: {message}',
  teamTaskDeleted: 'Excluída',
  teamTaskActions: 'Ações da tarefa',
  teamTaskDetail: 'Detalhes da tarefa',
  teamTaskNoDescription: 'Ainda sem descrição — clique em “Editar” para adicionar',
  teamTaskBlockedBy: 'Bloqueada por',
  teamTaskSubjectPlaceholder: 'Descreva o trabalho em uma linha',
  teamTaskDescriptionPlaceholder: 'Detalhes adicionais (opcional)',
  teamFilterAll: 'Tudo',
  tasksNodeTasks: 'Tarefas compartilhadas',
  jobCopyOutput: 'Copiar saída',
  jobCopied: 'Copiado',
  jobFollowTail: 'Acompanhar as últimas linhas',
  jobDragHint: 'Arraste para mover',
  workflowRunning: 'Em execução',
  workflowCompleted: 'Concluído',
  workflowCancelled: 'Cancelado',
  workflowFailed: 'Falhou',
  workflowPhaseUnnamed: 'Fase sem nome',
  workflowMembers: '{done}/{total} membros',
  jobsAutoCollapsed: 'Recolhido automaticamente (muitos agentes)',
  catalogLoadFailed: 'Falha ao carregar {count} branches',
