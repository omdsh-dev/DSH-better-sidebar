export const pt: Record<string, string> = {
  ...
  replace: 'Substituir',
  findNext: 'Próximo',
  findPrevious: 'Anterior',
  findAll: 'Selecionar tudo',
  findMatchCase: 'Diferenciar maiúsculas',
  findRegexp: 'Regex',
  findByWord: 'Palavra inteira',
  ...
  closeUnsavedConfirm: 'Este arquivo tem edições não salvas. Fechar a aba irá descartá-las. Continuar?',
  save: 'Salvar',
  saved: 'Salvo',
  unsaved: 'Não salvo',
  saveFailed: 'Falha ao salvar',
  saveConflict: 'O arquivo foi alterado no disco por outra origem. Salvamento cancelado; suas edições permanecem no editor.',   saveConflictReload: 'Recarregar do disco',
