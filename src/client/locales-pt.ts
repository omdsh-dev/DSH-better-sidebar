export const pt: Record<string, string> = {
  ...
  pasteImageFailed: 'Falha ao colar imagem',
  ...
  settingsSearchExcludeTitle: 'Diretórios excluídos da pesquisa',
  settingsSearchExcludeDesc: 'Ignorar estes diretórios na pesquisa por nome de ficheiro (separados por vírgulas; o mesmo nome em qualquer profundidade é excluído)',
  ...
  settingsImageDirTitle: 'Diretório de imagens do Obsidian',
  settingsImageDirDesc: 'Diretório de embeds ![[x.png]] e imagens coladas: relativo ao cwd da sessão (padrão images) ou caminho absoluto',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'Tema de cores da pré-visualização',
  settingsMdPreviewThemeDesc: 'Aplica-se apenas à pré-visualização de ficheiros Markdown — não ao Side Chat nem ao modo de leitura Changes',
  settingsMdPreviewThemeVivid: 'Vívido',
  settingsMdPreviewThemeVividDesc: 'Títulos, citações e cabeçalhos de tabela mais contrastados via tokens semânticos',
  settingsMdPreviewThemeHost: 'Anfitrião',
  settingsMdPreviewThemeHostDesc: 'Manter as cores MarkdownText do anfitrião como estão',
  viewerCode: 'Código',
