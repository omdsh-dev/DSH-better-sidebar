export const pt: Record<string, string> = {
  ...
  editorContentMode: 'Modo de visualização do conteúdo',
  ...
  fileCommentsPanel: 'Comentários do arquivo atual',
  fileCommentsCurrent: 'Atuais',
  fileCommentsSend: 'Enviar comentários selecionados ao Agent',
  fileCommentsSendShort: 'Enviar',
  fileCommentsSendFailed: 'Falha ao enviar comentários: {error}',
  fileCommentsEmptyCurrent: 'Nenhum comentário não enviado para este arquivo',
  fileCommentsEmptyHistory: 'Nenhum comentário enviado para este arquivo',
  fileCommentsSelectionOmitted: 'A seleção é muito longa; apenas a localização será enviada',
  fileCommentsEdit: 'Editar comentário',
  fileCommentsDelete: 'Excluir comentário',
  fileCommentsSelect: 'Selecionar comentário',
  fileCommentsSelectAll: 'Selecionar tudo',
  fileCommentsClearSelection: 'Cancelar',
  fileCommentsDeleteSelected: 'Excluir',
  fileCommentsPlaceholder: 'Adicionar um comentário sobre a seleção…',
