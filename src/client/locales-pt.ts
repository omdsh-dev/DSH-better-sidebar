export const pt: Record<string, string> = {
  ...
  explorerExclude: 'Padrões de exclusão',
  explorerExcludeDesc: 'Remove totalmente as entradas correspondentes da árvore de ficheiros e da pesquisa (suporta * e ?, um prefixo **/ corresponde a qualquer profundidade); as entradas excluídas nunca bloqueiam a dobra da trilha',
  explorerExcludePlaceholder: 'Adicionar padrão, ex.: node_modules, *.log, **/.git',
  explorerExcludeAdd: 'Adicionar',
  explorerExcludeRemove: 'Remover',
