export const pt: Record<string, string> = {
  ...
  subagentDelete: "Excluir permanentemente",
  subagentDeleteConfirm: "Excluir permanentemente",
  subagentDeleteDesc: "Exclui permanentemente o subagente \"{name}\" e todos os seus registros (incluindo subagentes filhos). Isto não pode ser desfeito.",
  subagentDeleteRunning: "Em execução — não é possível excluir",
  subagentDeleteUnavailable: "Requer o plugin @michengai/dsh-archive-manager",
