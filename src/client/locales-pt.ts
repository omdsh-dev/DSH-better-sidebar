export const pt: Record<string, string> = {
  enterCodeFocus: 'Tela cheia',
  exitCodeFocus: 'Sair da tela cheia',
  resizeSidebar: 'Redimensione a barra lateral; arraste totalmente para a direita para ocultá-la',
  releaseToHideSidebar: 'Solte para ocultar a barra lateral',
  createFile: 'Novo arquivo',
  createFolder: 'Nova pasta',
  newFileName: 'Nome do arquivo',
  newFolderName: 'Nome da pasta',
  createNameRequired: 'Digite um nome',
  createNameInvalid: 'O nome não pode ser . ou .. nem conter separadores de caminho',
  creating: 'Criando…',
  createDone: '{path} foi criado',
  createFailed: 'Falha ao criar: {error}',
  operationBusy: 'Outra operação de arquivo está em andamento',
  importFiles: 'Importar arquivos',
  importFolder: 'Importar pasta',
  deleteFile: 'Excluir arquivo',
  deleteFileTitle: 'Excluir arquivo',
  deleteFileDesc: 'Excluir permanentemente “{path}”? Esta ação não pode ser desfeita.',
  deleteFolder: 'Excluir pasta',
  deleteFolderTitle: 'Excluir pasta',
  deleteFolderDesc: 'Excluir permanentemente “{path}” e todo o seu conteúdo? Esta ação não pode ser desfeita.',
  deleteSymlink: 'Excluir link simbólico',
  deleteSymlinkTitle: 'Excluir link simbólico',
  deleteSymlinkDesc: 'Excluir o link simbólico “{path}”? O destino não será excluído. Esta ação não pode ser desfeita.',
  deleting: 'Excluindo…',
  deleteDone: '{path} foi excluído',
