export const pt: Record<string, string> = {
  ...
  toc: 'Sumário',
  review: 'Revisão',
  reviewPending: '{count} para revisar',
  reviewNoRepo: 'Não é um repositório Git',
  reviewAccepted: 'Aceito',
  accept: 'Aceitar',
  acceptAll: 'Aceitar tudo',
  reject: 'Rejeitar',
  rejectUntracked: 'Um arquivo novo não tem versão salva para restaurar',
  find: 'Localizar',
  findPrev: 'Ocorrência anterior',
  findNext: 'Próxima ocorrência',
  findClose: 'Fechar a busca',
  findNoResults: 'Nenhum resultado',
  edit: 'Editar',
  ...
  browserLocalBlockedTitle: 'Confiar e abrir {authority}?',
  browserLocalBlockedDesc: 'Este é um serviço local no seu computador. Permita-o apenas se iniciou ou confia nesta aplicação Web. O acesso aplica-se apenas a este endereço e porta.',
  browserTrustAndOpen: 'Confiar e abrir',
  browserTrusting: 'A guardar…',
  browserTrustFailed: 'Não foi possível guardar este endereço local. Verifique o serviço de definições da barra lateral e tente novamente.',
