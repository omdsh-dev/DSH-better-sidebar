export const pt: Record<string, string> = {
  ...
  viewerVideo: 'Vídeo',
  videoUnsupported: 'Este navegador não consegue reproduzir o vídeo — baixe o arquivo e abra em um player local.',
  mediaLoadFailed: 'Não foi possível carregar este arquivo',
  viewerCode: 'Código',
  viewerHtml: 'HTML',
  browser: 'Navegador',
