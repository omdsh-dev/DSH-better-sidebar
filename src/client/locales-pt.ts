export const pt: Record<string, string> = {
  ...
  allowOutsideFiles: 'Permitir abrir arquivos fora do espaço de trabalho',
  allowOutsideFilesDesc: 'Opção somente leitura: a barra lateral pode visualizar arquivos/pastas fora do espaço de trabalho da sessão; editar, salvar e enviar permanecem limitados ao espaço de trabalho.',
  externalReadonly: 'Externo · somente leitura',
