...
export const zhTW: Record<string, string> = {
  ...
  toc: '目錄',
  review: '審查',
  reviewPending: '{count} 項待審查',
  reviewNoRepo: '目前資料夾不是 Git 倉庫',
  reviewAccepted: '已接受',
  accept: '接受',
  acceptAll: '全部接受',
  reject: '拒絕',
  rejectUntracked: '新檔案沒有可回復的提交版本',
  find: '尋找',
  findPrev: '上一個相符項',
  findNext: '下一個相符項',
  findClose: '關閉尋找',
  ...
  browserLocalBlockedTitle: '信任並開啟 {authority}？',
  browserLocalBlockedDesc: '這是你電腦上的本機服務。只在你啟動或信任此 Web 應用程式時允許存取。此權限只授予這個位址和連接埠。',
  browserTrustAndOpen: '信任並開啟',
  browserTrusting: '正在儲存…',
  browserTrustFailed: '無法儲存這個本機位址。請檢查側邊欄設定服務，然後再試一次。',
