...
export const zhTW: Record<string, string> = {
  enterCodeFocus: '全螢幕',
  exitCodeFocus: '退出全螢幕',
  resizeSidebar: '調整側邊欄寬度；拖到最右側即可隱藏',
  releaseToHideSidebar: '放開以隱藏側邊欄',
  createFile: '新增檔案',
  createFolder: '新增資料夾',
  newFileName: '檔案名稱',
  newFolderName: '資料夾名稱',
  createNameRequired: '請輸入名稱',
  createNameInvalid: '名稱不可為 .、.. 或包含路徑分隔符號',
  creating: '正在建立…',
  createDone: '已建立 {path}',
  createFailed: '建立失敗：{error}',
  operationBusy: '另一項檔案操作正在進行',
  importFiles: '匯入檔案',
  importFolder: '匯入資料夾',
  deleteFile: '刪除檔案',
  deleteFileTitle: '刪除檔案',
  deleteFileDesc: '將永久刪除「{path}」。此操作無法復原。',
  deleteFolder: '刪除資料夾',
  deleteFolderTitle: '刪除資料夾',
  deleteFolderDesc: '將永久刪除資料夾「{path}」及其中的所有內容。此操作無法復原。',
  deleteSymlink: '刪除符號連結',
  deleteSymlinkTitle: '刪除符號連結',
  deleteSymlinkDesc: '將刪除符號連結「{path}」，不會刪除其指向的內容。此操作無法復原。',
  deleting: '正在刪除…',
  deleteDone: '已刪除 {path}',
