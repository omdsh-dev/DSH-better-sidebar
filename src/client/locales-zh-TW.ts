...
export const zhTW: Record<string, string> = {
  ...
  fileCommentsPanel: '目前檔案評論',
  fileCommentsCurrent: '目前',
  fileCommentsSend: '傳送所選評論給 Agent',
  fileCommentsSendShort: '發送',
  fileCommentsSendFailed: '評論傳送失敗：{error}',
  fileCommentsEmptyCurrent: '目前檔案沒有未傳送的評論',
  fileCommentsEmptyHistory: '目前檔案沒有已傳送的評論',
  fileCommentsSelectionOmitted: '所選內容過長，傳送時只包含檔案位置',
  fileCommentsEdit: '編輯評論',
  fileCommentsDelete: '刪除評論',
  fileCommentsSelect: '選取評論',
  fileCommentsSelectAll: '全選',
  fileCommentsClearSelection: '取消',
  fileCommentsDeleteSelected: '刪除',
  fileCommentsPlaceholder: '新增針對所選內容的評論…',
