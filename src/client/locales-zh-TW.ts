...
export const zhTW: Record<string, string> = {
  ...
  subagentDelete: "永久刪除",
  subagentDeleteConfirm: "永久刪除",
  subagentDeleteDesc: "將永久刪除子代理「{name}」及其全部記錄（含其子代理），此操作無法復原。",
  subagentDeleteRunning: "執行中，無法刪除",
  subagentDeleteUnavailable: "需要安裝 @michengai/dsh-archive-manager 外掛程式才能刪除",
  sideChat: '側邊對話(beta)',
  sideChatNew: '新增對話',
