...
export const de: Record<string, string> = {
  ...
  guideDescPlan: 'Jeder Plan, den das Modell im Planmodus vorlegt, vollständig und pro Revision archiviert',
  ...
  plan: 'Plan',
  planEmpty: 'Noch keine Pläne in dieser Sitzung',
  planEmptyDesc: 'Pläne, die das Modell im Planmodus vorlegt, erscheinen nach dem Absenden hier',
  planStatusPending: 'Ausstehende Prüfung',
  planStatusApproved: 'Genehmigt',
  planStatusUnadopted: 'Nicht übernommen',
  planCopy: 'Plan kopieren',
  planLoadError: 'Plan konnte nicht geladen werden; erneuter Versuch läuft',
  ...
  settingsPlanTitle: 'Plan-Seite automatisch öffnen, wenn das Modell einen Plan vorlegt',
  settingsPlanDesc: 'Die Plan-Seite öffnen, sobald das Modell für die aktuelle Unterhaltung einen Plan vorlegt (jedes Vorlegen löst dies aus); auf breiten Ansichten wird zusätzlich die Seitenkarte ausgeklappt, auf schmalen Ansichten wird das Öffnen der Vollbild-Schublade nicht erzwungen; ausschalten, um sie manuell zu öffnen',
