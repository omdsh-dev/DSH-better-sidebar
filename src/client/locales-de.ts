...
export const de: Record<string, string> = {
  ...
  viewerVideo: 'Video',
  videoUnsupported: 'Dieser Browser kann das Video nicht abspielen — lade es herunter und öffne es in einem lokalen Player.',
  mediaLoadFailed: 'Diese Datei konnte nicht geladen werden',
  viewerCode: 'Code',
  viewerHtml: 'HTML',
  browser: 'Browser',
