...
export const de: Record<string, string> = {
  ...
  suggestCommitError: 'Generieren der Commit-Nachricht fehlgeschlagen',
  suggestCommitEmpty: 'Keine ausstehenden Änderungen',
  push: 'Pushen',
  pull: 'Pullen',
  pushError: 'Pushen fehlgeschlagen',
  pullError: 'Pullen fehlgeschlagen',
  branch: 'Branch',
  worktree: 'Worktree',
