...
export const de: Record<string, string> = {
  ...
  subagentDelete: "Endgültig löschen",
  subagentDeleteConfirm: "Endgültig löschen",
  subagentDeleteDesc: "Löscht den Subagenten „{name}“ und alle seine Aufzeichnungen (einschließlich seiner Subagenten) endgültig. Dies kann nicht rückgängig gemacht werden.",
  subagentDeleteRunning: "Läuft — Löschen nicht möglich",
  subagentDeleteUnavailable: "Erfordert das Plugin @michengai/dsh-archive-manager",
