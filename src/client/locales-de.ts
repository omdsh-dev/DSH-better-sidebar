...
export const de: Record<string, string> = {
  ...
  editorContentMode: 'Inhaltsansicht',
  ...
  fileCommentsPanel: 'Kommentare zur aktuellen Datei',
  fileCommentsCurrent: 'Aktuell',
  fileCommentsSend: 'Ausgewählte Kommentare an Agent senden',
  fileCommentsSendShort: 'Senden',
  fileCommentsSendFailed: 'Kommentare konnten nicht gesendet werden: {error}',
  fileCommentsEmptyCurrent: 'Keine ungesendeten Kommentare für diese Datei',
  fileCommentsEmptyHistory: 'Keine gesendeten Kommentare für diese Datei',
  fileCommentsSelectionOmitted: 'Die Auswahl ist zu lang; nur die Dateiposition wird gesendet',
  fileCommentsEdit: 'Kommentar bearbeiten',
  fileCommentsDelete: 'Kommentar löschen',
  fileCommentsSelect: 'Kommentar auswählen',
  fileCommentsSelectAll: 'Alle auswählen',
  fileCommentsClearSelection: 'Auswahl aufheben',
  fileCommentsDeleteSelected: 'Löschen',
  fileCommentsPlaceholder: 'Kommentar zur Auswahl hinzufügen…',
