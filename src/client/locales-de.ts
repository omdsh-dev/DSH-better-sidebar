...
export const de: Record<string, string> = {
  enterCodeFocus: 'Vollbild',
  exitCodeFocus: 'Vollbild verlassen',
  resizeSidebar: 'Breite der Seitenleiste ändern; zum Ausblenden ganz nach rechts ziehen',
  releaseToHideSidebar: 'Loslassen, um die Seitenleiste auszublenden',
  createFile: 'Neue Datei',
  createFolder: 'Neuer Ordner',
  newFileName: 'Dateiname',
  newFolderName: 'Ordnername',
  createNameRequired: 'Geben Sie einen Namen ein',
  createNameInvalid: 'Namen dürfen weder . noch .. sein und keine Pfadtrenner enthalten',
  creating: 'Wird erstellt…',
  createDone: '{path} wurde erstellt',
  createFailed: 'Erstellen fehlgeschlagen: {error}',
  operationBusy: 'Ein anderer Dateivorgang wird gerade ausgeführt',
  importFiles: 'Dateien importieren',
  importFolder: 'Ordner importieren',
  deleteFile: 'Datei löschen',
  deleteFileTitle: 'Datei löschen',
  deleteFileDesc: '„{path}“ dauerhaft löschen? Diese Aktion kann nicht rückgängig gemacht werden.',
  deleteFolder: 'Ordner löschen',
  deleteFolderTitle: 'Ordner löschen',
  deleteFolderDesc: '„{path}“ und den gesamten Inhalt dauerhaft löschen? Diese Aktion kann nicht rückgängig gemacht werden.',
  deleteSymlink: 'Symbolischen Link löschen',
  deleteSymlinkTitle: 'Symbolischen Link löschen',
  deleteSymlinkDesc: 'Den symbolischen Link „{path}“ löschen? Sein Ziel wird nicht gelöscht. Diese Aktion kann nicht rückgängig gemacht werden.',
  deleting: 'Wird gelöscht…',
  deleteDone: '{path} wurde gelöscht',
