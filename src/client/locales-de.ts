...
export const de: Record<string, string> = {
  ...
  tasksViewGraph: 'Workflow-Diagramm',
  tasksViewTree: 'Baum',
  tasksViewSwitchToGraph: 'Zum Workflow-Diagramm wechseln',
  tasksViewSwitchToTree: 'Zum Baum wechseln',
  settingsViewModeTitle: 'Standardansicht der Aufgabenseite',
  settingsViewModeDesc: 'Wie die Aufgabenseite beim Öffnen dargestellt wird (der Umschalter auf der Seite ändert es weiterhin ad hoc)',
  settingsViewModeGraph: 'Workflow-Diagramm',
  ...
  tasksFoldExpand: 'Abgeschlossene Knoten ausklappen',
  tasksFoldCollapse: 'Abgeschlossene Knoten einklappen',
  tasksZoomIn: 'Vergrößern',
  ...
  tasksNodeTeamRole: 'Teamrolle',
  tasksNodeActivity: 'Letzte Aktivität',
  tasksStateRunning: 'Läuft',
  tasksStateIdle: 'Bereit',
  tasksStateDone: 'Abgeschlossen',
  tasksStateError: 'Fehler',
  teamBoard: 'Team-Aufgabenboard',
  teamChip: 'Team {members} Mitglieder · {tasks} Aufgaben',
  teamTasksEmpty: 'Noch keine geteilten Aufgaben',
  teamTaskCreate: 'Neue Aufgabe',
  teamTaskSubject: 'Titel',
  teamTaskDescription: 'Beschreibung',
  teamTaskOwner: 'Verantwortlich',
  teamTaskUnowned: 'Nicht übernommen',
  teamTaskPending: 'Offen',
  teamTaskInProgress: 'In Arbeit',
  teamTaskCompleted: 'Abgeschlossen',
  teamTaskBlocked: 'Blockiert',
  teamTaskComplete: 'Abschließen',
  teamTaskReopen: 'Wieder öffnen',
  teamTaskDelete: 'Löschen',
  teamTaskDeleteConfirm: 'Löschen bestätigen',
  teamTaskEdit: 'Bearbeiten',
  teamTaskSave: 'Speichern',
  teamTaskCancel: 'Abbrechen',
  teamTaskConflict: 'Die Aufgabe wurde anderweitig geändert; aktualisiert',
  teamTaskError: 'Vorgang fehlgeschlagen: {message}',
  teamTaskDeleted: 'Gelöscht',
  teamTaskActions: 'Aufgabenaktionen',
  teamTaskDetail: 'Aufgabendetails',
  teamTaskNoDescription: 'Noch keine Beschreibung – über „Bearbeiten“ ergänzen',
  teamTaskBlockedBy: 'Blockiert durch',
  teamTaskSubjectPlaceholder: 'Eine Zeile, die die Arbeit beschreibt',
  teamTaskDescriptionPlaceholder: 'Zusätzliche Details (optional)',
  teamFilterAll: 'Alle',
  tasksNodeTasks: 'Geteilte Aufgaben',
  jobCopyOutput: 'Ausgabe kopieren',
  jobCopied: 'Kopiert',
  jobFollowTail: 'Neuestes verfolgen',
  jobDragHint: 'Zum Verschieben ziehen',
  workflowRunning: 'Läuft',
  workflowCompleted: 'Abgeschlossen',
  workflowCancelled: 'Abgebrochen',
  workflowFailed: 'Fehlgeschlagen',
  workflowPhaseUnnamed: 'Unbenannte Phase',
  workflowMembers: '{done}/{total} Mitglieder',
  jobsAutoCollapsed: 'Automatisch eingeklappt (viele Agenten)',
  catalogLoadFailed: '{count} Branches konnten nicht geladen werden',
