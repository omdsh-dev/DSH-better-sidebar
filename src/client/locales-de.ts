...
export const de: Record<string, string> = {
  ...
  explorerExclude: 'Ausschlussmuster',
  explorerExcludeDesc: 'Entfernt übereinstimmende Einträge vollständig aus dem Dateibaum und der Suche (* und ? Wildcards, ein **/-Anfang trifft in jeder Tiefe); ausgeschlossene Einträge blockieren das Breadcrumb-Falten nie',
  explorerExcludePlaceholder: 'Muster hinzufügen, z. B. node_modules, *.log, **/.git',
  explorerExcludeAdd: 'Hinzufügen',
  explorerExcludeRemove: 'Entfernen',
