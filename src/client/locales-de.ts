...
export const de: Record<string, string> = {
  ...
  findNext: 'Weiter',
  findPrevious: 'Zurück',
  findAll: 'Alle auswählen',
  findMatchCase: 'Groß-/Kleinschreibung',
  findRegexp: 'Regex',
  findByWord: 'Ganzes Wort',
  replaceOne: 'Ersetzen',
  ...
  closeUnsavedConfirm: 'Diese Datei hat ungespeicherte Änderungen. Beim Schließen des Tabs gehen sie verloren. Fortfahren?',
  save: 'Speichern',
  saved: 'Gespeichert',
  unsaved: 'Nicht gespeichert',
  saveFailed: 'Speichern fehlgeschlagen',
  saveConflict: 'Die Datei wurde auf der Platte von anderer Stelle geändert. Speichern abgebrochen; Ihre Änderungen bleiben im Editor.',   saveConflictReload: 'Inhalt von der Platte neu laden',
