...
export const de: Record<string, string> = {
  ...
  pasteImageFailed: 'Bild einfügen fehlgeschlagen',
  ...
  settingsSearchExcludeTitle: 'Von der Suche ausgeschlossene Verzeichnisse',
  settingsSearchExcludeDesc: 'Diese Verzeichnisse bei der Dateinamen-Suche überspringen (kommagetrennt; gleicher Name in jeder Tiefe wird ausgeschlossen)',
  ...
  settingsImageDirTitle: 'Obsidian-Bildverzeichnis',
  settingsImageDirDesc: 'Verzeichnis für ![[x.png]]-Einbettungen und eingefügte Bilder: relativ zum Sitzungsverzeichnis (Standard: images) oder absoluter Pfad',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'Vorschau-Farbthema',
  settingsMdPreviewThemeDesc: 'Gilt nur für die Markdown-Dateivorschau — nicht für Side Chat oder Changes-Lesemodus',
  settingsMdPreviewThemeVivid: 'Lebendig',
  settingsMdPreviewThemeVividDesc: 'Kräftigere Überschriften-, Zitat- und Tabellenakzente über semantische Skin-Tokens',
  settingsMdPreviewThemeHost: 'Host',
  settingsMdPreviewThemeHostDesc: 'Host-MarkdownText-Farben unverändert belassen',
  viewerCode: 'Code',
