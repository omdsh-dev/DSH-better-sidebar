...
export const de: Record<string, string> = {
  ...
  review: 'Prüfen',
  reviewPending: '{count} zu prüfen',
  reviewNoRepo: 'Kein Git-Repository',
  reviewAccepted: 'Angenommen',
  accept: 'Annehmen',
  acceptAll: 'Alle annehmen',
  reject: 'Ablehnen',
  rejectUntracked: 'Eine neue Datei hat keine Commit-Version zum Wiederherstellen',
  find: 'Suchen',
  ...
  browserLocalBlockedTitle: '{authority} vertrauen und öffnen?',
  browserLocalBlockedDesc: 'Dies ist ein lokaler Dienst auf deinem Computer. Erlaube ihn nur, wenn du die Web-App gestartet hast oder ihr vertraust. Der Zugriff gilt nur für diese Adresse und diesen Port.',
  browserTrustAndOpen: 'Vertrauen und öffnen',
  browserTrusting: 'Wird gespeichert…',
  browserTrustFailed: 'Diese lokale Adresse konnte nicht gespeichert werden. Prüfe den Einstellungsdienst der Seitenleiste und versuche es erneut.',
