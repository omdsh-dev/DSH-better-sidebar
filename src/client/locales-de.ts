...
export const de: Record<string, string> = {
  ...
  allowOutsideFiles: 'Öffnen von Dateien außerhalb des Arbeitsbereichs erlauben',
  allowOutsideFilesDesc: 'Nur-Lese-Option: Die Seitenleiste kann Dateien/Ordner außerhalb des Sitzungs-Arbeitsbereichs anzeigen; Bearbeiten, Speichern und Hochladen bleiben auf den Arbeitsbereich beschränkt.',
  externalReadonly: 'Extern · schreibgeschützt',
