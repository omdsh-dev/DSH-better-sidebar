export const sv: Record<string, string> = {
  ...
  tasksViewGraph: 'Arbetsflödesgraf',
  tasksViewTree: 'Träd',
  tasksViewSwitchToGraph: 'Växla till arbetsflödesgrafen',
  tasksViewSwitchToTree: 'Växla till trädet',
  settingsViewModeTitle: 'Standardvy för uppgiftssidan',
  settingsViewModeDesc: 'Hur uppgiftssidan visas vid öppning (växeln på sidan ändrar den fortfarande ad hoc)',
  settingsViewModeGraph: 'Arbetsflödesgraf',
  ...
  tasksFoldExpand: 'Visa färdiga noder',
  tasksFoldCollapse: 'Dölj färdiga noder',
  tasksZoomIn: 'Zooma in',
  ...
  tasksNodeTeamRole: 'Teamroll',
  tasksNodeActivity: 'Senaste aktivitet',
  tasksStateRunning: 'Körs',
  tasksStateIdle: 'Vilar',
  tasksStateDone: 'Klar',
  tasksStateError: 'Fel',
  teamBoard: 'Teamuppgiftstavla',
  teamChip: 'Team {members} medlemmar · {tasks} uppgifter',
  teamTasksEmpty: 'Inga delade uppgifter än',
  teamTaskCreate: 'Ny uppgift',
  teamTaskSubject: 'Ämne',
  teamTaskDescription: 'Beskrivning',
  teamTaskOwner: 'Ansvarig',
  teamTaskUnowned: 'Ej tilldelad',
  teamTaskPending: 'Väntar',
  teamTaskInProgress: 'Pågår',
  teamTaskCompleted: 'Klar',
  teamTaskBlocked: 'Blockerad',
  teamTaskComplete: 'Färdigställ',
  teamTaskReopen: 'Öppna igen',
  teamTaskDelete: 'Ta bort',
  teamTaskDeleteConfirm: 'Bekräfta borttagning',
  teamTaskEdit: 'Redigera',
  teamTaskSave: 'Spara',
  teamTaskCancel: 'Avbryt',
  teamTaskConflict: 'Uppgiften ändrades av någon annan, har uppdaterats',
  teamTaskError: 'Åtgärden misslyckades: {message}',
  teamTaskDeleted: 'Borttagen',
  teamTaskActions: 'Uppgiftsåtgärder',
  teamTaskDetail: 'Uppgiftsdetaljer',
  teamTaskNoDescription: 'Ingen beskrivning än — klicka på “Redigera” för att lägga till en',
  teamTaskBlockedBy: 'Blockerad av',
  teamTaskSubjectPlaceholder: 'Beskriv arbetet på en rad',
  teamTaskDescriptionPlaceholder: 'Ytterligare information (valfritt)',
  teamFilterAll: 'Alla',
  tasksNodeTasks: 'Delade uppgifter',
  jobCopyOutput: 'Kopiera utdata',
  jobCopied: 'Kopierades',
  jobFollowTail: 'Följ senaste',
  jobDragHint: 'Dra för att flytta',
  workflowRunning: 'Körs',
  workflowCompleted: 'Slutförd',
  workflowCancelled: 'Avbruten',
  workflowFailed: 'Misslyckad',
  workflowPhaseUnnamed: 'Namnlös fas',
  workflowMembers: '{done}/{total} medlemmar',
  jobsAutoCollapsed: 'Auto-dold (många agenter)',
  catalogLoadFailed: '{count} grenar kunde inte läsas in',
