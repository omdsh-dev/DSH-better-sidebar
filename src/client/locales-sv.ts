export const sv: Record<string, string> = {
  ...
  explorerExclude: 'Undantagsmönster',
  explorerExcludeDesc: 'Tar bort matchande poster helt från filträdet och sökningen (stöder * och ?, ett **/-prefix matchar alla djup); undantagna poster blockerar aldrig brödsmulefällningen',
  explorerExcludePlaceholder: 'Lägg till mönster, t.ex. node_modules, *.log, **/.git',
  explorerExcludeAdd: 'Lägg till',
  explorerExcludeRemove: 'Ta bort',
