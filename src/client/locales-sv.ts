export const sv: Record<string, string> = {
  enterCodeFocus: 'Helskärm',
  exitCodeFocus: 'Avsluta helskärm',
  resizeSidebar: 'Ändra sidofältets bredd; dra hela vägen åt höger för att dölja',
  releaseToHideSidebar: 'Släpp för att dölja sidofältet',
  createFile: 'Ny fil',
  createFolder: 'Ny mapp',
  newFileName: 'Filnamn',
  newFolderName: 'Mappnamn',
  createNameRequired: 'Ange ett namn',
  createNameInvalid: 'Namnet får inte vara . eller .. och får inte innehålla sökvägsavgränsare',
  creating: 'Skapar…',
  createDone: '{path} skapades',
  createFailed: 'Kunde inte skapa: {error}',
  operationBusy: 'En annan filåtgärd pågår',
  importFiles: 'Importera filer',
  importFolder: 'Importera mapp',
  deleteFile: 'Ta bort fil',
  deleteFileTitle: 'Ta bort fil',
  deleteFileDesc: 'Ta bort “{path}” permanent? Åtgärden kan inte ångras.',
  deleteFolder: 'Ta bort mapp',
  deleteFolderTitle: 'Ta bort mapp',
  deleteFolderDesc: 'Ta bort “{path}” och allt innehåll permanent? Åtgärden kan inte ångras.',
  deleteSymlink: 'Ta bort symbolisk länk',
  deleteSymlinkTitle: 'Ta bort symbolisk länk',
  deleteSymlinkDesc: 'Ta bort den symboliska länken “{path}”? Målet tas inte bort. Åtgärden kan inte ångras.',
  deleting: 'Tar bort…',
  deleteDone: '{path} togs bort',
