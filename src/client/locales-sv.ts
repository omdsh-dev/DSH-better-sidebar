export const sv: Record<string, string> = {
  ...
  searchFind: 'Sök',
  searchReplace: 'Ersätt',
  searchNext: 'Nästa',
  searchPrevious: 'Föregående',
  searchAll: 'Markera alla',
  searchMatchCase: 'Matcha skiftläge',
  searchWholeWord: 'Hela ordet',
  searchRegexp: 'Regexp',
  searchReplaceAll: 'Ersätt alla',
  searchCurrentMatch: 'Aktuell träff',
  searchOnLine: 'på rad',
  searchReplacedMatches: '$ träffar ersatta',
  searchReplacedMatchOnLine: 'träff på rad $ ersatt',
  searchGoToLine: 'Gå till rad',
  searchGo: 'Gå',
