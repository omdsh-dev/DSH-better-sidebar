export const sv: Record<string, string> = {
  ...
  review: 'Granska',
  reviewPending: '{count} att granska',
  reviewNoRepo: 'Inte ett Git-arkiv',
  reviewAccepted: 'Godkänd',
  accept: 'Godkänn',
  acceptAll: 'Godkänn alla',
  reject: 'Avvisa',
  rejectUntracked: 'En ny fil har ingen incheckad version att återställa',
  find: 'Sök',
  findPrev: 'Föregående träff',
  findNext: 'Nästa träff',
  findClose: 'Stäng sökning',
  findNoResults: 'Inga resultat',
  edit: 'Redigera',
  ...
  browserLocalBlockedTitle: 'Lita på och öppna {authority}?',
  browserLocalBlockedDesc: 'Det här är en lokal tjänst på datorn. Tillåt den bara om du startade eller litar på webbappen. Åtkomsten gäller bara den här adressen och porten.',
  browserTrustAndOpen: 'Lita på och öppna',
  browserTrusting: 'Sparar…',
  browserTrustFailed: 'Det gick inte att spara den lokala adressen. Kontrollera sidopanelens inställningstjänst och försök igen.',
