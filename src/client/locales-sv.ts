export const sv: Record<string, string> = {
  ...
  allowOutsideFiles: 'Tillåt att filer utanför arbetsytan öppnas',
  allowOutsideFilesDesc: 'Skrivskyddat alternativ: sidofältet kan visa filer/mappar utanför sessionens arbetsyta; redigering, sparande och uppladdning är fortfarande begränsade till arbetsytan.',
  externalReadonly: 'Extern · skrivskyddad',
