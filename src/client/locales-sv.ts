export const sv: Record<string, string> = {
  ...
  replace: 'Ersätt',
  findNext: 'Nästa',
  findPrevious: 'Föregående',
  findAll: 'Markera alla',
  findMatchCase: 'Matcha skiftläge',
  findRegexp: 'Regex',
  findByWord: 'Helord',
  replaceOne: 'Ersätt',
  ...
  closeUnsavedConfirm: 'Filen har osparade ändringar. Att stänga fliken kastar dem. Fortsätta?',
  save: 'Spara',
  saved: 'Sparad',
  unsaved: 'Osparad',
  saveFailed: 'Kunde inte spara',
  saveConflict: 'Filen ändrades på disken av någon annan. Sparandet avbröts; dina ändringar finns kvar i redigeraren.',   saveConflictReload: 'Ladda om från disken',
