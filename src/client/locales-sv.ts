export const sv: Record<string, string> = {
  ...
  guideDescPlan: 'Alla planer som modellen presenterat i planläge, bevarade per version',
  ...
  plan: 'Plan',
  planEmpty: 'Inga planer i den här sessionen ännu',
  planEmptyDesc: 'Be modellen ta fram en plan i planläge — den visas här',
  planStatusPending: 'Väntar på granskning',
  planStatusApproved: 'Godkänd',
  planStatusUnadopted: 'Ej antagen',
  planCopy: 'Kopiera plan',
  planLoadError: 'Kunde inte ladda planen; försöker igen',
  ...
  settingsPlanTitle: 'Aktivera sidan Plan automatiskt när modellen presenterar en plan',
  settingsPlanDesc: 'När modellen presenterar en plan för den aktuella konversationen aktiveras sidan Plan automatiskt; på breda skärmar expanderas även sidokortet, medan helskärmspanelen inte tvingas öppnas på smala skärmar; stäng av för att välja sidan manuellt',
