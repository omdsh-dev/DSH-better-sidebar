export const sv: Record<string, string> = {
  ...
  viewerVideo: 'Video',
  videoUnsupported: 'Den här webbläsaren kan inte spela upp videon — ladda ner den och öppna den i en lokal spelare.',
  mediaLoadFailed: 'Filen kunde inte läsas in',
  viewerCode: 'Kod',
  viewerHtml: 'HTML',
  browser: 'Webbläsare',
