export const sv: Record<string, string> = {
  ...
  pasteImageFailed: 'Kunde inte klistra in bild',
  ...
  settingsSearchExcludeTitle: 'Kataloger undantagna från sökning',
  settingsSearchExcludeDesc: 'Hoppa över dessa kataloger vid filnamnssökning (kommaseparerade; samma namn på vilket djup som helst undantas)',
  ...
  settingsImageDirTitle: 'Obsidian-bildkatalog',
  settingsImageDirDesc: 'Katalog för ![[x.png]]-inbäddningar och inklistrade bilder: relativt sessions-cwd (standard images) eller absolut sökväg',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'Förhandsvisningens färgtema',
  settingsMdPreviewThemeDesc: 'Gäller endast Markdown-filförhandsvisning — inte Side Chat eller Changes-läsläge',
  settingsMdPreviewThemeVivid: 'Livfull',
  settingsMdPreviewThemeVividDesc: 'Rikare rubrik-, citat- och tabellaccenter via semantiska skin-tokens',
  settingsMdPreviewThemeHost: 'Värd',
  settingsMdPreviewThemeHostDesc: 'Behåll värdens MarkdownText-färger som de är',
  viewerCode: 'Kod',
