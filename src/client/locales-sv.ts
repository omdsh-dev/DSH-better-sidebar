export const sv: Record<string, string> = {
  ...
  generateCommitMessage: 'Generera commit-meddelande',
  generatingCommitMessage: 'Genererar commit-meddelande…',
  suggestCommitError: 'Kunde inte generera commit-meddelande',
  suggestCommitEmpty: 'Inga väntande ändringar',
  push: 'Skicka',
  pull: 'Hämta',
  pushError: 'Kunde inte skicka',
  pullError: 'Kunde inte hämta',
  branch: 'Gren',
  worktree: 'Arbetsträd',
