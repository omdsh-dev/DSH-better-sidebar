export const sv: Record<string, string> = {
  ...
  subagentDelete: "Ta bort permanent",
  subagentDeleteConfirm: "Ta bort permanent",
  subagentDeleteDesc: "Tar permanent bort subagenten \"{name}\" och alla dess poster (inklusive underordnade subagenter). Detta kan inte ångras.",
  subagentDeleteRunning: "Körs — kan inte tas bort",
  subagentDeleteUnavailable: "Kräver plugin @michengai/dsh-archive-manager",
