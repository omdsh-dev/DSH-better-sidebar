export const sv: Record<string, string> = {
  ...
  fileCommentsPanel: 'Kommentarer för aktuell fil',
  fileCommentsCurrent: 'Aktuella',
  fileCommentsSend: 'Skicka valda kommentarer till Agent',
  fileCommentsSendShort: 'Skicka',
  fileCommentsSendFailed: 'Det gick inte att skicka kommentarer: {error}',
  fileCommentsEmptyCurrent: 'Inga oskickade kommentarer för den här filen',
  fileCommentsEmptyHistory: 'Inga skickade kommentarer för den här filen',
  fileCommentsSelectionOmitted: 'Markeringen är för lång; endast filens plats skickas',
  fileCommentsEdit: 'Redigera kommentar',
  fileCommentsDelete: 'Ta bort kommentar',
  fileCommentsSelect: 'Välj kommentar',
  fileCommentsSelectAll: 'Välj alla',
  fileCommentsClearSelection: 'Avbryt',
  fileCommentsDeleteSelected: 'Ta bort',
  fileCommentsPlaceholder: 'Lägg till en kommentar om markeringen…',
