...
export const tr: Record<string, string> = {
  ...
  toc: 'İçindekiler',
  review: 'İnceleme',
  reviewPending: '{count} inceleme bekliyor',
  reviewNoRepo: 'Git deposu değil',
  reviewAccepted: 'Kabul edildi',
  accept: 'Kabul et',
  acceptAll: 'Tümünü kabul et',
  reject: 'Reddet',
  rejectUntracked: 'Yeni dosyanın geri yüklenecek bir işlenmiş sürümü yok',
  find: 'Bul',
  ...
  browserLocalBlockedTitle: '{authority} adresine güvenip açılsın mı?',
  browserLocalBlockedDesc: 'Bu, bilgisayarınızdaki yerel bir hizmettir. Yalnızca web uygulamasını siz başlattıysanız veya uygulamaya güveniyorsanız izin verin. Erişim yalnızca bu adres ve bağlantı noktası için geçerlidir.',
  browserTrustAndOpen: 'Güven ve aç',
  browserTrusting: 'Kaydediliyor…',
  browserTrustFailed: 'Bu yerel adres kaydedilemedi. Kenar çubuğu ayar hizmetini kontrol edip tekrar deneyin.',
