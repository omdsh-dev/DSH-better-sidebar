...
export const tr: Record<string, string> = {
  ...
  editorContentMode: 'İçerik görünüm modu',
  ...
  fileCommentsPanel: 'Geçerli dosya yorumları',
  fileCommentsCurrent: 'Geçerli',
  fileCommentsSend: 'Seçili yorumları Agent’a gönder',
  fileCommentsSendShort: 'Gönder',
  fileCommentsSendFailed: 'Yorumlar gönderilemedi: {error}',
  fileCommentsEmptyCurrent: 'Bu dosya için gönderilmemiş yorum yok',
  fileCommentsEmptyHistory: 'Bu dosya için gönderilmiş yorum yok',
  fileCommentsSelectionOmitted: 'Seçim çok uzun; yalnızca dosya konumu gönderilecek',
  fileCommentsEdit: 'Yorumu düzenle',
  fileCommentsDelete: 'Yorumu sil',
  fileCommentsSelect: 'Yorumu seç',
  fileCommentsSelectAll: 'Tümünü seç',
  fileCommentsClearSelection: 'İptal',
  fileCommentsDeleteSelected: 'Sil',
  fileCommentsPlaceholder: 'Seçim hakkında yorum ekle…',
