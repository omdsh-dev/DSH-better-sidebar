...
export const tr: Record<string, string> = {
  ...
  pluginVideoPreviewDesc: 'better-sidebar düzenleyicisinde satır içi video önizlemesi (.mp4/.webm/.mov/.mkv/.avi vb.); HTTP Range (206) destekli özel /video sunucu rotasıyla — ilerleme çubuğu sürükleme çalışır ve 64MB mediaLimit ile sınırlanmaz',
