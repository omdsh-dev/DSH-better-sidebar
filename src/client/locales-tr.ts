...
export const tr: Record<string, string> = {
  ...
  pasteImageFailed: 'Görsel yapıştırılamadı',
  ...
  settingsSearchExcludeTitle: 'Aramadan hariç tutulan dizinler',
  settingsSearchExcludeDesc: 'Dosya adı aramasında bu dizinleri atla (virgülle ayrılmış; her derinlikte aynı ad hariç tutulur)',
  ...
  settingsImageDirTitle: 'Obsidian görsel dizini',
  settingsImageDirDesc: '![[x.png]] gömmeleri ve yapıştırılan görsellerin dizini: oturum cwd değerine göre (varsayılan images) veya mutlak yol',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'Önizleme renk teması',
  settingsMdPreviewThemeDesc: 'Yalnızca Markdown dosya önizlemesine uygulanır — Side Chat veya Changes okuma moduna değil',
  settingsMdPreviewThemeVivid: 'Canlı',
  settingsMdPreviewThemeVividDesc: 'Anlamsal skin tokenlarıyla daha zengin başlık, alıntı ve tablo vurguları',
  settingsMdPreviewThemeHost: 'Ana makine',
  settingsMdPreviewThemeHostDesc: 'Ana makinenin MarkdownText renklerini olduğu gibi tut',
  viewerCode: 'Kod',
