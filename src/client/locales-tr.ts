...
export const tr: Record<string, string> = {
  ...
  generatingCommitMessage: 'Commit mesajı oluşturuluyor…',
  suggestCommitError: 'Commit mesajı oluşturulamadı',
  suggestCommitEmpty: 'Bekleyen değişiklik yok',
  push: 'İt',
  pull: 'Çek',
  pushError: 'İtme başarısız',
  pullError: 'Çekme başarısız',
  branch: 'Dal',
