...
export const tr: Record<string, string> = {
  ...
  guideDescPlan: 'Modelin plan modunda sunduğu tüm planlar, sürüm bazında saklanır',
  ...
  plan: 'Plan',
  planEmpty: 'Bu oturumda henüz plan yok',
  planEmptyDesc: 'Plan modunda modelden bir plan isteyin, sunulduğunda burada görünür',
  planStatusPending: 'İnceleme bekliyor',
  planStatusApproved: 'Onaylandı',
  planStatusUnadopted: 'Benimsenmedi',
  planCopy: 'Planı kopyala',
  planLoadError: 'Plan yüklenemedi; yeniden deniyor',
  ...
  settingsPlanTitle: 'Model bir plan sunduğunda Plan sayfasını otomatik etkinleştir',
  settingsPlanDesc: 'Geçerli sohbette model bir plan sunduğunda Plan sayfasını otomatik etkinleştir; geniş ekranlarda yan kart da genişletilir, dar ekranlarda tam ekran çekmecesi zorla açılmaz; kapalıyken elle açılması gerekir',
