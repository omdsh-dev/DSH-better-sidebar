...
export const tr: Record<string, string> = {
  ...
  allowOutsideFiles: 'Çalışma alanı dışındaki dosyaların açılmasına izin ver',
  allowOutsideFilesDesc: 'Salt okunur seçenek: kenar çubuğu oturum çalışma alanı dışındaki dosya/klasörleri görüntüleyebilir; düzenleme, kaydetme ve yükleme çalışma alanıyla sınırlı kalır.',
  externalReadonly: 'Harici · salt okunur',
