...
export const tr: Record<string, string> = {
  ...
  subagentDelete: "Kalıcı olarak sil",
  subagentDeleteConfirm: "Kalıcı olarak sil",
  subagentDeleteDesc: "\"{name}\" alt ajanını ve tüm kayıtlarını (alt ajanları dahil) kalıcı olarak siler. Bu işlem geri alınamaz.",
  subagentDeleteRunning: "Çalışıyor — silinemez",
  subagentDeleteUnavailable: "@michengai/dsh-archive-manager eklentisi gerekli",
