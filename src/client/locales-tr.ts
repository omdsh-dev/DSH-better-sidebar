...
export const tr: Record<string, string> = {
  ...
  findPrevious: 'Önceki',
  findAll: 'Tümünü seç',
  findMatchCase: 'Büyük/küçük harf',
  findRegexp: 'Regex',
  findByWord: 'Tam sözcük',
  replaceOne: 'Değiştir',
  ...
  closeUnsavedConfirm: 'Bu dosyada kaydedilmemiş değişiklikler var. Sekmeyi kapatmak bunları atacak. Devam edilsin mi?',
  save: 'Kaydet',
  saved: 'Kaydedildi',
  unsaved: 'Kaydedilmedi',
  saveFailed: 'Kaydetme başarısız',
  saveConflict: 'Dosya diskte başka bir kaynak tarafından değiştirildi. Kaydetme durduruldu; düzenlemeleriniz düzenleyicide kaldı.',   saveConflictReload: 'Diskten yeniden yükle',
