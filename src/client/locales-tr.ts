...
export const tr: Record<string, string> = {
  ...
  explorer: 'Gezgin',
  terminal: 'Terminal',
  restartHost: 'DSH Web’i yeniden başlat',
  restartHostStarting: 'DSH Web yeniden başlatılıyor…',
  restartHostFailed: 'Yeniden başlatma başarısız — tekrar denemek için tıklayın',
  editor: 'Düzenleyici',
