...
export const tr: Record<string, string> = {
  enterCodeFocus: 'Tam ekran',
  exitCodeFocus: 'Tam ekrandan çık',
  resizeSidebar: 'Kenar çubuğunun genişliğini değiştirin; gizlemek için en sağa sürükleyin',
  releaseToHideSidebar: 'Kenar çubuğunu gizlemek için bırakın',
  createFile: 'Yeni dosya',
  createFolder: 'Yeni klasör',
  newFileName: 'Dosya adı',
  newFolderName: 'Klasör adı',
  createNameRequired: 'Bir ad girin',
  createNameInvalid: 'Ad . veya .. olamaz ve yol ayırıcıları içeremez',
  creating: 'Oluşturuluyor…',
  createDone: '{path} oluşturuldu',
  createFailed: 'Oluşturma başarısız: {error}',
  operationBusy: 'Başka bir dosya işlemi devam ediyor',
  importFiles: 'Dosyaları içe aktar',
  importFolder: 'Klasörü içe aktar',
  deleteFile: 'Dosyayı sil',
  deleteFileTitle: 'Dosyayı sil',
  deleteFileDesc: '“{path}” kalıcı olarak silinsin mi? Bu işlem geri alınamaz.',
  deleteFolder: 'Klasörü sil',
  deleteFolderTitle: 'Klasörü sil',
  deleteFolderDesc: '“{path}” ve içindeki her şey kalıcı olarak silinsin mi? Bu işlem geri alınamaz.',
  deleteSymlink: 'Sembolik bağlantıyı sil',
  deleteSymlinkTitle: 'Sembolik bağlantıyı sil',
  deleteSymlinkDesc: '“{path}” sembolik bağlantısı silinsin mi? Hedefi silinmeyecektir. Bu işlem geri alınamaz.',
  deleting: 'Siliniyor…',
  deleteDone: '{path} silindi',
