...
export const tr: Record<string, string> = {
  ...
  searchFind: 'Bul',
  searchReplace: 'Değiştir',
  searchNext: 'Sonraki',
  searchPrevious: 'Önceki',
  searchAll: 'Tümünü seç',
  searchMatchCase: 'Büyük/küçük harf eşleştir',
  searchWholeWord: 'Tam sözcük',
  searchRegexp: 'Regexp',
  searchReplaceAll: 'Tümünü değiştir',
  searchCurrentMatch: 'Geçerli eşleşme',
  searchOnLine: 'satırda',
  searchReplacedMatches: '$ eşleşme değiştirildi',
  searchReplacedMatchOnLine: '$ satırındaki eşleşme değiştirildi',
  searchGoToLine: 'Satıra git',
  searchGo: 'Git',
