...
export const tr: Record<string, string> = {
  ...
  codeBlockTitle: 'Kod bloğu',
  codeBlockWrap: 'Satırları kaydır',
  ...
  tasksViewGraph: 'İş akışı grafiği',
  tasksViewTree: 'Ağaç',
  tasksViewSwitchToGraph: 'İş akışı grafiğine geç',
  tasksViewSwitchToTree: 'Ağaç görünümüne geç',
  settingsViewModeTitle: 'Görevler sayfası varsayılan görünümü',
  settingsViewModeDesc: 'Görevler sayfasının açılıştaki görünümü (sayfa içi düğme yine anlık değiştirebilir)',
  settingsViewModeGraph: 'İş akışı grafiği',
  ...
  tasksFoldExpand: 'Tamamlanan düğümleri genişlet',
  tasksFoldCollapse: 'Tamamlanan düğümleri daralt',
  tasksZoomIn: 'Yakınlaştır',
  ...
  tasksNodeTeamRole: 'Takım rolü',
  tasksNodeActivity: 'Son etkinlik',
  tasksStateRunning: 'Çalışıyor',
  tasksStateIdle: 'Beklemede',
  tasksStateDone: 'Tamamlandı',
  tasksStateError: 'Hata',
  teamBoard: 'Takım görev panosu',
  teamChip: 'Takım {members} üye · {tasks} görev',
  teamTasksEmpty: 'Henüz paylaşılan görev yok',
  teamTaskCreate: 'Yeni görev',
  teamTaskSubject: 'Konu',
  teamTaskDescription: 'Açıklama',
  teamTaskOwner: 'Sahip',
  teamTaskUnowned: 'Sahipsiz',
  teamTaskPending: 'Bekliyor',
  teamTaskInProgress: 'Devam ediyor',
  teamTaskCompleted: 'Tamamlandı',
  teamTaskBlocked: 'Engelli',
  teamTaskComplete: 'Tamamla',
  teamTaskReopen: 'Yeniden aç',
  teamTaskDelete: 'Sil',
  teamTaskDeleteConfirm: 'Silmeyi onayla',
  teamTaskEdit: 'Düzenle',
  teamTaskSave: 'Kaydet',
  teamTaskCancel: 'İptal',
  teamTaskConflict: 'Görev başkası tarafından değiştirildi, güncellendi',
  teamTaskError: 'İşlem başarısız: {message}',
  teamTaskDeleted: 'Silindi',
  teamTaskActions: 'Görev eylemleri',
  teamTaskDetail: 'Görev ayrıntısı',
  teamTaskNoDescription: 'Henüz açıklama yok — eklemek için Düzenle adımına tıklayın',
  teamTaskBlockedBy: 'Engellendiği görevler',
  teamTaskSubjectPlaceholder: 'İşi tek satırda açıkla',
  teamTaskDescriptionPlaceholder: 'Ek ayrıntılar (isteğe bağlı)',
  teamFilterAll: 'Tümü',
  tasksNodeTasks: 'Paylaşılan görevler',
  jobCopyOutput: 'Çıkışı kopyala',
  jobCopied: 'Kopyalandı',
  jobFollowTail: 'En sona kaydır',
  jobDragHint: 'Taşımak için sürükle',
  workflowRunning: 'Çalışıyor',
  workflowCompleted: 'Tamamlandı',
  workflowCancelled: 'İptal edildi',
  workflowFailed: 'Başarısız',
  workflowPhaseUnnamed: 'Adsız aşama',
  workflowMembers: '{done}/{total} üye',
  jobsAutoCollapsed: 'Otomatik daraltıldı (çok sayıda ajan)',
  catalogLoadFailed: '{count} dal yüklenemedi',
