...
export const tr: Record<string, string> = {
  ...
  explorerExclude: 'Hariç tutma desenleri',
  explorerExcludeDesc: 'Eşleşen girdileri dosya ağacından ve aramadan tamamen kaldırır (* ve ? destekler, **/ öneki her derinlikte eşleşir); hariç tutulan girdiler breadcrumb katlamasını asla engellemez',
  explorerExcludePlaceholder: 'Desen ekleyin, örn. node_modules, *.log, **/.git',
  explorerExcludeAdd: 'Ekle',
  explorerExcludeRemove: 'Kaldır',
