...
export const ar: Record<string, string> = {
  ...
  allowOutsideFiles: 'السماح بفتح الملفات خارج مساحة العمل',
  allowOutsideFilesDesc: 'خيار للقراءة فقط: يمكن للشريط الجانبي عرض الملفات/المجلدات خارج مساحة عمل الجلسة؛ يبقى التحرير والحفظ والرفع داخل مساحة العمل فقط',
  externalReadonly: 'خارجي · للقراءة فقط',
