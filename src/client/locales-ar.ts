...
export const ar: Record<string, string> = {
  ...
  pluginIdeGitDesc: 'علامة تبويب Git في better-sidebar: شجرة الفروع (شارات ahead/behind، علامة worktree)، رسم بياني للالتزامات مع مرشّحات النص/الفرع/المؤلف/التاريخ/المسار، فروق سطرية لكل ملف، قائمة التغييرات وصندوق الالتزام، مع الدمج وإعادة الأساس وcherry-pick وإعادة الضبط والتخزين والوسوم؛ الإجراءات المدمِّرة تطلب تأكيدًا ويمكن التراجع عن الحذف والتخلّص من التغييرات. بدون better-sidebar تُسجَّل في الشريط الجانبي الأيمن الأصلي لـ DSH، لذا تعمل بمفردها',
  ...
  pluginIdeGitName: 'dsh-ide-git نافذة Git',
