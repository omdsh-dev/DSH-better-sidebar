...
export const ar: Record<string, string> = {
  ...
  guideDescSubagent: 'مخطط سير العمل، لوحة مهام الفريق، والمهام الخلفية مباشرةً',
  ...
  tasksViewGraph: 'مخطط سير العمل',
  tasksViewTree: 'شجرة',
  tasksViewSwitchToGraph: 'التبديل إلى مخطط سير العمل',
  tasksViewSwitchToTree: 'التبديل إلى الشجرة',
  settingsViewModeTitle: 'العرض الافتراضي لصفحة المهام',
  settingsViewModeDesc: 'كيف تُعرض صفحة المهام عند الفتح (زر التبديل داخل الصفحة يظل يبدّلها مؤقتًا)',
  settingsViewModeGraph: 'مخطط سير العمل',
  ...
  tasksFoldExpand: 'توسيع العُقد المكتملة',
  tasksFoldCollapse: 'طي العُقد المكتملة',
  tasksZoomIn: 'تكبير',
  tasksZoomOut: 'تصغير',
  ...
  tasksNodeTeamRole: 'دور الفريق',
  tasksNodeActivity: 'آخر نشاط',
  tasksStateRunning: 'قيد التشغيل',
  tasksStateIdle: 'خامل',
  tasksStateDone: 'مكتمل',
  tasksStateError: 'خطأ',
  teamBoard: 'لوحة مهام الفريق',
  teamChip: 'فريق {members} أعضاء · {tasks} مهام',
  teamTasksEmpty: 'لا مهام مشتركة بعد',
  teamTaskCreate: 'مهمة جديدة',
  teamTaskSubject: 'الموضوع',
  teamTaskDescription: 'الوصف',
  teamTaskOwner: 'المسؤول',
  teamTaskUnowned: 'غير مُسندة',
  teamTaskPending: 'معلّقة',
  teamTaskInProgress: 'قيد التنفيذ',
  teamTaskCompleted: 'مكتملة',
  teamTaskBlocked: 'محجوبة',
  teamTaskComplete: 'إكمال',
  teamTaskReopen: 'إعادة فتح',
  teamTaskDelete: 'حذف',
  teamTaskDeleteConfirm: 'تأكيد الحذف',
  teamTaskEdit: 'تحرير',
  teamTaskSave: 'حفظ',
  teamTaskCancel: 'إلغاء',
  teamTaskConflict: 'تم تعديل المهمة من جهة أخرى، تم التحديث',
  teamTaskError: 'فشلت العملية: {message}',
  teamTaskDeleted: 'محذوفة',
  teamTaskActions: 'إجراءات المهمة',
  teamTaskDetail: 'تفاصيل المهمة',
  teamTaskNoDescription: 'لا يوجد وصف بعد — انقر على «تحرير» لإضافة واحد',
  teamTaskBlockedBy: 'محجوبة بسبب',
  teamTaskSubjectPlaceholder: 'سطر واحد يصف العمل',
  teamTaskDescriptionPlaceholder: 'تفاصيل إضافية (اختياري)',
  teamFilterAll: 'الكل',
  tasksNodeTasks: 'المهام المشتركة',
  jobCopyOutput: 'نسخ الإخراج',
  jobCopied: 'تم النسخ',
  jobFollowTail: 'متابعة الأحدث',
  jobDragHint: 'اسحب للتحريك',
  workflowRunning: 'قيد التشغيل',
  workflowCompleted: 'مكتمل',
  workflowCancelled: 'أُلغي',
  workflowFailed: 'فشل',
  workflowPhaseUnnamed: 'مرحلة بدون اسم',
  workflowMembers: '{done}/{total} أعضاء',
  jobsAutoCollapsed: 'تم الطي تلقائيًا (وكلاء كثيرون)',
  catalogLoadFailed: 'فشل تحميل {count} من الفروع',
