...
export const ar: Record<string, string> = {
  ...
  generateCommitMessage: 'إنشاء رسالة التثبيت',
  generatingCommitMessage: 'جارٍ إنشاء رسالة التثبيت…',
  suggestCommitError: 'فشل إنشاء رسالة التثبيت',
  suggestCommitEmpty: 'لا توجد تغييرات معلقة',
  branch: 'الفرع',
  worktree: 'شجرة العمل',
