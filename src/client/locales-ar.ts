...
export const ar: Record<string, string> = {
  ...
  pasteImageFailed: 'فشل لصق الصورة',
  ...
  settingsSearchExcludeTitle: 'المجلدات المستبعدة من البحث',
  settingsSearchExcludeDesc: 'تخطي هذه المجلدات أثناء البحث باسم الملف (مفصولة بفواصل؛ يُستبعد الاسم نفسه بأي عمق)',
  ...
  settingsImageDirTitle: 'دليل صور Obsidian',
  settingsImageDirDesc: 'دليل تضمينات ![[x.png]] والصور الملصقة: نسبي لـ cwd الجلسة (الافتراضي images) أو مسار مطلق',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'سمة ألوان المعاينة',
  settingsMdPreviewThemeDesc: 'تُطبَّق فقط على معاينة ملفات Markdown — وليس Side Chat أو وضع قراءة Changes',
  settingsMdPreviewThemeVivid: 'حيوي',
  settingsMdPreviewThemeVividDesc: 'عناوين واقتباسات وجداول أوضح عبر رموز الجلد الدلالية',
  settingsMdPreviewThemeHost: 'المضيف',
  settingsMdPreviewThemeHostDesc: 'الإبقاء على ألوان MarkdownText للمضيف كما هي',
  viewerCode: 'كود',
