...
export const ar: Record<string, string> = {
  ...
  guideDescPlan: 'النص الكامل لكل خطة يقدمها النموذج في وضع التخطيط، محفوظ لكل إصدار',
  ...
  plan: 'الخطة',
  planEmpty: 'لا توجد خطط في هذه الجلسة بعد',
  planEmptyDesc: 'الخطط التي يقدمها النموذج في وضع التخطيط ستظهر هنا',
  planStatusPending: 'بانتظار المراجعة',
  planStatusApproved: 'تمت الموافقة',
  planStatusUnadopted: 'لم يُعتمد',
  planCopy: 'نسخ الخطة كاملةً',
  planLoadError: 'تعذّر تحميل الخطة، ستُعاد المحاولة لاحقاً',
  ...
  settingsPlanTitle: 'فتح صفحة الخطة تلقائياً عند تقديم النموذج خطة',
  settingsPlanDesc: 'تُفتَح صفحة الخطة في الشريط الجانبي عند تقديم النموذج خطة في المحادثة الحالية (كل خطة مقدَّمة تُطلق الفتح)؛ في الشاشات العريضة تُوسَّع البطاقة الجانبية أيضاً، أما في الشاشات الضيقة فلا يُفرض فتح الدرج بملء الشاشة؛ عند إيقاف الخيار يصبح الفتح يدوياً',
