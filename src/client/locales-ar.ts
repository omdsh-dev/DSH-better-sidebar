...
export const ar: Record<string, string> = {
  ...
  explorerExclude: 'أنماط الاستثناء',
  explorerExcludeDesc: 'يزيل الإدخالات المطابقة تمامًا من شجرة الملفات والبحث (يدعم * و ?، و**/ في البداية يطابق أي عمق)؛ الإدخالات المستثناة لا تعيق طي مسار التنقل أبدًا',
  explorerExcludePlaceholder: 'أضف نمطًا، مثل node_modules أو *.log أو **/.git',
  explorerExcludeAdd: 'إضافة',
  explorerExcludeRemove: 'إزالة',
