...
export const ar: Record<string, string> = {
  ...
  editorContentMode: 'وضع عرض المحتوى',
  ...
  fileCommentsPanel: 'تعليقات الملف الحالي',
  fileCommentsCurrent: 'الحالية',
  fileCommentsSend: 'إرسال التعليقات المحددة إلى Agent',
  fileCommentsSendShort: 'إرسال',
  fileCommentsSendFailed: 'فشل إرسال التعليقات: {error}',
  fileCommentsEmptyCurrent: 'لا توجد تعليقات غير مرسلة لهذا الملف',
  fileCommentsEmptyHistory: 'لا توجد تعليقات مرسلة لهذا الملف',
  fileCommentsSelectionOmitted: 'التحديد طويل جدًا؛ سيُرسل موقع الملف فقط',
  fileCommentsEdit: 'تعديل التعليق',
  fileCommentsDelete: 'حذف التعليق',
  fileCommentsSelect: 'تحديد التعليق',
  fileCommentsSelectAll: 'تحديد الكل',
  fileCommentsClearSelection: 'إلغاء',
  fileCommentsDeleteSelected: 'حذف',
  fileCommentsPlaceholder: 'أضف تعليقًا حول التحديد…',
