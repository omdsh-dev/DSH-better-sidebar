...
export const ar: Record<string, string> = {
  enterCodeFocus: 'ملء الشاشة',
  exitCodeFocus: 'الخروج من ملء الشاشة',
  resizeSidebar: 'غيّر عرض الشريط الجانبي؛ اسحبه إلى أقصى اليمين لإخفائه',
  releaseToHideSidebar: 'أفلت لإخفاء الشريط الجانبي',
  createFile: 'ملف جديد',
  createFolder: 'مجلد جديد',
  newFileName: 'اسم الملف',
  newFolderName: 'اسم المجلد',
  createNameRequired: 'أدخل اسمًا',
  createNameInvalid: 'لا يمكن أن يكون الاسم . أو .. أو أن يحتوي على فواصل مسار',
  creating: 'جارٍ الإنشاء…',
  createDone: 'تم إنشاء {path}',
  createFailed: 'فشل الإنشاء: {error}',
  operationBusy: 'هناك عملية ملفات أخرى قيد التنفيذ',
  importFiles: 'استيراد ملفات',
  importFolder: 'استيراد مجلد',
  deleteFile: 'حذف الملف',
  deleteFileTitle: 'حذف الملف',
  deleteFileDesc: 'هل تريد حذف «{path}» نهائيًا؟ لا يمكن التراجع عن هذا الإجراء.',
  deleteFolder: 'حذف المجلد',
  deleteFolderTitle: 'حذف المجلد',
  deleteFolderDesc: 'هل تريد حذف «{path}» وكل ما بداخله نهائيًا؟ لا يمكن التراجع عن هذا الإجراء.',
  deleteSymlink: 'حذف الرابط الرمزي',
  deleteSymlinkTitle: 'حذف الرابط الرمزي',
  deleteSymlinkDesc: 'هل تريد حذف الرابط الرمزي «{path}»؟ لن يُحذف الهدف. لا يمكن التراجع عن هذا الإجراء.',
  deleting: 'جارٍ الحذف…',
  deleteDone: 'تم حذف {path}',
