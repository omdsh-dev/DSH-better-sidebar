...
export const ar: Record<string, string> = {
  ...
  subagentDelete: "حذف نهائي",
  subagentDeleteConfirm: "حذف نهائي",
  subagentDeleteDesc: "سيتم حذف الوكيل الفرعي \"{name}\" وجميع سجلاته (بما في ذلك وكلاؤه الفرعيون) نهائيًا. لا يمكن التراجع.",
  subagentDeleteRunning: "قيد التشغيل — لا يمكن الحذف",
  subagentDeleteUnavailable: "يتطلب تثبيت إضافة @michengai/dsh-archive-manager",
