...
export const ar: Record<string, string> = {
  ...
  toc: 'الفهرس',
  review: 'مراجعة',
  reviewPending: '{count} بانتظار المراجعة',
  reviewNoRepo: 'ليس مستودع Git',
  reviewAccepted: 'مقبول',
  accept: 'قبول',
  acceptAll: 'قبول الكل',
  reject: 'رفض',
  rejectUntracked: 'الملف الجديد ليس له نسخة مثبتة لاستعادتها',
  find: 'بحث',
  findPrev: 'التطابق السابق',
  findNext: 'التطابق التالي',
  findClose: 'إغلاق البحث',
  findNoResults: 'لا توجد نتائج',
  edit: 'تحرير',
  ...
  browserLocalBlockedTitle: 'هل تريد الوثوق بـ {authority} وفتحه؟',
  browserLocalBlockedDesc: 'هذه خدمة محلية تعمل على جهازك. اسمح بها فقط إذا كنت قد شغّلت تطبيق الويب أو كنت تثق به. يقتصر الوصول على هذا العنوان والمنفذ.',
  browserTrustAndOpen: 'الوثوق والفتح',
  browserTrusting: 'جارٍ الحفظ…',
  browserTrustFailed: 'تعذر حفظ هذا العنوان المحلي. تحقق من خدمة إعدادات الشريط الجانبي ثم حاول مرة أخرى.',
