...
export const ar: Record<string, string> = {
  ...
  settingsAutoCollapseTitle: 'طي البطاقة الجانبية تلقائياً بعد انتهاء النشاط',
  settingsAutoCollapseDesc: 'عندما يوسّع التفعيل التلقائي بطاقة جانبية مطوية، تُطوى البطاقة تلقائياً بعد انتهاء جميع الوكلاء الفرعيين والمهام الخلفية في المحادثة الحالية وبقائها خاملة لحظة (تُغلق البطاقة فقط وتبقى علامة التبويب؛ أما البطاقة التي وسّعتها بنفسك فلا تُمس). الخيار متوقف افتراضياً',
