...
export const ar: Record<string, string> = {
  ...
  findPrevious: 'السابق',
  findAll: 'تحديد الكل',
  findMatchCase: 'مطابقة حالة الأحرف',
  findRegexp: 'تعبير نمطي',
  findByWord: 'كلمة كاملة',
  replaceOne: 'استبدال',
  ...
  closeUnsavedConfirm: 'يحتوي هذا الملف على تعديلات غير محفوظة. سيؤدي إغلاق علامة التبويب إلى تجاهلها. المتابعة؟',
  save: 'حفظ',
  saved: 'تم الحفظ',
  unsaved: 'غير محفوظ',
  saveFailed: 'فشل الحفظ',
  saveConflict: 'تم تغيير الملف على القرص من مصدر آخر. تم إيقاف الحفظ، وتعديلاتك ما زالت في المحرر.',   saveConflictReload: 'إعادة التحميل من القرص',
