...
export const ja: Record<string, string> = {
  ...
  closeUnsavedConfirm: 'このファイルには未保存の編集があります。タブを閉じると破棄されます。続行しますか？',
  save: '保存',
  saved: '保存済み',
  unsaved: '未保存',
  saveFailed: '保存に失敗',
  saveConflict: 'ファイルはディスク上で他によって変更されています。保存を中止しました。編集内容はそのまま残っています。',   saveConflictReload: 'ディスクの内容を再読み込み',
