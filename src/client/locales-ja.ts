...
export const ja: Record<string, string> = {
  ...
  toc: '目次',
  review: 'レビュー',
  reviewPending: '未レビュー {count} 件',
  reviewNoRepo: 'Git リポジトリではありません',
  reviewAccepted: '承認済み',
  accept: '承認',
  acceptAll: 'すべて承認',
  reject: '却下',
  rejectUntracked: '新規ファイルには復元できるコミットがありません',
  find: '検索',
  findPrev: '前の一致',
  findNext: '次の一致',
  findClose: '検索を閉じる',
  ...
  browserLocalBlockedTitle: '{authority} を信頼して開きますか？',
  browserLocalBlockedDesc: 'これはこのコンピューター上のローカルサービスです。自分で起動した、または信頼できる Web アプリの場合のみ許可してください。この権限は、このアドレスとポートだけに適用されます',
  browserTrustAndOpen: '信頼して開く',
  browserTrusting: '保存中…',
  browserTrustFailed: 'このローカルアドレスを保存できませんでした。サイドバーの設定サービスを確認して、もう一度お試しください',
