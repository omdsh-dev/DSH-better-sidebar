...
export const ja: Record<string, string> = {
  ...
  pluginTylinaDesc: 'DeepSeek Harness 向けの Typst 文書エディター：組版済みページを直接編集し、PDF、視覚忠実度の高い PowerPoint、または実験的な編集可能 PowerPoint を出力。現在の会話ワークスペースと better-sidebar の「Tylina」タブに統合',
