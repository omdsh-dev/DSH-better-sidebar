...
export const ja: Record<string, string> = {
  ...
  settingsAutoCollapseTitle: '処理が終わったらサイドカードを自動的にたたむ',
  settingsAutoCollapseDesc: '自動アクティブ化でたたまれたサイドカードを展開した場合、現在の会話のサブエージェントとバックグラウンドタスクがすべて終了し、しばらくアイドル状態が続いたら自動的にたたむ（閉じるのはカードだけでタブは残る。自分で展開したカードには触れない）。既定ではオフ',
