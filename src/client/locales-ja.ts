...
export const ja: Record<string, string> = {
  ...
  jobKillError: '終了に失敗',
  tasksViewGraph: 'ワークフロー図',
  tasksViewTree: 'ツリー',
  tasksViewSwitchToGraph: 'ワークフロー図に切替',
  tasksViewSwitchToTree: 'ツリーに切替',
  settingsViewModeTitle: 'タスク管理の既定ビュー',
  settingsViewModeDesc: 'タスク管理ページを開いたときの表示方法（ページ内で一時切替可能）',
  settingsViewModeGraph: 'ワークフロー図',
  ...
  tasksNodeMode: 'モード',
  tasksNodeModel: 'モデル',
  tasksNodeTeamRole: 'チーム役割',
  tasksNodeActivity: '最新アクティビティ',
  tasksStateRunning: '実行中',
  tasksStateIdle: '待機',
  tasksStateDone: '完了',
  tasksStateError: 'エラー',
  teamBoard: 'チームタスクボード',
  teamChip: 'チーム {members} 名 · {tasks} タスク',
  teamTasksEmpty: '共有タスクはまだありません',
  teamTaskCreate: 'タスクを作成',
  teamTaskSubject: '件名',
  teamTaskDescription: '説明',
  teamTaskOwner: '担当',
  teamTaskUnowned: '未割当',
  teamTaskPending: '未着手',
  teamTaskInProgress: '進行中',
  teamTaskCompleted: '完了',
  teamTaskBlocked: 'ブロック',
  teamTaskComplete: '完了',
  teamTaskReopen: '再オープン',
  teamTaskDelete: '削除',
  teamTaskDeleteConfirm: '削除を確認',
  teamTaskEdit: '編集',
  teamTaskSave: '保存',
  teamTaskCancel: 'キャンセル',
  teamTaskConflict: '他の場所で変更されました。最新に更新しました',
  teamTaskError: '操作に失敗: {message}',
  teamTaskDeleted: '削除済み',
  teamTaskActions: 'タスク操作',
  teamTaskDetail: 'タスク詳細',
  teamTaskNoDescription: '説明はまだありません（「編集」で追加）',
  teamTaskBlockedBy: 'ブロック元',
  teamTaskSubjectPlaceholder: 'やることを一行で',
  teamTaskDescriptionPlaceholder: '補足（任意）',
  teamFilterAll: 'すべて',
  tasksNodeTasks: '共有タスク',
  jobCopyOutput: '出力をコピー',
  jobCopied: 'コピーしました',
  jobFollowTail: '最新に追従',
  jobDragHint: 'ドラッグで移動',
  workflowRunning: '進行中',
  ...
  workflowFailed: '失敗',
  workflowPhaseUnnamed: '無名フェーズ',
  workflowMembers: '{done}/{total} メンバー',
  jobsAutoCollapsed: 'エージェント多数のため自動折りたたみ',
  catalogLoadFailed: '{count} 個のブランチの読み込みに失敗',
