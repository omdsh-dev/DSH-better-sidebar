...
export const ja: Record<string, string> = {
  ...
  explorerExclude: '除外パターン',
  explorerExcludeDesc: '一致するエントリをファイルツリーと検索から完全に除外します（* と ? をサポート、**/ 接頭辞で任意の深さに一致）。除外項はパンくず折りたたみを妨げません',
  explorerExcludePlaceholder: 'パターンを追加（例: node_modules、*.log、**/.git）',
  explorerExcludeAdd: '追加',
  explorerExcludeRemove: '削除',
