...
export const ja: Record<string, string> = {
  ...
  fileCommentsPanel: '現在のファイルのコメント',
  fileCommentsCurrent: '現在',
  fileCommentsSend: '選択したコメントを Agent に送信',
  fileCommentsSendShort: '送信',
  fileCommentsSendFailed: 'コメントの送信に失敗しました：{error}',
  fileCommentsEmptyCurrent: 'このファイルに未送信のコメントはありません',
  fileCommentsEmptyHistory: 'このファイルに送信済みのコメントはありません',
  fileCommentsSelectionOmitted: '選択範囲が長すぎるため、ファイル位置のみ送信されます',
  fileCommentsEdit: 'コメントを編集',
  fileCommentsDelete: 'コメントを削除',
  fileCommentsSelect: 'コメントを選択',
  fileCommentsSelectAll: 'すべて選択',
  fileCommentsClearSelection: '選択解除',
  fileCommentsDeleteSelected: '削除',
  fileCommentsPlaceholder: '選択範囲へのコメントを追加…',
  ...
  editorFile: 'ファイル',
  editorDiff: '差分',
  editorDiffToolbar: '差分ツールバー',
  editorDiffPrevious: '前の差分',
  editorDiffNext: '次の差分',
  editorDiffLayout: '差分レイアウト',
  editorDiffSplit: '分割表示',
  editorDiffUnified: '単一表示',
  editorDiffCollapse: '未変更部分を折りたたむ',
  editorDiffCount: '{count} 件の差分',
  editorDiffHead: 'HEAD バージョン',
  editorDiffCurrent: '現在の内容',
  editorDiffUnifiedLabel: 'HEAD バージョンと現在の内容',
  editorDiffLoadError: 'Git バージョンを読み込めません：{error}',
