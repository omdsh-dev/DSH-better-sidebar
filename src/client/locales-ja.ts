...
export const ja: Record<string, string> = {
  ...
  subagentDelete: "完全に削除",
  subagentDeleteConfirm: "完全に削除",
  subagentDeleteDesc: "サブエージェント「{name}」とその全記録（子エージェントを含む）を完全に削除します。この操作は取り消せません。",
  subagentDeleteRunning: "実行中 — 削除できません",
  subagentDeleteUnavailable: "@michengai/dsh-archive-manager プラグインが必要です",
