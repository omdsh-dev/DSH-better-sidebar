...
export const ja: Record<string, string> = {
  ...
  settingsSearchExcludeTitle: '検索から除外するディレクトリ',
  settingsSearchExcludeDesc: 'ファイル名検索でこれらのディレクトリをスキップ（カンマ区切り；任意の深さの同名ディレクトリも除外）',
  ...
  settingsImageDirTitle: 'Obsidian 画像ディレクトリ',
  settingsImageDirDesc: '![[x.png]] 埋め込みの解決先と貼り付け保存先：セッション cwd 基準（既定 images）または絶対パス',
  settingsImageDirPlaceholder: 'images',
  settingsMdPreviewThemeTitle: 'プレビュー配色テーマ',
  settingsMdPreviewThemeDesc: 'Markdown ファイルプレビューにのみ適用（サイドチャット・変更の閲覧モードには影響しません）',
  settingsMdPreviewThemeVivid: '鮮やか',
  settingsMdPreviewThemeVividDesc: '見出し・引用・表見出しなどにセマンティック色でコントラストを上げる',
  settingsMdPreviewThemeHost: 'ホスト',
  settingsMdPreviewThemeHostDesc: 'ホストの MarkdownText 配色をそのまま使う',
  viewerCode: 'コード',
