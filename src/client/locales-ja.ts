...
export const ja: Record<string, string> = {
  ...
  commitPlaceholder: 'コミットメッセージ (Ctrl+G で生成、Ctrl+Enter でコミット)',
  commit: 'コミット',
  commitError: 'コミット失敗',
  ...
  commitModelDesc: 'コミットメッセージの生成に使うモデルを選択します。既定では現在の会話のモデルに従います。',
  commitModelFollow: '会話のモデルに従う',
  commitModelSearchPlaceholder: '検索：provider/model を入力',
  commitModelCurrent: '現在：{route}',
  commitModelInvalid: 'provider/model の形式で入力してください',
  commitModelUnavailable: 'この環境にはモデルサービスがありません（現在の会話に従うのみ）',
  commitModelEmpty: 'モデルが見つかりません（上の欄に provider/model を直接入力できます）',
  commitModelDefaultNote: '既定',
  commitModelRecentNote: 'この会話で使用',
  branch: 'ブランチ',
  worktree: 'ワークツリー',
