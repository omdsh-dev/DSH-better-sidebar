...
export const ja: Record<string, string> = {
  ...
  allowOutsideFiles: 'ワークスペース外のファイルを開くことを許可',
  allowOutsideFilesDesc: '読み取りのみ解放：セッションのワークスペース外のファイル/ディレクトリを表示できます。編集・保存・アップロードはワークスペース内に制限されます',
  externalReadonly: '外部 · 読み取り専用',
