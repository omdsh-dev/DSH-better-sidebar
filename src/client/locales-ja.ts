...
export const ja: Record<string, string> = {
  ...
  guideDescPlan: 'プランモードでモデルが提示したプランの全文を、版ごとに保存',
  ...
  plan: 'プラン',
  planEmpty: 'このセッションにはまだプランがありません',
  planEmptyDesc: 'プランモードでモデルにプランを作らせると、提出後にここに表示されます',
  planStatusPending: 'レビュー待ち',
  planStatusApproved: '承認済み',
  planStatusUnadopted: '未採用',
  planCopy: '全文をコピー',
  planLoadError: 'プランを読み込めませんでした。あとで再試行します',
  ...
  settingsPlanTitle: 'モデルがプランを提示したらプランページを自動的に開く',
  settingsPlanDesc: '現在の会話でモデルがプランを提示するたびにプランページを開く（提示ごとに発火）。広い画面ではサイドカードも展開するが、狭い画面では全画面ドロワーを強制的に開かない。オフにすると手動で開く必要がある',
