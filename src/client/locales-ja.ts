...
export const ja: Record<string, string> = {
  enterCodeFocus: 'フルスクリーン',
  exitCodeFocus: 'フルスクリーンを終了',
  resizeSidebar: 'サイドバーの幅を調整。右端までドラッグすると非表示になります',
  releaseToHideSidebar: '離すとサイドバーを非表示',
  createFile: '新規ファイル',
  createFolder: '新規フォルダー',
  newFileName: 'ファイル名',
  newFolderName: 'フォルダー名',
  createNameRequired: '名前を入力してください',
  createNameInvalid: '名前に .、..、またはパス区切り文字は使用できません',
  creating: '作成中…',
  createDone: '{path} を作成しました',
  createFailed: '作成に失敗しました：{error}',
  operationBusy: '別のファイル操作を実行中です',
  importFiles: 'ファイルをインポート',
  importFolder: 'フォルダーをインポート',
  deleteFile: 'ファイルを削除',
  deleteFileTitle: 'ファイルを削除',
  deleteFileDesc: '「{path}」を完全に削除します。この操作は元に戻せません。',
  deleteFolder: 'フォルダーを削除',
  deleteFolderTitle: 'フォルダーを削除',
  deleteFolderDesc: '「{path}」とその中のすべてを完全に削除します。この操作は元に戻せません。',
  deleteSymlink: 'シンボリックリンクを削除',
  deleteSymlinkTitle: 'シンボリックリンクを削除',
  deleteSymlinkDesc: 'シンボリックリンク「{path}」を削除します。リンク先は削除されません。この操作は元に戻せません。',
  deleting: '削除中…',
  deleteDone: '{path} を削除しました',
