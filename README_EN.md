...
- [DeepSeek Harness Desktop Tauri](https://github.com/hairyf/deepseek-harness-desktop): a Tauri desktop build of DeepSeek Harness — only a 5MB installer, zero environment setup, ready-to-use preset plugins, supporting Windows / macOS / Linux
