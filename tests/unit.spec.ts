...
describe('editor language mapping', () => {
  ...
  it('maps common extensions to languages and falls back to plain text', () => {
    ...
    expect(languageKeyForExt('kts')).toBe('kotlin')
    expect(languageKeyForExt('swift')).toBe('swift')
    expect(languageKeyForExt('m')).toBe('objc')
    expect(languageKeyForExt('mm')).toBe('objcpp')
    expect(languageKeyForExt('dart')).toBe('dart')
    expect(languageKeyForExt('ets')).toBe('ts')
    expect(languageKeyForExt('xcconfig')).toBe('properties')
    expect(languageKeyForExt('plist')).toBe('xml')
    expect(languageKeyForExt('gradle')).toBe('groovy')
